    ...
    <>
      ...
      <div className="nill-auth-root">
        <div className="nill-auth-card">
          ...
          {!token ? (
            <>
              <h1 className="nill-auth-heading">Ungültiger <em>Link.</em></h1>
              <p className="nill-auth-sub">Dieser Reset-Link ist nicht gültig. Bitte fordere einen neuen an.</p>
              <div className="nill-divider" />
              <p className="nill-auth-footer">
                <span className="link" onClick={() => navigate("/login")}>← Zum Login</span>
              </p>
            </>
          ) : success ? (
            <>
              <h1 className="nill-auth-heading">Passwort <em>gesetzt.</em></h1>
              <p className="nill-auth-sub">Dein Passwort wurde erfolgreich geändert. Du kannst dich jetzt anmelden.</p>
            ...
            <>
              <h1 className="nill-auth-heading">Neues <em>Passwort.</em></h1>
              <p className="nill-auth-sub">Wähle ein neues Passwort für dein Konto.</p>

              <form onSubmit={handleSubmit} noValidate>
                <div className="nill-field">
                  <label className="nill-label" htmlFor="rp-password">Neues Passwort</label>
                  <input
                    id="rp-password"
                ...
                <div className="nill-field">
                  <label className="nill-label" htmlFor="rp-password2">Passwort bestätigen</label>
                  <input
                    id="rp-password2"
                    className="nill-input"
                    type="password"
                ...
                <button className="nill-btn-primary" type="submit" disabled={loading || !password || !password2}>
              ...
              <div className="nill-divider" />
              <p className="nill-auth-footer">
                <span className="link" onClick={() => navigate("/login")}>← Zurück zum Login</span>
              </p>
            </>
          )}
