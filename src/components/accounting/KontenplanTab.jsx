...
const KLASSEN = {
  "0":"Klasse 0 - Anlagevermogen","1":"Klasse 1 - Umlaufvermogen",
  "2":"Klasse 2 - Eigenkapital","3":"Klasse 3 - Verbindlichkeiten",
  "4":"Klasse 4 - Betriebliche Aufwendungen","5":"Klasse 5 - Wareneinsatz",
  "6":"Klasse 6 - Sonstige Kosten","7":"Klasse 7 - Ertrage (Sonderposten)",
  "8":"Klasse 8 - Erlose / Ertrage","9":"Klasse 9 - Vor- und Abschlusskonten",
};
          ...
          <div className="ac-modal">
            ...
            <div className="ac-form-col" style={{ marginBottom:12 }}>
              ...
              <input className="ac-input ac-mono" value={newKonto.kontonummer}
                onChange={e => setNewKonto(n => ({ ...n, kontonummer: e.target.value }))} placeholder="z.B. 4820" maxLength={8} />
            </div>
            <div className="ac-form-col" style={{ marginBottom:12 }}>
              <label className="ac-label">Bezeichnung</label>
              <input className="ac-input" value={newKonto.bezeichnung}
                onChange={e => setNewKonto(n => ({ ...n, bezeichnung: e.target.value }))} placeholder="Kontobeschreibung" />
            </div>
