...
// Updated: after upload, offer one-click auto-booking into double-entry system
        ...
        {!result ? (
          <>
            ...
            <div className="ac-modal-footer">
              ...
              <button className="ac-btn ac-btn-primary" onClick={upload}
          ...
          <>
            ...
            {booked ? (
              ...
              <div style={{ background:"rgba(122,92,255,.08)", border:"1px solid rgba(122,92,255,.2)",
            ...
            <div className="ac-modal-footer">
              <button className="ac-btn ac-btn-ghost" onClick={() => { setResult(null); setFile(null); setPreview(null); setBooked(false); }}>
                Weiteren Beleg
              </button>
