  ...
  const plans = [
    {
      ...
      features: [
        "KI Email Integration",
        "Buchhaltung",
        "Kalender und Task Managment",
      ],
    },
    {
      id: "team",
      ...
      features: [
        "Alles aus Solo",
        "Zeiterfassung",
        "Aufgabenverteilung mit Deadline Erinnerung",
        "Inventur- und Lieferscheinliste",
      ],
    },
    {
      id: "business",
      title: "Business",
      price: "15€",
      description: "Erweiterte KI & maximale Kontrolle.",
      features: [
        "Alle Funktionen von Team",
