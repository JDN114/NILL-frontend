import{a as d,j as e}from"./vendor-react--hPKs4bs.js";import{L as K}from"./vendor-router-rhPWNlHF.js";import{u as pe,T as be,C as ne,R as ye,a as je,F as we,B as Ne,b as oe,S as ce,A as ue,V as de,c as ke,d as Me}from"./vendor-three-CU4f1WLN.js";/* empty css                */import"./vendor-misc-1rS7ujT8.js";function Se(){const r=document.createElement("canvas");r.width=1024,r.height=512;const a=r.getContext("2d");a.fillStyle="#d4d6dc",a.fillRect(0,0,1024,512);for(let s=0;s<2400;s++)a.fillStyle=`rgba(${100+(Math.random()*40|0)},${100+(Math.random()*40|0)},${110+(Math.random()*40|0)},${.08+Math.random()*.12})`,a.fillRect(Math.random()*1024,Math.random()*512,1+Math.random()*3,1);a.strokeStyle="rgba(20,22,28,.55)",a.lineWidth=1.2;for(let s=0;s<1024;s+=64)a.beginPath(),a.moveTo(s,0),a.lineTo(s,512),a.stroke();for(let s=0;s<512;s+=64)a.beginPath(),a.moveTo(0,s),a.lineTo(1024,s),a.stroke();a.fillStyle="rgba(40,44,52,.7)";for(let s=8;s<1024;s+=32)for(let o=8;o<512;o+=32)a.fillRect(s,o,1.5,1.5);for(let s=0;s<14;s++){const o=Math.random()*844,c=Math.random()*422,l=80+Math.random()*100,p=40+Math.random()*60;a.strokeStyle="rgba(15,17,22,.7)",a.lineWidth=2,a.strokeRect(o,c,l,p),a.fillStyle="rgba(50,55,65,.18)",a.fillRect(o,c,l,p)}for(let s=0;s<60;s++)a.fillStyle=`rgba(${30+(Math.random()*40|0)},${28+(Math.random()*30|0)},${28+(Math.random()*30|0)},${.15+Math.random()*.25})`,a.fillRect(Math.random()*1024,Math.random()*512,30+Math.random()*120,1+Math.random()*3);a.fillStyle="rgba(220,200,40,.55)",a.font="bold 14px monospace",["CAUTION","HATCH-A4","MOD-7","EXT-VENT","HIGH-V","NILL-OS"].forEach((s,o)=>a.fillText(s,60+o*160,40+o%2*220));const i=new ne(r);return i.wrapS=i.wrapT=ye,i.anisotropy=8,i}function ze(){const r=document.createElement("canvas");r.width=512,r.height=256;const a=r.getContext("2d"),i=a.createLinearGradient(0,0,512,256);i.addColorStop(0,"#0a1840"),i.addColorStop(.5,"#1a3878"),i.addColorStop(1,"#0a1d54"),a.fillStyle=i,a.fillRect(0,0,512,256);const s=32,o=32;for(let l=0;l<512;l+=s)for(let p=0;p<256;p+=o){const y=.8+Math.random()*.3;a.fillStyle=`rgba(${30*y|0},${60*y|0},${140*y|0},.95)`,a.fillRect(l+1,p+1,s-2,o-2);const w=a.createLinearGradient(l,p,l+s,p+o);w.addColorStop(0,"rgba(120,180,255,.18)"),w.addColorStop(.5,"rgba(255,255,255,.05)"),w.addColorStop(1,"rgba(20,40,90,.2)"),a.fillStyle=w,a.fillRect(l+1,p+1,s-2,o-2),a.fillStyle="rgba(180,190,210,.4)",a.fillRect(l+s/2-.5,p+1,1,o-2)}a.strokeStyle="rgba(8,12,28,.85)",a.lineWidth=1;for(let l=0;l<=512;l+=s)a.beginPath(),a.moveTo(l,0),a.lineTo(l,256),a.stroke();for(let l=0;l<=256;l+=o)a.beginPath(),a.moveTo(0,l),a.lineTo(512,l),a.stroke();const c=new ne(r);return c.anisotropy=8,c}function Ie(){const n=document.createElement("canvas");n.width=n.height=128;const t=n.getContext("2d"),r=t.createRadialGradient(64,64,0,64,64,64);return r.addColorStop(0,"rgba(255,255,255,1)"),r.addColorStop(.3,"rgba(255,255,255,.5)"),r.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=r,t.fillRect(0,0,128,128),new ne(n)}function Pe(){const n=document.createElement("canvas");n.width=512,n.height=64;const t=n.getContext("2d");t.fillStyle="#181a20",t.fillRect(0,0,512,64);for(let r=0;r<24;r++){const a=20+r*20,i=t.createRadialGradient(a+6,32,0,a+6,32,12);i.addColorStop(0,"rgba(255,240,200,1)"),i.addColorStop(.4,"rgba(180,220,255,.85)"),i.addColorStop(1,"rgba(40,80,160,0)"),t.fillStyle=i,t.fillRect(a-6,16,24,32),t.strokeStyle="#2a2d35",t.lineWidth=2,t.strokeRect(a,22,12,20)}return new ne(n)}function Le(n){const t=be,r=Se(),a=ze(),i=Ie(),s=Pe(),o=new t.MeshStandardMaterial({map:r,color:16777215,metalness:.65,roughness:.42}),c=new t.MeshStandardMaterial({map:r,color:10133680,metalness:.7,roughness:.5}),l=new t.MeshStandardMaterial({color:13041468,emissive:7178772,emissiveIntensity:.9,metalness:.5,roughness:.35}),p=new t.MeshStandardMaterial({color:1842982,metalness:.75,roughness:.55}),y=new t.MeshStandardMaterial({color:13148234,metalness:.85,roughness:.25,emissive:3811848,emissiveIntensity:.15}),w=new t.MeshStandardMaterial({map:a,metalness:.7,roughness:.35,emissive:661560,emissiveIntensity:.18,side:t.DoubleSide}),f=new t.MeshBasicMaterial({map:s,transparent:!0,opacity:.95}),N=new t.Group;n.add(N),[-1,0,1].forEach((v,m)=>{const x=new t.Mesh(new t.CylinderGeometry(.88,.88,.92,32),o);if(x.rotation.z=Math.PI/2,x.position.x=v*1,N.add(x),m<2){const g=new t.Mesh(new t.CylinderGeometry(.94,.94,.12,32),y);g.rotation.z=Math.PI/2,g.position.x=v*1+.5,N.add(g)}const b=new t.Mesh(new t.CylinderGeometry(.881,.881,.22,32,1,!0),f);b.rotation.z=Math.PI/2,b.position.x=v*1,N.add(b)}),[-1.5,1.5].forEach(v=>{const m=new t.Mesh(new t.SphereGeometry(.88,32,16,0,Math.PI*2,0,Math.PI/2),o);m.rotation.z=v>0?-Math.PI/2:Math.PI/2,m.position.x=v,N.add(m)});const S=new t.Group;S.position.y=.82,S.add(new t.Mesh(new t.CylinderGeometry(.32,.38,.15,24),o));const I=new t.Mesh(new t.SphereGeometry(.3,24,16,0,Math.PI*2,0,Math.PI/2),new t.MeshStandardMaterial({color:4880568,metalness:.9,roughness:.08,emissive:3823736,emissiveIntensity:.45,transparent:!0,opacity:.88}));I.position.y=.075,S.add(I);for(let v=0;v<6;v++){const m=v/6*Math.PI*2,x=new t.Mesh(new t.BoxGeometry(.012,.3,.012),p);x.position.set(Math.cos(m)*.27,.075,Math.sin(m)*.27),x.rotation.y=-m,S.add(x)}N.add(S),[-2.55,2.55].forEach(v=>{const m=new t.Group;m.position.x=v;const x=new t.Mesh(new t.CylinderGeometry(.58,.58,1.5,24),o);x.rotation.z=Math.PI/2,m.add(x);const b=new t.Mesh(new t.SphereGeometry(.58,24,16,0,Math.PI*2,0,Math.PI/2),y);b.rotation.z=v>0?-Math.PI/2:Math.PI/2,b.position.x=v>0?.75:-.75,m.add(b);const g=new t.Mesh(new t.TorusGeometry(.58,.03,8,24),l);g.rotation.y=Math.PI/2,g.position.x=v>0?.75:-.75,m.add(g);const k=new t.Mesh(new t.CylinderGeometry(.581,.581,.18,24,1,!0),f);k.rotation.z=Math.PI/2,m.add(k);for(let h=0;h<8;h++){const M=h/8*Math.PI*2,j=new t.Mesh(new t.BoxGeometry(.08,.04,.15),p);j.position.set((Math.random()-.5)*1,Math.cos(M)*.6,Math.sin(M)*.6),j.lookAt(j.position.x,0,0),m.add(j)}const P=new t.Mesh(new t.BoxGeometry(.4,.15,.12),p);P.position.set(0,-.62,0),m.add(P);const G=new t.Mesh(new t.CylinderGeometry(.04,.04,1.4,8),y);G.rotation.z=Math.PI/2,G.position.set(0,.58,.15),m.add(G),n.add(m)});const L=(v,m)=>{const x=new t.Group;x.position.x=v,[[-.13,-.13],[.13,-.13],[-.13,.13],[.13,.13]].forEach(([b,g])=>{const k=new t.Mesh(new t.CylinderGeometry(.018,.018,m,6),p);k.rotation.z=Math.PI/2,k.position.set(0,b,g),x.add(k)});for(let b=0;b<4;b++){const g=-m/2+(b+.5)*(m/4),k=new t.Mesh(new t.CylinderGeometry(.012,.012,.36,6),p);k.position.set(g,0,0),k.rotation.z=Math.PI/4,x.add(k);const P=new t.Mesh(new t.CylinderGeometry(.012,.012,.36,6),p);P.position.set(g,0,0),P.rotation.x=Math.PI/4,x.add(P)}return[-m/2,m/2].forEach(b=>{const g=new t.Mesh(new t.TorusGeometry(.18,.015,6,12),p);g.rotation.y=Math.PI/2,g.position.x=b,x.add(g)}),x};n.add(L(-1.7,.65)),n.add(L(1.7,.65)),[-1,1].forEach(v=>{const m=new t.Group,x=new t.Mesh(new t.CylinderGeometry(.13,.13,.35,12),c);x.position.y=v*.9,m.add(x);const b=new t.Mesh(new t.CylinderGeometry(.07,.07,1.7,10),c);b.position.y=v*1.95,m.add(b);const g=new t.Mesh(new t.SphereGeometry(.14,16,12),y);g.position.y=v*2.85,m.add(g),[-1,1].forEach(k=>{const P=new t.Group;P.position.set(k*2.4,v*2.85,0);const G=new t.Mesh(new t.PlaneGeometry(4.6,1.55,16,4),w);G.rotation.y=Math.PI/2*(k>0?1:-1),P.add(G);const h=new t.Mesh(new t.BoxGeometry(.08,1.55,4.6),c);P.add(h);const M=new t.Mesh(new t.BoxGeometry(.18,.25,.25),p);M.position.x=k>0?-2.3:2.3,P.add(M),m.add(P)}),n.add(m)}),[-1,1].forEach(v=>{const m=new t.Mesh(new t.PlaneGeometry(1.2,.9),new t.MeshStandardMaterial({color:15790312,metalness:.1,roughness:.8,side:t.DoubleSide,emissive:2105376,emissiveIntensity:.05}));m.position.set(v*1.7,0,.85),m.rotation.x=Math.PI/2,n.add(m);const x=new t.Mesh(new t.BoxGeometry(1.2,.04,.04),p);x.position.set(v*1.7,0,.85),n.add(x)});const C=new t.Group;C.position.set(.4,0,1);const z=new t.Mesh(new t.CylinderGeometry(.05,.05,.55,10),c);z.position.y=.27,C.add(z);const u=new t.Mesh(new t.SphereGeometry(.08,12,10),y);u.position.y=.55,C.add(u);const E=new t.Mesh(new t.SphereGeometry(.42,24,16,0,Math.PI*2,0,Math.PI/2.5),new t.MeshStandardMaterial({color:15658724,metalness:.4,roughness:.3,side:t.DoubleSide}));E.position.y=.65,E.rotation.x=-.4,C.add(E);const T=new t.Mesh(new t.ConeGeometry(.06,.18,10),p);T.position.set(0,.82,.15),T.rotation.x=Math.PI,C.add(T);for(let v=0;v<3;v++){const m=v/3*Math.PI*2,x=new t.Mesh(new t.CylinderGeometry(.006,.006,.25,6),p);x.position.set(Math.cos(m)*.12,.75,.08+Math.sin(m)*.12),x.rotation.x=.4,x.rotation.z=m,C.add(x)}n.add(C);const D=new t.Group;D.position.set(-.6,0,1);const te=new t.Mesh(new t.CylinderGeometry(.025,.025,.8,8),p);te.position.y=.4,D.add(te);const ae=new t.Mesh(new t.SphereGeometry(.04,8,8),l);ae.position.y=.82,D.add(ae),n.add(D);const O=new t.Mesh(new t.CylinderGeometry(.32,.42,.48,24),c);O.position.set(0,-.85,.35),O.rotation.x=Math.PI/2,n.add(O);const H=new t.Mesh(new t.TorusGeometry(.34,.04,10,24),l);H.position.set(0,-1.05,.35),H.rotation.x=Math.PI/2,n.add(H);for(let v=0;v<4;v++){const m=v/4*Math.PI*2+Math.PI/4,x=new t.Mesh(new t.CylinderGeometry(.022,.022,.15,6),p);x.position.set(Math.cos(m)*.36,-1.05,.35+Math.sin(m)*.36),x.rotation.z=-Math.PI/2,n.add(x)}[[3.2,0,0],[-3.2,0,0],[0,1,1],[0,-1,1]].forEach(([v,m,x])=>{const b=new t.Group;b.position.set(v,m,x);for(let g=0;g<4;g++){const k=g/4*Math.PI*2,P=new t.Mesh(new t.ConeGeometry(.04,.12,8),p);P.position.set(Math.cos(k)*.08,Math.sin(k)*.08,0),P.rotation.x=Math.PI/2,b.add(P)}n.add(b)});const X=[];[[0,-2.9,.15],[0,-2.9,-.15],[0,-1.1,.35],[0,-1.1,-.05],[-3.2,0,0],[3.2,0,0]].forEach(([v,m,x])=>{const b=new t.Sprite(new t.SpriteMaterial({map:i,color:6336767,transparent:!0,opacity:0,blending:t.AdditiveBlending,depthWrite:!1}));b.scale.set(2.8,2.8,1),b.position.set(v,m,x),n.add(b);const g=new t.Sprite(new t.SpriteMaterial({map:i,color:15267071,transparent:!0,opacity:0,blending:t.AdditiveBlending,depthWrite:!1}));g.scale.set(.7,.7,1),g.position.set(v,m,x),n.add(g),X.push({outer:b,inner:g})});const J=[];[[3.4,0,0,16724048],[-3.4,0,0,13041468],[0,2.95,1.2,16777215],[0,-2.95,1.2,16777215],[0,0,1.4,16747068],[0,0,-1.4,6741503]].forEach(([v,m,x,b])=>{const g=new t.Mesh(new t.SphereGeometry(.05,10,10),new t.MeshBasicMaterial({color:b,transparent:!0}));g.position.set(v,m,x);const k=new t.Sprite(new t.SpriteMaterial({map:i,color:b,transparent:!0,opacity:.6,blending:t.AdditiveBlending,depthWrite:!1}));k.scale.set(.4,.4,1),g.add(k),n.add(g),J.push({mesh:g,halo:k})});const V=[new t.Vector3(0,.82,.2),new t.Vector3(-2.4,2.85,0),new t.Vector3(.4,.65,1)],Q=V.map((v,m)=>{const x=new t.Sprite(new t.SpriteMaterial({map:i,color:[13041468,3732944,8019199][m],transparent:!0,opacity:0,blending:t.AdditiveBlending,depthWrite:!1}));return x.scale.set(3.5,3.5,1),x.position.copy(v),n.add(x),x});return{thrusterGlows:X,navLights:J,focusHalos:Q,FOCUS_ANCHORS:V}}const Ce=d.forwardRef(function({thrusterProxy:t,focusProxy:r,stationProxy:a},i){const s=d.useRef(),o=d.useRef(null);return d.useImperativeHandle(i,()=>s.current,[]),d.useEffect(()=>{if(!s.current)return;const c=Le(s.current);return o.current=c,()=>{o.current=null}},[]),pe(({clock:c})=>{if(!o.current)return;const l=c.elapsedTime,p=(t==null?void 0:t.intensity)??0,y=(r==null?void 0:r.value)??-1,{thrusterGlows:w,navLights:f,focusHalos:N}=o.current;w.forEach(({outer:S,inner:I},L)=>{const C=Math.sin(l*9+L*.8)*.5+.5;S.material.opacity=p*(.18+C*.07),I.material.opacity=p*(.45+C*.12)}),f.forEach(({mesh:S},I)=>{const L=Math.sin(l*(2.1+I*.43)+I*1.9)>.3;S.material.opacity=L?1:.04}),N.forEach((S,I)=>{const L=I===y?.36+Math.sin(l*1.8)*.07:0;S.material.opacity+=(L-S.material.opacity)*.06})}),e.jsx("group",{ref:s})}),Te=`
...
`;function Ee(){const n=d.useRef(),{surfaceMat:t,atmoMat:r}=d.useMemo(()=>{const a=new de(Math.cos(-53*Math.PI/180)*Math.cos(135*Math.PI/180),Math.sin(-53*Math.PI/180),Math.cos(-53*Math.PI/180)*Math.sin(135*Math.PI/180)).normalize(),i=new ce({uniforms:{uTime:{value:0},uSunDir:{value:a.clone()},uSeaLevel:{value:-.02},uCloudOpacity:{value:.45},uCloudSpeed:{value:.65},uCityLights:{value:1},uAtmoStrength:{value:0}},vertexShader:`
      ...
      `});return{surfaceMat:i,atmoMat:s}},[]);return pe(({clock:a})=>{t.uniforms.uTime.value=a.elapsedTime,n.current&&(n.current.rotation.y=a.elapsedTime*.075)}),e.jsxs("group",{ref:n,position:[-7.4,-7.5,-13.7],scale:1.14,children:[e.jsx("mesh",{material:t,children:e.jsx("sphereGeometry",{args:[2.7,96,64]})}),e.jsx("mesh",{material:r,children:e.jsx("sphereGeometry",{args:[2.92,64,48]})})]})}function Ae(){const{geometry:t,material:r}=d.useMemo(()=>{const a=new Float32Array(6600),i=new Float32Array(2200),s=new Float32Array(2200*3);for(let l=0;l<2200;l++){const p=60+Math.random()*70,y=Math.random()*Math.PI*2,w=Math.acos(2*Math.random()-1);a[l*3]=p*Math.sin(w)*Math.cos(y),a[l*3+1]=p*Math.sin(w)*Math.sin(y),a[l*3+2]=p*Math.cos(w),i[l]=.4+Math.random()*1.4;const f=Math.random();s[l*3]=f<.15?1:f>.85?.7:.95,s[l*3+1]=f<.15?.85:f>.85?.8:.95,s[l*3+2]=f<.15?.7:f>.85?1:.95}const o=new Ne;o.setAttribute("position",new oe(a,3)),o.setAttribute("starSize",new oe(i,1)),o.setAttribute("color",new oe(s,3));const c=new ce({uniforms:{},vertexShader:`
      ...
      `,transparent:!0,depthWrite:!1,blending:ue});return{geometry:o,material:c}},[]);return e.jsx("points",{geometry:t,material:r})}function Fe({cameraProxy:n,lookProxy:t,fovProxy:r}){const{camera:a}=Me(),i=d.useMemo(()=>new de,[]),s=d.useMemo(()=>new de,[]);return d.useEffect(()=>{a.position.set(0,1.6,28),a.fov=36,a.updateProjectionMatrix()},[]),pe(({clock:o})=>{const c=o.elapsedTime,l=Math.sin(c*.19)*.06,p=Math.sin(c*.13)*.04,y=Math.sin(c*.07)*.05;s.set(((n==null?void 0:n.x)??0)+l,((n==null?void 0:n.y)??0)+p,((n==null?void 0:n.z)??16)+y),a.position.lerp(s,.18),i.set(((t==null?void 0:t.x)??0)+Math.sin(c*.17)*.025,((t==null?void 0:t.y)??0)+Math.cos(c*.21)*.02,(t==null?void 0:t.z)??0),a.lookAt(i),r&&Math.abs(a.fov-r.value)>.05&&(a.fov+=(r.value-a.fov)*.12,a.updateProjectionMatrix())}),null}function We({issGroupRef:n,stationProxy:t,cameraProxy:r,lookProxy:a,thrusterProxy:i,fovProxy:s,focusProxy:o,onReady:c}){return d.useEffect(()=>{c==null||c()},[c]),e.jsxs(e.Fragment,{children:[e.jsx("ambientLight",{color:2107456,intensity:.35}),e.jsx("directionalLight",{color:16774364,intensity:2.4,position:[10,5,7]}),e.jsx("directionalLight",{color:4880568,intensity:.95,position:[6,-8,-4]}),e.jsx("directionalLight",{color:8965375,intensity:.45,position:[-7,3,-5]}),e.jsx(Ae,{}),e.jsx(Ee,{}),e.jsx(d.Suspense,{fallback:null,children:e.jsx(Ce,{ref:n,thrusterProxy:i,focusProxy:o})}),e.jsx(Fe,{cameraProxy:r,lookProxy:a,fovProxy:s})]})}function Re({issGroupRef:n,stationProxy:t,cameraProxy:r,lookProxy:a,thrusterProxy:i,fovProxy:s,focusProxy:o,onLoaded:c}){return e.jsx(je,{dpr:[1,1.6],gl:{antialias:!0,alpha:!1,powerPreference:"high-performance"},style:{width:"100%",height:"100%",background:"#02030a"},camera:{fov:36,near:.1,far:300,position:[0,1.6,28]},onCreated:({scene:l})=>{l.fog=new we(131850,.025)},children:e.jsx(We,{issGroupRef:n,stationProxy:t,cameraProxy:r,lookProxy:a,thrusterProxy:i,fovProxy:s,focusProxy:o,onReady:c})})}function De(n){return n?n.split(/(<em>[^<]*<\/em>|\n)/g).map((t,r)=>{if(t===`
`)return e.jsx("br",{},r);const a=t.match(/^<em>([^<]*)<\/em>$/);return a?e.jsx("em",{children:a[1]},r):t||null}):null}const Ge=d.forwardRef(function({index:t=0,total:r=3,tag:a,title:i,description:s,stats:o,position:c="tr",state:l="future"},p){const y=["iss-card",`pos-${c}`,l==="active"?"is-active":"",l==="past"?"is-past":""].filter(Boolean).join(" ");return e.jsxs("article",{ref:p,className:y,"aria-hidden":l!=="active",children:[e.jsxs("div",{className:"iss-card-index",children:[e.jsx("em",{children:String(t+1).padStart(2,"0")}),e.jsx("span",{children:"/"}),e.jsx("span",{children:String(r).padStart(2,"0")})]}),a&&e.jsx("div",{className:"iss-card-tag",children:a}),i&&e.jsx("h3",{children:De(i)}),s&&e.jsx("p",{children:s}),o&&o.length>0&&e.jsx("div",{className:"iss-card-stats",children:o.map(([w,f],N)=>e.jsxs("div",{className:"iss-card-stat",children:[e.jsx("span",{className:"iss-card-stat-num",children:w}),e.jsx("span",{className:"iss-card-stat-lbl",children:f})]},N))})]})}),W=(n,t,r)=>n+(t-n)*r,fe=(n,t,r)=>n<t?t:n>r?r:n,Be=n=>{const t=fe(n,0,1);return t*t*t*(t*(t*6-15)+10)},ee=[{p:0,cam:{x:0,y:1.6,z:28},look:{x:0,y:0,z:0},rotX:.05,rotY:.2,rotZ:0,fov:36,thruster:0,focus:-1,card:-1,phase:"approach"},{p:.1,cam:{x:0,y:.7,z:13.5},look:{x:0,y:.1,z:0},rotX:.18,rotY:.85,rotZ:.04,fov:40,thruster:.25,focus:-1,card:-1,phase:"active"},{p:.26,cam:{x:-1.9,y:1.8,z:6.4},look:{x:0,y:.6,z:.2},rotX:-.06,rotY:1.55,rotZ:-.04,fov:38,thruster:0,focus:0,card:0,phase:"reveal"},{p:.46,cam:{x:3.6,y:-.1,z:8},look:{x:-.4,y:1.4,z:0},rotX:.08,rotY:2.55,rotZ:.08,fov:44,thruster:0,focus:1,card:1,phase:"reveal"},{p:.66,cam:{x:-2.3,y:-.6,z:6.6},look:{x:.4,y:-.05,z:.9},rotX:.18,rotY:3.45,rotZ:-.05,fov:36,thruster:0,focus:2,card:2,phase:"reveal"},{p:.86,cam:{x:0,y:2.9,z:19.5},look:{x:0,y:-.8,z:-1.8},rotX:.28,rotY:4.25,rotZ:-.05,fov:46,thruster:.55,focus:-1,card:-1,phase:"outro"},{p:1,cam:{x:0,y:3.4,z:23},look:{x:0,y:-1.1,z:-2.4},rotX:.3,rotY:4.45,rotZ:-.06,fov:48,thruster:.25,focus:-1,card:-1,phase:"outro"}];function Oe(n){let t=0;for(;t<ee.length-2&&n>ee[t+1].p;)t++;const r=ee[t],a=ee[Math.min(t+1,ee.length-1)],i=a.p-r.p,s=i>1e-5?Be((n-r.p)/i):0;return{cam:{x:W(r.cam.x,a.cam.x,s),y:W(r.cam.y,a.cam.y,s),z:W(r.cam.z,a.cam.z,s)},look:{x:W(r.look.x,a.look.x,s),y:W(r.look.y,a.look.y,s),z:W(r.look.z,a.look.z,s)},rotX:W(r.rotX,a.rotX,s),rotY:W(r.rotY,a.rotY,s),rotZ:W(r.rotZ,a.rotZ,s),fov:W(r.fov,a.fov,s),thruster:W(r.thruster,a.thruster,s),focus:s>.65?a.focus:r.focus,card:s>.65?a.card:r.card,phase:s>.65?a.phase:r.phase}}function _e({sectionRef:n,issGroupRef:t,stationProxy:r,cameraProxy:a,lookProxy:i,thrusterProxy:s,fovProxy:o,focusProxy:c,onPhaseChange:l,onCardChange:p,damping:y=.07}={}){d.useEffect(()=>{if(!(n!=null&&n.current)){console.warn("[ISS] sectionRef.current ist null – RAF wurde nicht gestartet");return}let w=0,f=0,N=0,S=-2,I="",L=!0;const C=()=>{const u=n.current;if(!u)return;const E=u.getBoundingClientRect(),T=document.documentElement.clientHeight||window.innerHeight,D=u.offsetHeight-T;if(D<=0){f=0;return}f=fe(-E.top/D,0,1)},z=()=>{if(!L)return;w=requestAnimationFrame(z),C(),N=W(N,f,y),Math.abs(N-f)<1e-4&&(N=f);const u=Oe(N),E=performance.now()/1e3;a&&(a.x=u.cam.x,a.y=u.cam.y,a.z=u.cam.z),i&&(i.x=u.look.x,i.y=u.look.y,i.z=u.look.z),r&&(r.rotX=u.rotX,r.rotY=u.rotY,r.rotZ=u.rotZ),s&&(s.intensity=u.thruster),o&&(o.value=u.fov),c&&(c.value=u.focus);const T=t==null?void 0:t.current;T&&(T.position.x=Math.sin(E*.31)*.04,T.position.y=Math.sin(E*.23)*.055,T.position.z=Math.sin(E*.17)*.03,T.rotation.x=u.rotX+Math.sin(E*.07)*.005,T.rotation.y=u.rotY+Math.sin(E*.09)*.008,T.rotation.z=u.rotZ+Math.sin(E*.11)*.004),u.card!==S&&(S=u.card,p&&p(u.card)),u.phase!==I&&(I=u.phase,l&&l(u.phase))};return w=requestAnimationFrame(z),()=>{L=!1,cancelAnimationFrame(w)}},[n,t,r,a,i,s,o,c,l,p,y])}const le=[{tag:"Observation Layer",title:`Intelligente
...
`;let he=!1,xe=!1;function He(){if(he)return;he=!0;const n=document.createElement("style");if(n.textContent=$e,document.head.appendChild(n),document.title="NILL — Intelligenz, die mitarbeitet.",!window.THREE&&!xe){xe=!0;const t=document.createElement("script");t.src="https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js",document.head.appendChild(t)}}function $(n=.12){const t=d.useRef(null),[r,a]=d.useState(!1);return d.useEffect(()=>{if(!t.current)return;const i=new IntersectionObserver(([s])=>{s.isIntersecting&&(a(!0),i.disconnect())},{threshold:n});return i.observe(t.current),()=>i.disconnect()},[]),[t,r]}function ge(n){d.useEffect(()=>{const t=n.current;if(!t)return;const r=i=>{const s=t.getBoundingClientRect();t.style.setProperty("--mx",(i.clientX-s.left)/s.width*100+"%"),t.style.setProperty("--my",(i.clientY-s.top)/s.height*100+"%");const o=(i.clientY-s.top-s.height/2)/s.height*-4,c=(i.clientX-s.left-s.width/2)/s.width*4;t.style.transform=`translateY(-4px) perspective(900px) rotateX(${o}deg) rotateY(${c}deg)`},a=()=>t.style.transform="";return t.addEventListener("mousemove",r),t.addEventListener("mouseleave",a),()=>{t.removeEventListener("mousemove",r),t.removeEventListener("mouseleave",a)}},[])}function Ve(n){d.useEffect(()=>{const t=n.current;if(!t)return;const r=i=>{const s=t.getBoundingClientRect();t.style.transform=`translate(${(i.clientX-s.left-s.width/2)/s.width*18}px,${(i.clientY-s.top-s.height/2)/s.height*18}px)`},a=()=>t.style.transform="";return t.addEventListener("mousemove",r),t.addEventListener("mouseleave",a),()=>{t.removeEventListener("mousemove",r),t.removeEventListener("mouseleave",a)}},[])}function R({className:n,children:t,onClick:r,href:a}){const i=d.useRef(null);return Ve(i),a?e.jsx("a",{ref:i,href:a,className:n,onClick:r,children:t}):e.jsx("button",{ref:i,className:n,onClick:r,children:t})}function Z({className:n,style:t,children:r}){const a=d.useRef(null);return ge(a),e.jsx("article",{ref:a,className:`card ${n||""}`,style:t,children:r})}const me=`
  vec3 _m3(vec3 x){return x-floor(x*(1./289.))*289.;}
  vec4 _m4(vec4 x){return x-floor(x*(1./289.))*289.;}
...
`;function rt(n){const t=THREE,r=new t.WebGLRenderer({canvas:n,antialias:!1,powerPreference:"high-performance"});r.setPixelRatio(Math.min(devicePixelRatio,1)),r.setClearColor(131850,1);const a=new t.Scene,i=new t.PerspectiveCamera(42,2,.1,300);i.position.set(0,1.8,11),i.lookAt(0,0,0);const s=2200,o=new Float32Array(s*3),c=new Float32Array(s),l=new Float32Array(s*3);for(let h=0;h<s;h++){const M=60+Math.random()*70,j=Math.random()*Math.PI*2,A=Math.acos(2*Math.random()-1);o[h*3]=M*Math.sin(A)*Math.cos(j),o[h*3+1]=M*Math.sin(A)*Math.sin(j),o[h*3+2]=M*Math.cos(A),c[h]=.4+Math.random()*1.4;const F=Math.random();l[h*3]=F<.15?1:F>.85?.7:.95,l[h*3+1]=F<.15?.85:F>.85?.8:.95,l[h*3+2]=F<.15?.7:F>.85?1:.95}const p=new t.BufferGeometry;p.setAttribute("position",new t.BufferAttribute(o,3)),p.setAttribute("starSize",new t.BufferAttribute(c,1)),p.setAttribute("color",new t.BufferAttribute(l,3));const y=new t.ShaderMaterial({uniforms:{},vertexShader:"attribute float starSize;attribute vec3 color;varying vec3 vC;void main(){vC=color;vec4 mv=modelViewMatrix*vec4(position,1.);gl_PointSize=starSize*(700./-mv.z);gl_Position=projectionMatrix*mv;}",fragmentShader:"varying vec3 vC;void main(){vec2 uv=gl_PointCoord-.5;float a=1.-smoothstep(.25,.5,length(uv));if(a<.01)discard;gl_FragColor=vec4(vC,a*.85);}",transparent:!0,depthWrite:!1,blending:t.AdditiveBlending}),w=new t.Points(p,y);a.add(w);const f=new t.Group;f.rotation.x=-.55,f.rotation.z=.07,a.add(f);const N=new t.Group;f.add(N);const S=new t.ShaderMaterial({uniforms:{uTime:{value:0}},vertexShader:"varying vec3 vP;varying vec3 vN;void main(){vP=position;vN=normal;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}",fragmentShader:me+`
