...
`,P={nill:"◈",emails:"✉",accounting:"◎",calendar:"▦",team:"⌘",arbeitsstation:"▤",settings:"◉",ausweis:"▣"},T={rechnung:{bg:"rgba(198,255,60,.1)",color:"#c6ff3c",icon:"◎",label:"Rechnung"},buchung:{bg:"rgba(122,92,255,.12)",color:"#a585ff",icon:"⊕",label:"Buchung"},steuer:{bg:"rgba(255,179,71,.1)",color:"#ffb347",icon:"◈",label:"Steuer"},export:{bg:"rgba(255,179,71,.1)",color:"#ffb347",icon:"⊠",label:"Export"},team:{bg:"rgba(56,245,208,.1)",color:"#38f5d0",icon:"⬡",label:"Team"},update:{bg:"rgba(197,165,114,.1)",color:"#c5a572",icon:"◧",label:"Update"},email:{bg:"rgba(198,255,60,.08)",color:"#c6ff3c",icon:"✉",label:"E-Mail"},system:{bg:"rgba(122,92,255,.08)",color:"#7a5cff",icon:"◈",label:"System"}},te=[{id:"u-260608",cat:"update",title:"NILL v2.4 — Buchhaltung Sidebar",desc:"Neue Sidebar-Navigation mit gruppierten Bereichen, 20 neue Statistik-Widgets (Kundentaktivität, Prognose, Stornoquote, Jahr-über-Jahr, …)",ts:"2026-06-08T10:00:00Z",link:"/changelog"},{id:"u-260607",cat:"update",title:"NILL v2.3 — Push-Benachrichtigungen",desc:"Native Push-Notifications für neue E-Mails — auch wenn die App im Hintergrund läuft (PWA & Safari).",ts:"2026-06-07T09:00:00Z",link:"/changelog"},{id:"u-260604",cat:"update",title:"NILL v2.2 — Mobile PWA",desc:"Bottom Tab Bar, Safe-Area Support für iPhone-Notch, mobiles Buchhaltungs-Layout überarbeitet.",ts:"2026-06-04T08:00:00Z",link:"/changelog"},{id:"u-260523",cat:"update",title:"NILL v2.1 — Sicherheits-Patch",desc:"4 kritische Sicherheitslücken geschlossen (Session-Token, CORS, Content-Security-Policy, Rate-Limiting).",ts:"2026-05-23T08:00:00Z",link:"/changelog"}];function ne(p){const l=new Date(p),s=new Date-l,c=s/36e5,h=s/864e5;return c<1?`vor ${Math.max(1,Math.round(c*60))} Min.`:c<24?`vor ${Math.round(c)} Std.`:h<2?"Gestern":h<7?`vor ${Math.round(h)} Tagen`:l.toLocaleDateString("de-DE",{day:"2-digit",month:"short"})}function ae(p){const l=new Date().toDateString(),b=new Date(Date.now()-864e5).toDateString(),s={};for(const c of p){const h=new Date(c.ts),x=h.toDateString(),f=x===l?"Heute":x===b?"Gestern":h.toLocaleDateString("de-DE",{weekday:"long",day:"numeric",month:"long"});s[f]||(s[f]=[]),s[f].push(c)}return Object.entries(s)}function ie(){return e.jsxs("svg",{width:"15",height:"15",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("path",{d:"M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"}),e.jsx("path",{d:"M13.73 21a2 2 0 0 1-3.46 0"})]})}function ge(){const[p,l]=d.useState(!1),[b,s]=d.useState(!1),[c,h]=d.useState(null),[x,f]=d.useState([]),[W,D]=d.useState(null),[w,B]=d.useState(()=>localStorage.getItem("nill_accounting_mode")||"doppelt"),[j,v]=d.useState(!1),[N,L]=d.useState([]),[_,O]=d.useState(()=>localStorage.getItem("nill_feed_seen")||"1970-01-01T00:00:00Z"),{hasFeature:R,hasModule:K,isCompanyAdmin:I,org:z}=q(),Z=n=>{n.preventDefault(),n.stopPropagation();const r=w==="doppelt"?"einfach":"doppelt";localStorage.setItem("nill_accounting_mode",r),B(r)};d.useEffect(()=>{if(!j)return;const n=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=n}},[j]),d.useEffect(()=>{m.get("/me/profile").then(a=>h(a.data.name||null)).catch(()=>{}),m.get("/me/onboarding-status").then(a=>{a.data.is_subscription_active&&!a.data.has_seen_onboarding&&l(!0),D(a.data.ai_email_processing_consent===!0)}).catch(()=>{D(!0)}),m.get("/me/notifications").then(a=>f(a.data||[])).catch(()=>{});const n=te.map(a=>({...a})),r=a=>L(i=>{const t=[...i,...a].sort((g,S)=>new Date(S.ts)-new Date(g.ts)),o=new Set;return t.filter(g=>!o.has(g.id)&&o.add(g.id))});L([...n]),Promise.allSettled([m.get("/api/v1/aktivitaeten").then(a=>{const i=(a.data||[]).slice(0,30).map(t=>({id:`act-${t.id||t.ts}`,cat:t.kategorie||t.typ||"system",title:t.titel||t.nachricht||"Aktivität",desc:t.beschreibung||null,ts:t.erstellt_am||t.ts||new Date().toISOString(),link:t.link||null}));i.length&&r(i)}),m.get("/api/v1/rechnungen",{params:{limit:8}}).then(a=>{const i=(a.data||[]).map(t=>({id:`rec-${t.id}`,cat:"rechnung",title:`Rechnung ${t.nummer||t.id||""} — ${t.partner_name||t.partner||t.empfaenger_name||"Kunde"}`,desc:`${Number(t.betrag_netto||t.betrag_brutto||0).toLocaleString("de-DE",{minimumFractionDigits:2})} €`,ts:t.datum||t.erstellt_am||new Date().toISOString(),link:"/dashboard/accounting"}));i.length&&r(i)}),m.get("/api/v1/buchhaltung/buchungen",{params:{limit:6}}).then(a=>{const i=(a.data||[]).map(t=>({id:`bch-${t.id}`,cat:"buchung",title:t.buchungstext||"Buchung",desc:`${Number(t.betrag||0).toLocaleString("de-DE",{minimumFractionDigits:2})} €`,ts:t.buchungsdatum||t.erstellt_am||new Date().toISOString(),link:"/dashboard/accounting"}));i.length&&r(i)}),m.get("/api/v1/steuerexport").then(a=>{const i=(a.data||[]).slice(0,4).map(t=>({id:`tax-${t.id}`,cat:"export",title:`Steuerexport erstellt — ${t.typ||"UStVA"} ${t.zeitraum||""}`,desc:t.erstellt_von?`von ${t.erstellt_von}`:null,ts:t.erstellt_am||new Date().toISOString(),link:"/dashboard/accounting"}));i.length&&r(i)}),m.get("/api/v1/mitarbeiter").then(a=>{const i=(a.data||[]).filter(t=>t.beigetreten_am).slice(0,5).map(t=>({id:`emp-${t.id}`,cat:"team",title:`${t.name||"Mitarbeiter"} beigetreten`,desc:t.rolle||t.abteilung||null,ts:t.beigetreten_am,link:"/dashboard/workflow"}));i.length&&r(i)}),m.get("/inventory/activity",{params:{limit:20}}).then(a=>{var o;const i={"inventory.item.create":"Artikel angelegt","inventory.item.update":"Artikel geändert","inventory.item.delete":"Artikel gelöscht","inventory.item.quantity":"Bestand aktualisiert","inventory.list.create":"Liste angelegt","inventory.list.update":"Liste geändert","inventory.list.delete":"Liste gelöscht","inventory.delivery_note.confirm":"Lieferschein bestätigt","inventory.entry.create":"Eintrag hinzugefügt","inventory.entry.delete":"Eintrag gelöscht"},t=(((o=a.data)==null?void 0:o.items)||[]).map(g=>{var E;const S=(E=g.details)!=null&&E.name?` — ${g.details.name}`:"";return{id:`inv-${g.id}`,cat:"inventur",title:`${i[g.action]||"Inventur-Änderung"}${S}`,desc:g.actor_name?`von ${g.actor_name}`:null,ts:g.created_at||new Date().toISOString(),link:"/dashboard/workflow/Delivery-notes"}});t.length&&r(t)}),m.get("/workflow/tasks",{params:{status:"completed",limit:15}}).then(a=>{var t;const i=(((t=a.data)==null?void 0:t.items)||[]).filter(o=>o.completed_at).map(o=>({id:`task-${o.id}`,cat:"task",title:`Aufgabe erledigt — ${o.title}`,desc:o.completed_by_name?`von ${o.completed_by_name}`:null,ts:o.completed_at,link:"/dashboard/workflow/tasks"}));i.length&&r(i)})])},[]);const G=async()=>{l(!1),setTimeout(()=>s(!0),400),m.post("/me/onboarding-complete").catch(()=>{})},U=[{key:"emails",title:"E-Mails",desc:"Postfach, Filter & Kategorien",link:"/dashboard/emails",feature:"email",module:"emails"},{key:"team",title:"Team",desc:"Aufgaben, Prozesse & Rollen",link:"/dashboard/workflow",feature:null,module:null},{key:"arbeitsstation",title:"Arbeitsstation",desc:"Zeiterfassung, Aufgaben & Lieferscheine",link:"/station",feature:null,module:null,isStation:!0},{key:"ausweis",title:"Mein Ausweis",desc:"QR-Code zum Ein-/Ausstempeln",link:"/ausweis",feature:null,module:null},{key:"accounting",title:"Buchhaltung",desc:"Rechnungen, Einnahmen & Ausgaben",link:"/dashboard/accounting",feature:"accounting",module:"accounting"},{key:"calendar",title:"Kalender",desc:"Termine, Planung & Events",link:"/dashboard/calendar",feature:"calendar",module:"calendar"},{key:"settings",title:"Einstellungen",desc:"Account & Verbindungen",link:"/dashboard/settings",feature:null,module:null,adminOnly:!0}].filter(n=>!n.adminOnly||I()).filter(n=>(!n.module||K(n.module))&&(!n.feature||R(n.feature))),k=N.filter(n=>new Date(n.ts)>new Date(_)).length,H=()=>v(!0),J=()=>{const n=new Date().toISOString();O(n),localStorage.setItem("nill_feed_seen",n)},C=(z==null?void 0:z.name)??c??null,M=new Date().getHours(),$=M<12?"Guten Morgen":M<18?"Guten Tag":"Guten Abend";return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:ee}),e.jsx(Q,{isOpen:p,onClose:G}),e.jsx(Y,{isOpen:b,onFinish:()=>s(!1)}),j&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"nd-feed-backdrop",onClick:()=>v(!1)}),e.jsxs("div",{className:"nd-feed-panel",role:"dialog","aria-label":"Aktivitäten",children:[e.jsxs("div",{className:"nd-feed-hdr",children:[e.jsx("div",{className:"nd-feed-hdr-title",children:"Aktivitäten"}),k>0&&e.jsx("button",{className:"nd-feed-read-btn",onClick:J,children:"Alle gelesen"}),e.jsx("button",{className:"nd-feed-close",onClick:()=>v(!1),"aria-label":"Schließen",children:"✕"})]}),e.jsx("div",{className:"nd-feed-body",children:N.length===0?e.jsx("div",{className:"nd-feed-empty",children:"Noch keine Aktivitäten"}):ae(N).map(([n,r])=>e.jsxs("div",{children:[e.jsx("div",{className:"nd-feed-group",children:n}),r.map(a=>{const i=T[a.cat]||T.system,t=new Date(a.ts)>new Date(_),o=e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"nd-feed-item-dot"}),e.jsx("div",{className:"nd-feed-item-icon",style:{background:i.bg},children:e.jsx("span",{style:{color:i.color},children:i.icon})}),e.jsxs("div",{className:"nd-feed-item-body",children:[e.jsx("div",{className:"nd-feed-item-title",children:a.title}),a.desc&&e.jsx("div",{className:"nd-feed-item-desc",children:a.desc})]}),e.jsx("div",{className:"nd-feed-item-time",children:ne(a.ts)})]});return a.link?e.jsx("a",{href:a.link,className:`nd-feed-item${t?" nd-unread":""}`,onClick:()=>v(!1),children:o},a.id):e.jsx("div",{className:`nd-feed-item${t?" nd-unread":""}`,children:o},a.id)})]},n))})]})]}),e.jsx(V,{noScroll:!0,footer:e.jsx(X,{}),children:e.jsxs("div",{className:"nd-root",children:[e.jsxs(u.div,{className:"nd-welcome",initial:{opacity:0,y:16},animate:{opacity:1,y:0},transition:{duration:.6},children:[e.jsxs("button",{className:"nd-bell-btn",onClick:H,"aria-label":"Aktivitäten & Mitteilungen",children:[e.jsx(ie,{}),k>0&&e.jsx("span",{className:"nd-bell-badge",children:k>9?"9+":k})]}),e.jsx("div",{className:"nd-welcome-eyebrow",children:"Dashboard"}),e.jsx("h1",{children:C?e.jsxs(e.Fragment,{children:[$,", ",e.jsxs("em",{children:[C,"."]})]}):e.jsxs(e.Fragment,{children:[$,e.jsx("em",{children:"."})]})}),e.jsx("p",{className:"nd-welcome-sub",children:"Alles im grünen Bereich — keine offenen Aufgaben."}),x.length>0&&e.jsx("div",{className:"nd-notifs",children:x.slice(0,2).map((n,r)=>e.jsx("div",{className:"nd-notif",children:n.message},r))})]}),W===!1&&I()&&e.jsxs(u.div,{className:"nd-ai-banner",initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{duration:.45},children:[e.jsx("div",{className:"nd-ai-banner-icon",children:"◈"}),e.jsxs("div",{className:"nd-ai-banner-body",children:[e.jsx("div",{className:"nd-ai-banner-tag",children:"EU AI Act · Deine Zustimmung erforderlich"}),e.jsx("div",{className:"nd-ai-banner-title",children:"KI E-Mail-Analyse noch nicht aktiviert"}),e.jsx("p",{className:"nd-ai-banner-desc",children:"NILL kann eingehende E-Mails automatisch zusammenfassen, priorisieren und kategorisieren — aber nur mit deiner ausdrücklichen Zustimmung. Aktiviere die Funktion in den Einstellungen."})]}),e.jsx(A,{to:"/dashboard/settings?tab=integrationen",className:"nd-ai-banner-cta",children:"Jetzt aktivieren →"})]}),e.jsx("div",{className:"nd-section-label",children:"Module"}),e.jsx("div",{className:"nd-grid",children:U.map((n,r)=>n.isStation?e.jsx(u.div,{initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{delay:r*.05},children:e.jsxs(A,{to:n.link,className:"nd-card",style:{display:"flex"},children:[e.jsx("div",{className:"nd-card-icon",children:P[n.key]||"▤"}),e.jsxs("div",{children:[e.jsx("div",{className:"nd-card-title",children:n.title}),e.jsx("span",{className:"nd-soon-badge",style:{background:"rgba(198,255,60,.1)",borderColor:"rgba(198,255,60,.25)",color:"var(--accent)"},children:"Tablet & Kiosk"}),e.jsx("p",{className:"nd-card-desc",style:{marginTop:6},children:n.desc})]}),e.jsxs("div",{className:"nd-card-arrow",children:["Station öffnen ",e.jsx("span",{children:"→"})]})]})},n.key):e.jsx(u.div,{initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{delay:r*.05},children:e.jsxs(A,{to:n.link,className:"nd-card",style:{display:"flex"},children:[e.jsx("div",{className:"nd-card-icon",children:P[n.key]||"◎"}),e.jsxs("div",{children:[e.jsx("div",{className:"nd-card-title",children:n.title}),e.jsx("p",{className:"nd-card-desc",children:n.desc}),n.key==="accounting"&&e.jsxs("span",{className:"nd-mode-toggle",onClick:Z,title:"Buchhaltungsart umschalten",children:[e.jsx("span",{className:"nd-mode-toggle-label",children:"Modus"}),e.jsx("span",{className:`nd-mode-pill nd-mode-pill-${w}`,children:w==="doppelt"?"Doppelt":"Einfach"})]})]}),e.jsxs("div",{className:"nd-card-arrow",children:["Öffnen ",e.jsx("span",{children:"→"})]})]})},n.key))})]})})]})}export{ge as default};
