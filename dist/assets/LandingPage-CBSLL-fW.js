import{a as d,j as e}from"./vendor-react--hPKs4bs.js";import{L as Q}from"./vendor-router-C68Dx3I_.js";import{u as le,T as Ze,C as ce,R as Xe,a as Je,F as Qe,B as $e,b as ne,S as xe,A as ue,V as Se,c as et,d as tt,e as at}from"./vendor-three-Bk8Ut5pD.js";/* empty css                */import"./vendor-misc-CXStdJRK.js";function nt(){const r=document.createElement("canvas");r.width=1024,r.height=512;const a=r.getContext("2d");a.fillStyle="#d4d6dc",a.fillRect(0,0,1024,512);for(let i=0;i<2400;i++)a.fillStyle=`rgba(${100+(Math.random()*40|0)},${100+(Math.random()*40|0)},${110+(Math.random()*40|0)},${.08+Math.random()*.12})`,a.fillRect(Math.random()*1024,Math.random()*512,1+Math.random()*3,1);a.strokeStyle="rgba(20,22,28,.55)",a.lineWidth=1.2;for(let i=0;i<1024;i+=64)a.beginPath(),a.moveTo(i,0),a.lineTo(i,512),a.stroke();for(let i=0;i<512;i+=64)a.beginPath(),a.moveTo(0,i),a.lineTo(1024,i),a.stroke();a.fillStyle="rgba(40,44,52,.7)";for(let i=8;i<1024;i+=32)for(let l=8;l<512;l+=32)a.fillRect(i,l,1.5,1.5);for(let i=0;i<14;i++){const l=Math.random()*844,c=Math.random()*422,o=80+Math.random()*100,m=40+Math.random()*60;a.strokeStyle="rgba(15,17,22,.7)",a.lineWidth=2,a.strokeRect(l,c,o,m),a.fillStyle="rgba(50,55,65,.18)",a.fillRect(l,c,o,m)}for(let i=0;i<60;i++)a.fillStyle=`rgba(${30+(Math.random()*40|0)},${28+(Math.random()*30|0)},${28+(Math.random()*30|0)},${.15+Math.random()*.25})`,a.fillRect(Math.random()*1024,Math.random()*512,30+Math.random()*120,1+Math.random()*3);a.fillStyle="rgba(220,200,40,.55)",a.font="bold 14px monospace",["CAUTION","HATCH-A4","MOD-7","EXT-VENT","HIGH-V","NILL-OS"].forEach((i,l)=>a.fillText(i,60+l*160,40+l%2*220));const s=new ce(r);return s.wrapS=s.wrapT=Xe,s.anisotropy=8,s}function rt(){const r=document.createElement("canvas");r.width=512,r.height=256;const a=r.getContext("2d"),s=a.createLinearGradient(0,0,512,256);s.addColorStop(0,"#0a1840"),s.addColorStop(.5,"#1a3878"),s.addColorStop(1,"#0a1d54"),a.fillStyle=s,a.fillRect(0,0,512,256);const i=32,l=32;for(let o=0;o<512;o+=i)for(let m=0;m<256;m+=l){const g=.8+Math.random()*.3;a.fillStyle=`rgba(${30*g|0},${60*g|0},${140*g|0},.95)`,a.fillRect(o+1,m+1,i-2,l-2);const k=a.createLinearGradient(o,m,o+i,m+l);k.addColorStop(0,"rgba(120,180,255,.18)"),k.addColorStop(.5,"rgba(255,255,255,.05)"),k.addColorStop(1,"rgba(20,40,90,.2)"),a.fillStyle=k,a.fillRect(o+1,m+1,i-2,l-2),a.fillStyle="rgba(180,190,210,.4)",a.fillRect(o+i/2-.5,m+1,1,l-2)}a.strokeStyle="rgba(8,12,28,.85)",a.lineWidth=1;for(let o=0;o<=512;o+=i)a.beginPath(),a.moveTo(o,0),a.lineTo(o,256),a.stroke();for(let o=0;o<=256;o+=l)a.beginPath(),a.moveTo(0,o),a.lineTo(512,o),a.stroke();const c=new ce(r);return c.anisotropy=8,c}function it(){const n=document.createElement("canvas");n.width=n.height=128;const t=n.getContext("2d"),r=t.createRadialGradient(64,64,0,64,64,64);return r.addColorStop(0,"rgba(255,255,255,1)"),r.addColorStop(.3,"rgba(255,255,255,.5)"),r.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=r,t.fillRect(0,0,128,128),new ce(n)}function st(){const n=document.createElement("canvas");n.width=512,n.height=64;const t=n.getContext("2d");t.fillStyle="#181a20",t.fillRect(0,0,512,64);for(let r=0;r<24;r++){const a=20+r*20,s=t.createRadialGradient(a+6,32,0,a+6,32,12);s.addColorStop(0,"rgba(255,240,200,1)"),s.addColorStop(.4,"rgba(180,220,255,.85)"),s.addColorStop(1,"rgba(40,80,160,0)"),t.fillStyle=s,t.fillRect(a-6,16,24,32),t.strokeStyle="#2a2d35",t.lineWidth=2,t.strokeRect(a,22,12,20)}return new ce(n)}function ot(n){const t=Ze,r=nt(),a=rt(),s=it(),i=st(),l=new t.MeshStandardMaterial({map:r,color:16777215,metalness:.65,roughness:.42}),c=new t.MeshStandardMaterial({map:r,color:10133680,metalness:.7,roughness:.5}),o=new t.MeshStandardMaterial({color:13041468,emissive:7178772,emissiveIntensity:.9,metalness:.5,roughness:.35}),m=new t.MeshStandardMaterial({color:1842982,metalness:.75,roughness:.55}),g=new t.MeshStandardMaterial({color:13148234,metalness:.85,roughness:.25,emissive:3811848,emissiveIntensity:.15}),k=new t.MeshStandardMaterial({map:a,metalness:.7,roughness:.35,emissive:661560,emissiveIntensity:.18,side:t.DoubleSide}),j=new t.MeshBasicMaterial({map:i,transparent:!0,opacity:.95}),b=new t.Group;n.add(b),[-1,0,1].forEach((v,p)=>{const x=new t.Mesh(new t.CylinderGeometry(.88,.88,.92,32),l);if(x.rotation.z=Math.PI/2,x.position.x=v*1,b.add(x),p<2){const f=new t.Mesh(new t.CylinderGeometry(.94,.94,.12,32),g);f.rotation.z=Math.PI/2,f.position.x=v*1+.5,b.add(f)}const N=new t.Mesh(new t.CylinderGeometry(.881,.881,.22,32,1,!0),j);N.rotation.z=Math.PI/2,N.position.x=v*1,b.add(N)}),[-1.5,1.5].forEach(v=>{const p=new t.Mesh(new t.SphereGeometry(.88,32,16,0,Math.PI*2,0,Math.PI/2),l);p.rotation.z=v>0?-Math.PI/2:Math.PI/2,p.position.x=v,b.add(p)});const I=new t.Group;I.position.y=.82,I.add(new t.Mesh(new t.CylinderGeometry(.32,.38,.15,24),l));const P=new t.Mesh(new t.SphereGeometry(.3,24,16,0,Math.PI*2,0,Math.PI/2),new t.MeshStandardMaterial({color:4880568,metalness:.9,roughness:.08,emissive:3823736,emissiveIntensity:.45,transparent:!0,opacity:.88}));P.position.y=.075,I.add(P);for(let v=0;v<6;v++){const p=v/6*Math.PI*2,x=new t.Mesh(new t.BoxGeometry(.012,.3,.012),m);x.position.set(Math.cos(p)*.27,.075,Math.sin(p)*.27),x.rotation.y=-p,I.add(x)}b.add(I),[-2.55,2.55].forEach(v=>{const p=new t.Group;p.position.x=v;const x=new t.Mesh(new t.CylinderGeometry(.58,.58,1.5,24),l);x.rotation.z=Math.PI/2,p.add(x);const N=new t.Mesh(new t.SphereGeometry(.58,24,16,0,Math.PI*2,0,Math.PI/2),g);N.rotation.z=v>0?-Math.PI/2:Math.PI/2,N.position.x=v>0?.75:-.75,p.add(N);const f=new t.Mesh(new t.TorusGeometry(.58,.03,8,24),o);f.rotation.y=Math.PI/2,f.position.x=v>0?.75:-.75,p.add(f);const z=new t.Mesh(new t.CylinderGeometry(.581,.581,.18,24,1,!0),j);z.rotation.z=Math.PI/2,p.add(z);for(let $=0;$<8;$++){const H=$/8*Math.PI*2,X=new t.Mesh(new t.BoxGeometry(.08,.04,.15),m);X.position.set((Math.random()-.5)*1,Math.cos(H)*.6,Math.sin(H)*.6),X.lookAt(X.position.x,0,0),p.add(X)}const C=new t.Mesh(new t.BoxGeometry(.4,.15,.12),m);C.position.set(0,-.62,0),p.add(C);const D=new t.Mesh(new t.CylinderGeometry(.04,.04,1.4,8),g);D.rotation.z=Math.PI/2,D.position.set(0,.58,.15),p.add(D),n.add(p)});const M=(v,p)=>{const x=new t.Group;x.position.x=v,[[-.13,-.13],[.13,-.13],[-.13,.13],[.13,.13]].forEach(([N,f])=>{const z=new t.Mesh(new t.CylinderGeometry(.018,.018,p,6),m);z.rotation.z=Math.PI/2,z.position.set(0,N,f),x.add(z)});for(let N=0;N<4;N++){const f=-p/2+(N+.5)*(p/4),z=new t.Mesh(new t.CylinderGeometry(.012,.012,.36,6),m);z.position.set(f,0,0),z.rotation.z=Math.PI/4,x.add(z);const C=new t.Mesh(new t.CylinderGeometry(.012,.012,.36,6),m);C.position.set(f,0,0),C.rotation.x=Math.PI/4,x.add(C)}return[-p/2,p/2].forEach(N=>{const f=new t.Mesh(new t.TorusGeometry(.18,.015,6,12),m);f.rotation.y=Math.PI/2,f.position.x=N,x.add(f)}),x};n.add(M(-1.7,.65)),n.add(M(1.7,.65));const S=[];[-1,1].forEach(v=>{const p=new t.Group,x=new t.Mesh(new t.CylinderGeometry(.13,.13,.35,12),c);x.position.y=v*.9,p.add(x);const N=new t.Mesh(new t.CylinderGeometry(.07,.07,1.7,10),c);N.position.y=v*1.95,p.add(N);const f=new t.Mesh(new t.SphereGeometry(.14,16,12),g);f.position.y=v*2.85,p.add(f),[-1,1].forEach(z=>{const C=new t.Group;C.position.set(z*2.4,v*2.85,0);const D=new t.Mesh(new t.PlaneGeometry(4.6,1.55,16,4),k);D.rotation.y=Math.PI/2*(z>0?1:-1),C.add(D);const $=new t.Mesh(new t.BoxGeometry(.08,1.55,4.6),c);C.add($);const H=new t.Mesh(new t.BoxGeometry(.18,.25,.25),m);H.position.x=z>0?-2.3:2.3,C.add(H),p.add(C),S.push(C)}),n.add(p)}),[-1,1].forEach(v=>{const p=new t.Mesh(new t.PlaneGeometry(1.2,.9),new t.MeshStandardMaterial({color:15790312,metalness:.1,roughness:.8,side:t.DoubleSide,emissive:2105376,emissiveIntensity:.05}));p.position.set(v*1.7,0,.85),p.rotation.x=Math.PI/2,n.add(p);const x=new t.Mesh(new t.BoxGeometry(1.2,.04,.04),m);x.position.set(v*1.7,0,.85),n.add(x)});const y=new t.Group;y.position.set(.4,0,1);const u=new t.Mesh(new t.CylinderGeometry(.05,.05,.55,10),c);u.position.y=.27,y.add(u);const W=new t.Mesh(new t.SphereGeometry(.08,12,10),g);W.position.y=.55,y.add(W);const T=new t.Mesh(new t.SphereGeometry(.42,24,16,0,Math.PI*2,0,Math.PI/2.5),new t.MeshStandardMaterial({color:15658724,metalness:.4,roughness:.3,side:t.DoubleSide}));T.position.y=.65,T.rotation.x=-.4,y.add(T);const Y=new t.Mesh(new t.ConeGeometry(.06,.18,10),m);Y.position.set(0,.82,.15),Y.rotation.x=Math.PI,y.add(Y);for(let v=0;v<3;v++){const p=v/3*Math.PI*2,x=new t.Mesh(new t.CylinderGeometry(.006,.006,.25,6),m);x.position.set(Math.cos(p)*.12,.75,.08+Math.sin(p)*.12),x.rotation.x=.4,x.rotation.z=p,y.add(x)}n.add(y);const U=new t.Group;U.position.set(-.6,0,1);const re=new t.Mesh(new t.CylinderGeometry(.025,.025,.8,8),m);re.position.y=.4,U.add(re);const ie=new t.Mesh(new t.SphereGeometry(.04,8,8),o);ie.position.y=.82,U.add(ie),n.add(U);const O=new t.Mesh(new t.CylinderGeometry(.32,.42,.48,24),c);O.position.set(0,-.85,.35),O.rotation.x=Math.PI/2,n.add(O);const te=new t.Mesh(new t.TorusGeometry(.34,.04,10,24),o);te.position.set(0,-1.05,.35),te.rotation.x=Math.PI/2,n.add(te);for(let v=0;v<4;v++){const p=v/4*Math.PI*2+Math.PI/4,x=new t.Mesh(new t.CylinderGeometry(.022,.022,.15,6),m);x.position.set(Math.cos(p)*.36,-1.05,.35+Math.sin(p)*.36),x.rotation.z=-Math.PI/2,n.add(x)}[[3.2,0,0],[-3.2,0,0],[0,1,1],[0,-1,1]].forEach(([v,p,x])=>{const N=new t.Group;N.position.set(v,p,x);for(let f=0;f<4;f++){const z=f/4*Math.PI*2,C=new t.Mesh(new t.ConeGeometry(.04,.12,8),m);C.position.set(Math.cos(z)*.08,Math.sin(z)*.08,0),C.rotation.x=Math.PI/2,N.add(C)}n.add(N)});const de=[];[[0,-2.9,.15],[0,-2.9,-.15],[0,-1.1,.35],[0,-1.1,-.05],[-3.2,0,0],[3.2,0,0]].forEach(([v,p,x])=>{const N=new t.Sprite(new t.SpriteMaterial({map:s,color:6336767,transparent:!0,opacity:0,blending:t.AdditiveBlending,depthWrite:!1}));N.scale.set(2.8,2.8,1),N.position.set(v,p,x),n.add(N);const f=new t.Sprite(new t.SpriteMaterial({map:s,color:15267071,transparent:!0,opacity:0,blending:t.AdditiveBlending,depthWrite:!1}));f.scale.set(.7,.7,1),f.position.set(v,p,x),n.add(f),de.push({outer:N,inner:f})});const Z=[];[[3.4,0,0,16724048],[-3.4,0,0,13041468],[0,2.95,1.2,16777215],[0,-2.95,1.2,16777215],[0,0,1.4,16747068],[0,0,-1.4,6741503]].forEach(([v,p,x,N])=>{const f=new t.Mesh(new t.SphereGeometry(.05,10,10),new t.MeshBasicMaterial({color:N,transparent:!0}));f.position.set(v,p,x);const z=new t.Sprite(new t.SpriteMaterial({map:s,color:N,transparent:!0,opacity:.6,blending:t.AdditiveBlending,depthWrite:!1}));z.scale.set(.4,.4,1),f.add(z),n.add(f),Z.push({mesh:f,halo:z})});const K=[new t.Vector3(0,.82,.2),new t.Vector3(-2.4,2.85,0),new t.Vector3(.4,.65,1)],R=K.map((v,p)=>{const x=new t.Sprite(new t.SpriteMaterial({map:s,color:[13041468,3732944,8019199][p],transparent:!0,opacity:0,blending:t.AdditiveBlending,depthWrite:!1}));return x.scale.set(3.5,3.5,1),x.position.copy(v),n.add(x),x});return{thrusterGlows:de,navLights:Z,focusHalos:R,FOCUS_ANCHORS:K,solarWings:S,dishGroup:y}}const lt=d.forwardRef(function({thrusterProxy:t,focusProxy:r,stationProxy:a},s){const i=d.useRef(),l=d.useRef(null);return d.useImperativeHandle(s,()=>i.current,[]),d.useEffect(()=>{if(!i.current)return;const c=ot(i.current);return l.current=c,()=>{l.current=null}},[]),le(({clock:c})=>{if(!l.current)return;const o=c.elapsedTime,m=(t==null?void 0:t.intensity)??0,g=(r==null?void 0:r.value)??-1,{thrusterGlows:k,navLights:j,focusHalos:b,solarWings:I,dishGroup:P}=l.current;I.forEach((M,S)=>{M.rotation.z=Math.sin(o*.06+S*1.4)*.22}),P.rotation.y=Math.sin(o*.05)*.3,P.rotation.x=Math.sin(o*.041+.7)*.08,k.forEach(({outer:M,inner:S},y)=>{const u=Math.sin(o*9+y*.8)*.5+.5;M.material.opacity=m*(.18+u*.07),S.material.opacity=m*(.45+u*.12)}),j.forEach(({mesh:M},S)=>{const y=Math.sin(o*(2.1+S*.43)+S*1.9)>.3;M.material.opacity=y?1:.04}),b.forEach((M,S)=>{const y=S===g?.36+Math.sin(o*1.8)*.07:0;M.material.opacity+=(y-M.material.opacity)*.06})}),e.jsx("group",{ref:i})}),ct=`
...
`;function dt(){const n=d.useRef(),{surfaceMat:t,atmoMat:r}=d.useMemo(()=>{const a=new Se(Math.cos(-53*Math.PI/180)*Math.cos(135*Math.PI/180),Math.sin(-53*Math.PI/180),Math.cos(-53*Math.PI/180)*Math.sin(135*Math.PI/180)).normalize(),s=new xe({uniforms:{uTime:{value:0},uSunDir:{value:a.clone()},uSeaLevel:{value:-.02},uCloudOpacity:{value:.45},uCloudSpeed:{value:.65},uCityLights:{value:1},uAtmoStrength:{value:0}},vertexShader:`
      ...
      `}),i=new xe({side:et,transparent:!0,depthWrite:!1,blending:ue,uniforms:{uSunDir:{value:a.clone()},uAtmoStrength:{value:.55}},vertexShader:`
      ...
      `});return{surfaceMat:s,atmoMat:i}},[]);return le(({clock:a})=>{t.uniforms.uTime.value=a.elapsedTime,n.current&&(n.current.rotation.y=a.elapsedTime*.075)}),e.jsxs("group",{ref:n,position:[-7.4,-7.5,-13.7],scale:1.14,children:[e.jsx("mesh",{material:t,children:e.jsx("sphereGeometry",{args:[2.7,96,64]})}),e.jsx("mesh",{material:r,children:e.jsx("sphereGeometry",{args:[2.92,64,48]})})]})}function pt(){const{geometry:t,material:r}=d.useMemo(()=>{const a=new Float32Array(6600),s=new Float32Array(2200),i=new Float32Array(2200*3);for(let o=0;o<2200;o++){const m=60+Math.random()*70,g=Math.random()*Math.PI*2,k=Math.acos(2*Math.random()-1);a[o*3]=m*Math.sin(k)*Math.cos(g),a[o*3+1]=m*Math.sin(k)*Math.sin(g),a[o*3+2]=m*Math.cos(k),s[o]=.4+Math.random()*1.4;const j=Math.random();i[o*3]=j<.15?1:j>.85?.7:.95,i[o*3+1]=j<.15?.85:j>.85?.8:.95,i[o*3+2]=j<.15?.7:j>.85?1:.95}const l=new $e;l.setAttribute("position",new ne(a,3)),l.setAttribute("starSize",new ne(s,1)),l.setAttribute("color",new ne(i,3));const c=new xe({uniforms:{},vertexShader:`
      ...
      `,transparent:!0,depthWrite:!1,blending:ue});return{geometry:l,material:c}},[]);return e.jsx("points",{geometry:t,material:r})}function mt(){const{geometry:n,material:t}=d.useMemo(()=>{const a=new Float32Array(660),s=new Float32Array(220),i=new Float32Array(220);for(let o=0;o<220;o++)a[o*3]=(Math.random()-.5)*30,a[o*3+1]=(Math.random()-.5)*18,a[o*3+2]=-6+Math.random()*14,s[o]=.25+Math.random()*.9,i[o]=.3+Math.random()*1;const l=new $e;l.setAttribute("position",new ne(a,3)),l.setAttribute("aSpeed",new ne(s,1)),l.setAttribute("starSize",new ne(i,1));const c=new xe({uniforms:{uTime:{value:0}},vertexShader:`
      ...
      `,transparent:!0,depthWrite:!1,blending:ue});return{geometry:l,material:c}},[]);return le(({clock:r})=>{t.uniforms.uTime.value=r.elapsedTime}),e.jsx("points",{geometry:n,material:t})}function ht(){const n=d.useMemo(()=>{const t=document.createElement("canvas");t.width=t.height=256;const r=t.getContext("2d"),a=r.createRadialGradient(128,128,0,128,128,128);return a.addColorStop(0,"rgba(255,244,220,.95)"),a.addColorStop(.18,"rgba(255,210,150,.38)"),a.addColorStop(.5,"rgba(255,170,90,.08)"),a.addColorStop(1,"rgba(0,0,0,0)"),r.fillStyle=a,r.fillRect(0,0,256,256),new tt({map:new ce(t),transparent:!0,opacity:.5,blending:ue,depthWrite:!1,fog:!1})},[]);return le(({clock:t})=>{n.opacity=.46+Math.sin(t.elapsedTime*.8)*.06}),e.jsx("sprite",{material:n,position:[44.7,22.3,31.3],scale:[30,30,1]})}function xt({cameraProxy:n,lookProxy:t,fovProxy:r}){const{camera:a}=at(),s=d.useMemo(()=>new Se,[]),i=d.useMemo(()=>new Se,[]);return d.useEffect(()=>{a.position.set(0,1.6,28),a.fov=36,a.updateProjectionMatrix()},[]),le(({clock:l})=>{const c=l.elapsedTime,o=Math.sin(c*.19)*.06,m=Math.sin(c*.13)*.04,g=Math.sin(c*.07)*.05;i.set(((n==null?void 0:n.x)??0)+o,((n==null?void 0:n.y)??0)+m,((n==null?void 0:n.z)??16)+g),a.position.lerp(i,.18),s.set(((t==null?void 0:t.x)??0)+Math.sin(c*.17)*.025,((t==null?void 0:t.y)??0)+Math.cos(c*.21)*.02,(t==null?void 0:t.z)??0),a.lookAt(s),r&&Math.abs(a.fov-r.value)>.05&&(a.fov+=(r.value-a.fov)*.12,a.updateProjectionMatrix())}),null}function ut({issGroupRef:n,stationProxy:t,cameraProxy:r,lookProxy:a,thrusterProxy:s,fovProxy:i,focusProxy:l,onReady:c}){return d.useEffect(()=>{c==null||c()},[c]),e.jsxs(e.Fragment,{children:[e.jsx("ambientLight",{color:2107456,intensity:.35}),e.jsx("directionalLight",{color:16774364,intensity:2.4,position:[10,5,7]}),e.jsx("directionalLight",{color:4880568,intensity:.95,position:[6,-8,-4]}),e.jsx("directionalLight",{color:8965375,intensity:.45,position:[-7,3,-5]}),e.jsx(pt,{}),e.jsx(dt,{}),e.jsx(mt,{}),e.jsx(ht,{}),e.jsx(d.Suspense,{fallback:null,children:e.jsx(lt,{ref:n,thrusterProxy:s,focusProxy:l})}),e.jsx(xt,{cameraProxy:r,lookProxy:a,fovProxy:i})]})}function vt({issGroupRef:n,stationProxy:t,cameraProxy:r,lookProxy:a,thrusterProxy:s,fovProxy:i,focusProxy:l,onLoaded:c}){return e.jsx(Je,{dpr:[1,1.6],gl:{antialias:!0,alpha:!1,powerPreference:"high-performance"},style:{width:"100%",height:"100%",background:"#02030a"},camera:{fov:36,near:.1,far:300,position:[0,1.6,28]},onCreated:({scene:o})=>{o.fog=new Qe(131850,.025)},children:e.jsx(ut,{issGroupRef:n,stationProxy:t,cameraProxy:r,lookProxy:a,thrusterProxy:s,fovProxy:i,focusProxy:l,onReady:c})})}function ft(n){return n?n.split(/(<em>[^<]*<\/em>|\n)/g).map((t,r)=>{if(t===`
`)return e.jsx("br",{},r);const a=t.match(/^<em>([^<]*)<\/em>$/);return a?e.jsx("em",{children:a[1]},r):t||null}):null}const gt=d.forwardRef(function({index:t=0,total:r=3,tag:a,title:s,description:i,stats:l,position:c="tr",state:o="future"},m){const g=["iss-card",`pos-${c}`,o==="active"?"is-active":"",o==="past"?"is-past":""].filter(Boolean).join(" ");return e.jsxs("article",{ref:m,className:g,"aria-hidden":o!=="active",children:[e.jsxs("div",{className:"iss-card-index",children:[e.jsx("em",{children:String(t+1).padStart(2,"0")}),e.jsx("span",{children:"/"}),e.jsx("span",{children:String(r).padStart(2,"0")})]}),a&&e.jsx("div",{className:"iss-card-tag",children:a}),s&&e.jsx("h3",{children:ft(s)}),i&&e.jsx("p",{children:i}),l&&l.length>0&&e.jsx("div",{className:"iss-card-stats",children:l.map(([k,j],b)=>e.jsxs("div",{className:"iss-card-stat",children:[e.jsx("span",{className:"iss-card-stat-num",children:k}),e.jsx("span",{className:"iss-card-stat-lbl",children:j})]},b))})]})}),G=(n,t,r)=>n+(t-n)*r,He=(n,t,r)=>n<t?t:n>r?r:n,bt=n=>{const t=He(n,0,1);return t*t*t*(t*(t*6-15)+10)},oe=[{p:0,cam:{x:0,y:1.6,z:28},look:{x:0,y:0,z:0},rotX:.05,rotY:.2,rotZ:0,fov:36,thruster:0,focus:-1,card:-1,phase:"approach"},{p:.1,cam:{x:0,y:.7,z:13.5},look:{x:0,y:.1,z:0},rotX:.18,rotY:.85,rotZ:.04,fov:40,thruster:.25,focus:-1,card:-1,phase:"active"},{p:.26,cam:{x:-1.9,y:1.8,z:6.4},look:{x:0,y:.6,z:.2},rotX:-.06,rotY:1.55,rotZ:-.04,fov:38,thruster:0,focus:0,card:0,phase:"reveal"},{p:.46,cam:{x:3.6,y:-.1,z:8},look:{x:-.4,y:1.4,z:0},rotX:.08,rotY:2.55,rotZ:.08,fov:44,thruster:0,focus:1,card:1,phase:"reveal"},{p:.66,cam:{x:-2.3,y:-.6,z:6.6},look:{x:.4,y:-.05,z:.9},rotX:.18,rotY:3.45,rotZ:-.05,fov:36,thruster:0,focus:2,card:2,phase:"reveal"},{p:.86,cam:{x:0,y:2.9,z:19.5},look:{x:0,y:-.8,z:-1.8},rotX:.28,rotY:4.25,rotZ:-.05,fov:46,thruster:.55,focus:-1,card:-1,phase:"outro"},{p:1,cam:{x:0,y:3.4,z:23},look:{x:0,y:-1.1,z:-2.4},rotX:.3,rotY:4.45,rotZ:-.06,fov:48,thruster:.25,focus:-1,card:-1,phase:"outro"}];function yt(n){let t=0;for(;t<oe.length-2&&n>oe[t+1].p;)t++;const r=oe[t],a=oe[Math.min(t+1,oe.length-1)],s=a.p-r.p,i=s>1e-5?bt((n-r.p)/s):0;return{cam:{x:G(r.cam.x,a.cam.x,i),y:G(r.cam.y,a.cam.y,i),z:G(r.cam.z,a.cam.z,i)},look:{x:G(r.look.x,a.look.x,i),y:G(r.look.y,a.look.y,i),z:G(r.look.z,a.look.z,i)},rotX:G(r.rotX,a.rotX,i),rotY:G(r.rotY,a.rotY,i),rotZ:G(r.rotZ,a.rotZ,i),fov:G(r.fov,a.fov,i),thruster:G(r.thruster,a.thruster,i),focus:i>.65?a.focus:r.focus,card:i>.65?a.card:r.card,phase:i>.65?a.phase:r.phase}}function wt({sectionRef:n,issGroupRef:t,stationProxy:r,cameraProxy:a,lookProxy:s,thrusterProxy:i,fovProxy:l,focusProxy:c,onPhaseChange:o,onCardChange:m,damping:g=.07}={}){d.useEffect(()=>{if(!(n!=null&&n.current)){console.warn("[ISS] sectionRef.current ist null – RAF wurde nicht gestartet");return}let k=0,j=0,b=0,I=-2,P="",M=!0;const S=()=>{const u=n.current;if(!u)return;const W=u.getBoundingClientRect(),T=document.documentElement.clientHeight||window.innerHeight,Y=u.offsetHeight-T;if(Y<=0){j=0;return}j=He(-W.top/Y,0,1)},y=()=>{if(!M)return;k=requestAnimationFrame(y),S(),b=G(b,j,g),Math.abs(b-j)<1e-4&&(b=j);const u=yt(b),W=performance.now()/1e3;a&&(a.x=u.cam.x,a.y=u.cam.y,a.z=u.cam.z),s&&(s.x=u.look.x,s.y=u.look.y,s.z=u.look.z),r&&(r.rotX=u.rotX,r.rotY=u.rotY,r.rotZ=u.rotZ),i&&(i.intensity=u.thruster),l&&(l.value=u.fov),c&&(c.value=u.focus);const T=t==null?void 0:t.current;T&&(T.position.x=Math.sin(W*.31)*.04,T.position.y=Math.sin(W*.23)*.055,T.position.z=Math.sin(W*.17)*.03,T.rotation.x=u.rotX+Math.sin(W*.07)*.005,T.rotation.y=u.rotY+Math.sin(W*.09)*.008,T.rotation.z=u.rotZ+Math.sin(W*.11)*.004),u.card!==I&&(I=u.card,m&&m(u.card)),u.phase!==P&&(P=u.phase,o&&o(u.phase))};return k=requestAnimationFrame(y),()=>{M=!1,cancelAnimationFrame(k)}},[n,t,r,a,s,i,l,c,o,m,g])}const Me=[{tag:"Observation Layer",title:`Intelligente
...
<em>Orchestrierung</em>`,description:"Die Schüssel zeigt nach draußen — NILL spricht mit Banken, Behörden, Lieferanten. Workloads finden ihren Weg, ohne dass du ein Ticket öffnest.",stats:[["1.200+","aufgaben/tag"],["−60 %","manuelle arbeit"],["3 s","cold start"]],position:"br"}];function jt(){const n=d.useRef(null),t=d.useRef(null),r=[d.useRef(null),d.useRef(null),d.useRef(null)],[a,s]=d.useState(-1),[i,l]=d.useState("approach"),[c,o]=d.useState(!1),[m,g]=d.useState({x:"0.00",y:"0.00",z:"0.00"}),k=d.useMemo(()=>({rotX:0,rotY:0,rotZ:0}),[]),j=d.useMemo(()=>({x:0,y:1.6,z:28}),[]),b=d.useMemo(()=>({x:0,y:0,z:0}),[]),I=d.useMemo(()=>({intensity:0}),[]),P=d.useMemo(()=>({value:36}),[]),M=d.useMemo(()=>({value:-1}),[]);wt({sectionRef:n,issGroupRef:t,stationProxy:k,cameraProxy:j,lookProxy:b,thrusterProxy:I,fovProxy:P,focusProxy:M,onCardChange:s,onPhaseChange:l,damping:.07}),d.useEffect(()=>{let y=0,u=0;const W=T=>{y=requestAnimationFrame(W),!(T-u<120)&&(u=T,g({x:j.x.toFixed(2),y:j.y.toFixed(2),z:j.z.toFixed(2)}))};return y=requestAnimationFrame(W),()=>cancelAnimationFrame(y)},[j]);const S=y=>y===a?"active":a>y?"past":"future";return e.jsx("section",{ref:n,className:`iss-section ${c?"iss-loaded":""}`,"data-screen-label":"ISS",children:e.jsxs("div",{className:"iss-sticky","data-phase":i,children:[e.jsx("div",{className:"iss-canvas-wrap",children:e.jsx(vt,{issGroupRef:t,stationProxy:k,cameraProxy:j,lookProxy:b,thrusterProxy:I,fovProxy:P,focusProxy:M,onLoaded:()=>o(!0)})}),e.jsx("div",{className:"iss-bar top","aria-hidden":"true"}),e.jsx("div",{className:"iss-bar bot","aria-hidden":"true"}),e.jsx("div",{className:"iss-grain","aria-hidden":"true"}),e.jsxs("div",{className:"iss-hud tl",children:[e.jsxs("div",{children:[e.jsx("span",{className:"dot"}),"NILL · MISSION CONTROL"]}),e.jsx("div",{className:"label",children:"Orbital Layer · v1"})]}),e.jsxs("div",{className:"iss-hud tr",children:[e.jsx("div",{className:"label",children:"REF · NILL-OS / ISS-04"}),e.jsx("div",{className:"value",children:"42° 06′ 18″ N · 5° 23′ 41″ E"})]}),e.jsxs("div",{className:"iss-hud bl",children:[e.jsx("div",{className:"label",children:"CAMERA"}),e.jsxs("div",{className:"value",children:["x ",e.jsx("em",{children:m.x}),"  y ",e.jsx("em",{children:m.y}),"  z ",e.jsx("em",{children:m.z})]})]}),e.jsxs("div",{className:"iss-hud br",children:[e.jsx("div",{className:"label",children:"STATUS"}),e.jsx("div",{className:"value",children:i==="approach"?"APPROACH — STAND-BY":i==="reveal"?"REVEAL — MODULE FOCUS":"NOMINAL — TRACKING"})]}),e.jsx("div",{className:"iss-intro","aria-hidden":i!=="approach",children:e.jsxs("div",{className:"iss-intro-inner",children:[e.jsxs("span",{className:"eyebrow",children:[e.jsx("span",{className:"pip"}),"NILL · MISSION CONTROL"]}),e.jsxs("h2",{children:["Das Betriebssystem, das dein",e.jsx("br",{}),"Unternehmen ",e.jsx("em",{children:"im Orbit"})," hält."]}),e.jsx("p",{children:"Stell dir NILL als Raumstation vor: ein zentrales System, das alle Module deines Betriebs verbindet. Beobachtung, Energie, Kommunikation — orchestriert von einer KI, die nie schläft."})]})}),e.jsx("div",{className:"iss-outro","aria-hidden":i!=="outro",children:e.jsxs("div",{className:"iss-outro-inner",children:[e.jsxs("span",{className:"eyebrow",children:[e.jsx("span",{className:"pip"}),"READY · LAUNCH WINDOW OPEN"]}),e.jsxs("h2",{children:["Eine Plattform.",e.jsx("br",{}),"Ein Login. ",e.jsx("em",{children:"Alle Module."})]}),e.jsx("p",{children:"NILL hält deinen Betrieb in der Umlaufbahn — 24/7, ohne Tickets, ohne Bauchschmerzen. Bereit, die Station zu betreten?"}),e.jsxs("a",{className:"iss-outro-cta",href:"#cta",children:["Demo anfragen ",e.jsx("span",{className:"arrow",children:"→"})]})]})}),e.jsx("div",{className:"iss-card-stage",children:Me.map((y,u)=>e.jsx(gt,{ref:r[u],index:u,total:Me.length,tag:y.tag,title:y.title,description:y.description,stats:y.stats,position:y.position,state:S(u)},u))}),e.jsx("div",{className:"iss-progress","aria-hidden":"true",children:Me.map((y,u)=>e.jsx("div",{className:`iss-progress-dot ${u===a?"active":u<a?"passed":""}`},u))}),e.jsxs("div",{className:`iss-scroll-hint ${i!=="approach"?"hidden":""}`,children:[e.jsx("span",{children:"scroll · mission"}),e.jsx("span",{className:"iss-scroll-hint-line"})]})]})})}const Nt=`
:root{
...
`;let De=!1,Ge=!1;function kt(){if(De)return;De=!0;const n=document.createElement("style");if(n.textContent=Nt,document.head.appendChild(n),document.title="NILL — Intelligenz, die mitarbeitet.",!window.THREE&&!Ge){Ge=!0;const t=document.createElement("script");t.src="/three.min.js",document.head.appendChild(t)}}function q(n=.12){const t=d.useRef(null),[r,a]=d.useState(!1);return d.useEffect(()=>{if(!t.current)return;const s=new IntersectionObserver(([i])=>{i.isIntersecting&&(a(!0),s.disconnect())},{threshold:n});return s.observe(t.current),()=>s.disconnect()},[]),[t,r]}function ee({className:n="",stagger:t=!1,children:r,...a}){const[s,i]=q(.08);return e.jsx("div",{ref:s,className:`${t?"stagger":"reveal"}${i?" in":""} ${n}`,...a,children:r})}function Mt(){const n=d.useRef(null);return d.useEffect(()=>{let t,r=0;const a=()=>{t=requestAnimationFrame(a);const s=document.documentElement.scrollHeight-innerHeight,i=s>0?window.scrollY/s:0;r+=(i-r)*.12,n.current&&(n.current.style.transform=`scaleX(${r})`)};return t=requestAnimationFrame(a),()=>cancelAnimationFrame(t)},[]),e.jsx("div",{className:"scroll-progress","aria-hidden":"true",children:e.jsx("span",{ref:n})})}function Ve(n){d.useEffect(()=>{const t=n.current;if(!t)return;const r=s=>{const i=t.getBoundingClientRect();t.style.setProperty("--mx",(s.clientX-i.left)/i.width*100+"%"),t.style.setProperty("--my",(s.clientY-i.top)/i.height*100+"%");const l=(s.clientY-i.top-i.height/2)/i.height*-4,c=(s.clientX-i.left-i.width/2)/i.width*4;t.style.transform=`translateY(-4px) perspective(900px) rotateX(${l}deg) rotateY(${c}deg)`},a=()=>t.style.transform="";return t.addEventListener("mousemove",r),t.addEventListener("mouseleave",a),()=>{t.removeEventListener("mousemove",r),t.removeEventListener("mouseleave",a)}},[])}function St(n){d.useEffect(()=>{const t=n.current;if(!t)return;const r=s=>{const i=t.getBoundingClientRect();t.style.transform=`translate(${(s.clientX-i.left-i.width/2)/i.width*18}px,${(s.clientY-i.top-i.height/2)/i.height*18}px)`},a=()=>t.style.transform="";return t.addEventListener("mousemove",r),t.addEventListener("mouseleave",a),()=>{t.removeEventListener("mousemove",r),t.removeEventListener("mouseleave",a)}},[])}function _({className:n,children:t,onClick:r,href:a}){const s=d.useRef(null);return St(s),a?e.jsx("a",{ref:s,href:a,className:n,onClick:r,children:t}):e.jsx("button",{ref:s,className:n,onClick:r,children:t})}function ae({className:n,style:t,children:r}){const a=d.useRef(null);return Ve(a),e.jsx("article",{ref:a,className:`card ${n||""}`,style:t,children:r})}const ze=`
  vec3 _m3(vec3 x){return x-floor(x*(1./289.))*289.;}
  vec4 _m4(vec4 x){return x-floor(x*(1./289.))*289.;}
...
`;function Ft(n){const t=THREE,r=new t.WebGLRenderer({canvas:n,antialias:!0,powerPreference:"high-performance"});r.setPixelRatio(Math.min(devicePixelRatio,1.5)),r.setClearColor(131850,1);const a=new t.Scene,s=new t.PerspectiveCamera(42,2,.1,300);s.position.set(0,1.8,11),s.lookAt(0,0,0);const i=2200,l=new Float32Array(i*3),c=new Float32Array(i),o=new Float32Array(i*3),m=new Float32Array(i);for(let h=0;h<i;h++){m[h]=Math.random()*Math.PI*2;const A=60+Math.random()*70,w=Math.random()*Math.PI*2,E=Math.acos(2*Math.random()-1);l[h*3]=A*Math.sin(E)*Math.cos(w),l[h*3+1]=A*Math.sin(E)*Math.sin(w),l[h*3+2]=A*Math.cos(E),c[h]=.4+Math.random()*1.4;const L=Math.random();o[h*3]=L<.15?1:L>.85?.7:.95,o[h*3+1]=L<.15?.85:L>.85?.8:.95,o[h*3+2]=L<.15?.7:L>.85?1:.95}const g=new t.BufferGeometry;g.setAttribute("position",new t.BufferAttribute(l,3)),g.setAttribute("starSize",new t.BufferAttribute(c,1)),g.setAttribute("color",new t.BufferAttribute(o,3)),g.setAttribute("twinkle",new t.BufferAttribute(m,1));const k=new t.ShaderMaterial({uniforms:{uTime:{value:0}},vertexShader:"attribute float starSize;attribute vec3 color;attribute float twinkle;uniform float uTime;varying vec3 vC;varying float vTw;void main(){vC=color;vTw=.72+.28*sin(uTime*1.6+twinkle*7.);vec4 mv=modelViewMatrix*vec4(position,1.);gl_PointSize=starSize*(.85+.3*sin(uTime*1.1+twinkle*5.))*(700./-mv.z);gl_Position=projectionMatrix*mv;}",fragmentShader:"varying vec3 vC;varying float vTw;void main(){vec2 uv=gl_PointCoord-.5;float a=1.-smoothstep(.25,.5,length(uv));if(a<.01)discard;gl_FragColor=vec4(vC,a*.85*vTw);}",transparent:!0,depthWrite:!1,blending:t.AdditiveBlending}),j=new t.Points(g,k);a.add(j);const b=new t.Group;b.rotation.x=-.55,b.rotation.z=.07,a.add(b);const I=new t.Group;b.add(I);const P=new t.ShaderMaterial({uniforms:{uTime:{value:0}},vertexShader:"varying vec3 vP;varying vec3 vN;void main(){vP=position;vN=normal;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}",fragmentShader:ze+`
