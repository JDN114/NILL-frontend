import{a as i,j as e}from"./vendor-react--hPKs4bs.js";import{a as j,c as y}from"./vendor-router-BxWC8dWZ.js";import{a as k}from"./index-DsTSGAHm.js";import"./vendor-misc-CMqYbET0.js";function F(){const s=j(),[m]=y(),o=m.get("token")||"",[n,g]=i.useState(""),[t,f]=i.useState(""),[d,c]=i.useState(!1),[p,r]=i.useState(null),[x,b]=i.useState(!1);async function w(a){var u,h;if(a.preventDefault(),r(null),n.length<8){r("Passwort muss mindestens 8 Zeichen lang sein.");return}if(n!==t){r("Die Passwörter stimmen nicht überein.");return}c(!0);try{await k.post("/auth/reset-password",{token:o,password:n}),b(!0)}catch(l){r(((h=(u=l==null?void 0:l.response)==null?void 0:u.data)==null?void 0:h.detail)||"Ungültiger oder abgelaufener Link.")}finally{c(!1)}}return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
