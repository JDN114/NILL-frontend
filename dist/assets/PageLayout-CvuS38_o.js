import{a as m,j as a}from"./vendor-react--hPKs4bs.js";import{u as b,L as o}from"./vendor-router-B9EJrQcr.js";function s({compact:l=!1}){return a.jsx("span",{style:{marginLeft:l?"0.25rem":"0.4rem",fontSize:l?"0.55rem":"0.6rem",fontWeight:700,letterSpacing:"0.04em",padding:l?"0 0.2rem":"0.05rem 0.3rem",borderRadius:4,verticalAlign:"middle",color:"var(--nill-gold, #c5a572)",background:"var(--nill-gold-dim, rgba(197,165,114,0.15))",border:"1px solid rgba(197,165,114,0.35)"},children:"WIP"})}const d=[{label:"Dashboard",path:"/dashboard",exact:!0},{label:"Emails",path:"/dashboard/emails"},{label:"Kalender",path:"/dashboard/calendar"},{label:"Einstellungen",path:"/dashboard/settings"}],h=[{label:"Start",path:"/dashboard",exact:!0,icon:"◧"},{label:"E-Mails",path:"/dashboard/emails",icon:"✉"},{label:"Workflow",path:"/dashboard/workflow",icon:"⬡"},{label:"Mehr",path:"/dashboard/settings",icon:"◉"}];function g(){const{pathname:l}=b(),[i,r]=m.useState(!1),t=e=>e.exact?l===e.path:l.startsWith(e.path);return a.jsxs(a.Fragment,{children:[a.jsx("style",{children:`
      ...
      `}),a.jsxs("div",{className:`min-h-screen bg-[var(--bg-main)] text-[var(--text-main)] ${r?"nill-shell-mobilefixed":""} ${i&&!n?"nill-shell-noscroll":""}`,style:c?{display:"flex",flexDirection:"column",height:"100dvh",overflow:"hidden"}:{},children:[a.jsx(g,{}),n?a.jsx("div",{className:"nill-page-fixed",style:{flex:1,overflow:"hidden",display:"flex",flexDirection:"column"},children:l}):i?a.jsxs(a.Fragment,{children:[a.jsx("main",{className:"nill-page-main p-4 sm:p-6 max-w-7xl mx-auto w-full",style:{flex:1,overflow:"hidden",minHeight:0,boxSizing:"border-box"},children:l}),t]}):r?a.jsxs(a.Fragment,{children:[a.jsx("main",{className:"nill-page-main nill-main-mobilefixed p-4 sm:p-6 max-w-7xl mx-auto w-full",style:{boxSizing:"border-box"},children:l}),t]}):a.jsx("main",{className:"nill-page-main p-4 sm:p-6 max-w-7xl mx-auto w-full",children:l})]})]})}export{f as P};
