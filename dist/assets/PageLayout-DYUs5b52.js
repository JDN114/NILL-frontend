import{a as b,j as l}from"./vendor-react--hPKs4bs.js";import{a as d,L as t}from"./vendor-router-rhPWNlHF.js";const s=[{label:"Dashboard",path:"/dashboard",exact:!0},{label:"Emails",path:"/dashboard/emails"},{label:"Kalender",path:"/dashboard/calendar"},{label:"Buchhaltung",path:"/dashboard/accounting"},{label:"NILL",disabled:!0,gold:!0},{label:"Einstellungen",path:"/dashboard/settings"}];function c(){const{pathname:r}=d(),[n,i]=b.useState(!1),o=a=>a.exact?r===a.path:r.startsWith(a.path);return l.jsxs(l.Fragment,{children:[l.jsx("style",{children:`
        .nill-navbar {
