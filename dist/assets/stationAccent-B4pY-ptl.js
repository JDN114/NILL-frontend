import{j as a,a as t}from"./vendor-react--hPKs4bs.js";import{L as o}from"./vendor-router-B9EJrQcr.js";import{u as c}from"./index-BTOSmSS4.js";const d=`
  .asl-root {
    --asl-bg:        #040817;
...
`;function m(){const[s,e]=t.useState(new Date);return t.useEffect(()=>{const r=setInterval(()=>e(new Date),1e3);return()=>clearInterval(r)},[]),a.jsxs("div",{className:"asl-clock",children:[a.jsx("div",{className:"asl-clock-time",children:s.toLocaleTimeString("de-DE",{hour:"2-digit",minute:"2-digit",second:"2-digit"})}),a.jsx("div",{className:"asl-clock-date",children:s.toLocaleDateString("de-DE",{weekday:"short",day:"numeric",month:"short"})})]})}function v({children:s,title:e,icon:r,accent:i="#c5a572",maxWidth:n=900}){const{org:l}=c();return a.jsxs(a.Fragment,{children:[a.jsx("style",{children:d}),a.jsxs("div",{className:"asl-root",children:[a.jsxs("header",{className:"asl-hdr",children:[a.jsxs("div",{className:"asl-hdr-left",children:[a.jsx(o,{to:"/station",className:"asl-back",children:"←"}),a.jsxs("div",{children:[a.jsx("div",{className:"asl-breadcrumb",children:"ArbeitsStation"}),a.jsxs("div",{className:"asl-title",children:[r&&a.jsx("span",{style:{color:i,fontSize:"0.9em"},children:r}),e]})]})]}),a.jsx(m,{}),a.jsx("div",{className:"asl-org",children:(l==null?void 0:l.name)??"Nill"})]}),a.jsx("main",{className:"asl-main",style:{maxWidth:n},children:s})]})]})}const f={"#fbbf24":"#815d00","#38f5d0":"#03735d","#c6ff3c":"#4f6f00","#ff4d8d":"#c70048","#fb923c":"#a34900","#a78bfa":"#6938fc","#f87171":"#cb0505","#86efac":"#0c7432","#c5a572":"#806228"};function x(s,e){return e==="light"&&f[s]||s}export{v as A,x as a};
