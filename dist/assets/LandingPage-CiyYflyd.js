import{a as d,j as e}from"./vendor-react--hPKs4bs.js";import{L as Q}from"./vendor-router-DHr2oj4b.js";import{u as le,T as Ze,C as ce,R as Xe,a as Je,F as Qe,B as $e,b as ne,S as xe,A as ue,V as Se,c as et,d as tt,e as at}from"./vendor-three-BBl3idiH.js";/* empty css                */import"./vendor-misc-DR5OIT6T.js";function nt(){const r=document.createElement("canvas");r.width=1024,r.height=512;const a=r.getContext("2d");a.fillStyle="#d4d6dc",a.fillRect(0,0,1024,512);for(let s=0;s<2400;s++)a.fillStyle=`rgba(${100+(Math.random()*40|0)},${100+(Math.random()*40|0)},${110+(Math.random()*40|0)},${.08+Math.random()*.12})`,a.fillRect(Math.random()*1024,Math.random()*512,1+Math.random()*3,1);a.strokeStyle="rgba(20,22,28,.55)",a.lineWidth=1.2;for(let s=0;s<1024;s+=64)a.beginPath(),a.moveTo(s,0),a.lineTo(s,512),a.stroke();for(let s=0;s<512;s+=64)a.beginPath(),a.moveTo(0,s),a.lineTo(1024,s),a.stroke();a.fillStyle="rgba(40,44,52,.7)";for(let s=8;s<1024;s+=32)for(let l=8;l<512;l+=32)a.fillRect(s,l,1.5,1.5);for(let s=0;s<14;s++){const l=Math.random()*844,c=Math.random()*422,o=80+Math.random()*100,p=40+Math.random()*60;a.strokeStyle="rgba(15,17,22,.7)",a.lineWidth=2,a.strokeRect(l,c,o,p),a.fillStyle="rgba(50,55,65,.18)",a.fillRect(l,c,o,p)}for(let s=0;s<60;s++)a.fillStyle=`rgba(${30+(Math.random()*40|0)},${28+(Math.random()*30|0)},${28+(Math.random()*30|0)},${.15+Math.random()*.25})`,a.fillRect(Math.random()*1024,Math.random()*512,30+Math.random()*120,1+Math.random()*3);a.fillStyle="rgba(220,200,40,.55)",a.font="bold 14px monospace",["CAUTION","HATCH-A4","MOD-7","EXT-VENT","HIGH-V","NILL-OS"].forEach((s,l)=>a.fillText(s,60+l*160,40+l%2*220));const i=new ce(r);return i.wrapS=i.wrapT=Xe,i.anisotropy=8,i}function rt(){const r=document.createElement("canvas");r.width=512,r.height=256;const a=r.getContext("2d"),i=a.createLinearGradient(0,0,512,256);i.addColorStop(0,"#0a1840"),i.addColorStop(.5,"#1a3878"),i.addColorStop(1,"#0a1d54"),a.fillStyle=i,a.fillRect(0,0,512,256);const s=32,l=32;for(let o=0;o<512;o+=s)for(let p=0;p<256;p+=l){const g=.8+Math.random()*.3;a.fillStyle=`rgba(${30*g|0},${60*g|0},${140*g|0},.95)`,a.fillRect(o+1,p+1,s-2,l-2);const N=a.createLinearGradient(o,p,o+s,p+l);N.addColorStop(0,"rgba(120,180,255,.18)"),N.addColorStop(.5,"rgba(255,255,255,.05)"),N.addColorStop(1,"rgba(20,40,90,.2)"),a.fillStyle=N,a.fillRect(o+1,p+1,s-2,l-2),a.fillStyle="rgba(180,190,210,.4)",a.fillRect(o+s/2-.5,p+1,1,l-2)}a.strokeStyle="rgba(8,12,28,.85)",a.lineWidth=1;for(let o=0;o<=512;o+=s)a.beginPath(),a.moveTo(o,0),a.lineTo(o,256),a.stroke();for(let o=0;o<=256;o+=l)a.beginPath(),a.moveTo(0,o),a.lineTo(512,o),a.stroke();const c=new ce(r);return c.anisotropy=8,c}function st(){const n=document.createElement("canvas");n.width=n.height=128;const t=n.getContext("2d"),r=t.createRadialGradient(64,64,0,64,64,64);return r.addColorStop(0,"rgba(255,255,255,1)"),r.addColorStop(.3,"rgba(255,255,255,.5)"),r.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=r,t.fillRect(0,0,128,128),new ce(n)}function it(){const n=document.createElement("canvas");n.width=512,n.height=64;const t=n.getContext("2d");t.fillStyle="#181a20",t.fillRect(0,0,512,64);for(let r=0;r<24;r++){const a=20+r*20,i=t.createRadialGradient(a+6,32,0,a+6,32,12);i.addColorStop(0,"rgba(255,240,200,1)"),i.addColorStop(.4,"rgba(180,220,255,.85)"),i.addColorStop(1,"rgba(40,80,160,0)"),t.fillStyle=i,t.fillRect(a-6,16,24,32),t.strokeStyle="#2a2d35",t.lineWidth=2,t.strokeRect(a,22,12,20)}return new ce(n)}function ot(n){const t=Ze,r=nt(),a=rt(),i=st(),s=it(),l=new t.MeshStandardMaterial({map:r,color:16777215,metalness:.65,roughness:.42}),c=new t.MeshStandardMaterial({map:r,color:10133680,metalness:.7,roughness:.5}),o=new t.MeshStandardMaterial({color:13041468,emissive:7178772,emissiveIntensity:.9,metalness:.5,roughness:.35}),p=new t.MeshStandardMaterial({color:1842982,metalness:.75,roughness:.55}),g=new t.MeshStandardMaterial({color:13148234,metalness:.85,roughness:.25,emissive:3811848,emissiveIntensity:.15}),N=new t.MeshStandardMaterial({map:a,metalness:.7,roughness:.35,emissive:661560,emissiveIntensity:.18,side:t.DoubleSide}),k=new t.MeshBasicMaterial({map:s,transparent:!0,opacity:.95}),y=new t.Group;n.add(y),[-1,0,1].forEach((v,m)=>{const x=new t.Mesh(new t.CylinderGeometry(.88,.88,.92,32),l);if(x.rotation.z=Math.PI/2,x.position.x=v*1,y.add(x),m<2){const f=new t.Mesh(new t.CylinderGeometry(.94,.94,.12,32),g);f.rotation.z=Math.PI/2,f.position.x=v*1+.5,y.add(f)}const j=new t.Mesh(new t.CylinderGeometry(.881,.881,.22,32,1,!0),k);j.rotation.z=Math.PI/2,j.position.x=v*1,y.add(j)}),[-1.5,1.5].forEach(v=>{const m=new t.Mesh(new t.SphereGeometry(.88,32,16,0,Math.PI*2,0,Math.PI/2),l);m.rotation.z=v>0?-Math.PI/2:Math.PI/2,m.position.x=v,y.add(m)});const T=new t.Group;T.position.y=.82,T.add(new t.Mesh(new t.CylinderGeometry(.32,.38,.15,24),l));const D=new t.Mesh(new t.SphereGeometry(.3,24,16,0,Math.PI*2,0,Math.PI/2),new t.MeshStandardMaterial({color:4880568,metalness:.9,roughness:.08,emissive:3823736,emissiveIntensity:.45,transparent:!0,opacity:.88}));D.position.y=.075,T.add(D);for(let v=0;v<6;v++){const m=v/6*Math.PI*2,x=new t.Mesh(new t.BoxGeometry(.012,.3,.012),p);x.position.set(Math.cos(m)*.27,.075,Math.sin(m)*.27),x.rotation.y=-m,T.add(x)}y.add(T),[-2.55,2.55].forEach(v=>{const m=new t.Group;m.position.x=v;const x=new t.Mesh(new t.CylinderGeometry(.58,.58,1.5,24),l);x.rotation.z=Math.PI/2,m.add(x);const j=new t.Mesh(new t.SphereGeometry(.58,24,16,0,Math.PI*2,0,Math.PI/2),g);j.rotation.z=v>0?-Math.PI/2:Math.PI/2,j.position.x=v>0?.75:-.75,m.add(j);const f=new t.Mesh(new t.TorusGeometry(.58,.03,8,24),o);f.rotation.y=Math.PI/2,f.position.x=v>0?.75:-.75,m.add(f);const M=new t.Mesh(new t.CylinderGeometry(.581,.581,.18,24,1,!0),k);M.rotation.z=Math.PI/2,m.add(M);for(let $=0;$<8;$++){const H=$/8*Math.PI*2,X=new t.Mesh(new t.BoxGeometry(.08,.04,.15),p);X.position.set((Math.random()-.5)*1,Math.cos(H)*.6,Math.sin(H)*.6),X.lookAt(X.position.x,0,0),m.add(X)}const I=new t.Mesh(new t.BoxGeometry(.4,.15,.12),p);I.position.set(0,-.62,0),m.add(I);const R=new t.Mesh(new t.CylinderGeometry(.04,.04,1.4,8),g);R.rotation.z=Math.PI/2,R.position.set(0,.58,.15),m.add(R),n.add(m)});const S=(v,m)=>{const x=new t.Group;x.position.x=v,[[-.13,-.13],[.13,-.13],[-.13,.13],[.13,.13]].forEach(([j,f])=>{const M=new t.Mesh(new t.CylinderGeometry(.018,.018,m,6),p);M.rotation.z=Math.PI/2,M.position.set(0,j,f),x.add(M)});for(let j=0;j<4;j++){const f=-m/2+(j+.5)*(m/4),M=new t.Mesh(new t.CylinderGeometry(.012,.012,.36,6),p);M.position.set(f,0,0),M.rotation.z=Math.PI/4,x.add(M);const I=new t.Mesh(new t.CylinderGeometry(.012,.012,.36,6),p);I.position.set(f,0,0),I.rotation.x=Math.PI/4,x.add(I)}return[-m/2,m/2].forEach(j=>{const f=new t.Mesh(new t.TorusGeometry(.18,.015,6,12),p);f.rotation.y=Math.PI/2,f.position.x=j,x.add(f)}),x};n.add(S(-1.7,.65)),n.add(S(1.7,.65));const z=[];[-1,1].forEach(v=>{const m=new t.Group,x=new t.Mesh(new t.CylinderGeometry(.13,.13,.35,12),c);x.position.y=v*.9,m.add(x);const j=new t.Mesh(new t.CylinderGeometry(.07,.07,1.7,10),c);j.position.y=v*1.95,m.add(j);const f=new t.Mesh(new t.SphereGeometry(.14,16,12),g);f.position.y=v*2.85,m.add(f),[-1,1].forEach(M=>{const I=new t.Group;I.position.set(M*2.4,v*2.85,0);const R=new t.Mesh(new t.PlaneGeometry(4.6,1.55,16,4),N);R.rotation.y=Math.PI/2*(M>0?1:-1),I.add(R);const $=new t.Mesh(new t.BoxGeometry(.08,1.55,4.6),c);I.add($);const H=new t.Mesh(new t.BoxGeometry(.18,.25,.25),p);H.position.x=M>0?-2.3:2.3,I.add(H),m.add(I),z.push(I)}),n.add(m)}),[-1,1].forEach(v=>{const m=new t.Mesh(new t.PlaneGeometry(1.2,.9),new t.MeshStandardMaterial({color:15790312,metalness:.1,roughness:.8,side:t.DoubleSide,emissive:2105376,emissiveIntensity:.05}));m.position.set(v*1.7,0,.85),m.rotation.x=Math.PI/2,n.add(m);const x=new t.Mesh(new t.BoxGeometry(1.2,.04,.04),p);x.position.set(v*1.7,0,.85),n.add(x)});const b=new t.Group;b.position.set(.4,0,1);const u=new t.Mesh(new t.CylinderGeometry(.05,.05,.55,10),c);u.position.y=.27,b.add(u);const F=new t.Mesh(new t.SphereGeometry(.08,12,10),g);F.position.y=.55,b.add(F);const A=new t.Mesh(new t.SphereGeometry(.42,24,16,0,Math.PI*2,0,Math.PI/2.5),new t.MeshStandardMaterial({color:15658724,metalness:.4,roughness:.3,side:t.DoubleSide}));A.position.y=.65,A.rotation.x=-.4,b.add(A);const Y=new t.Mesh(new t.ConeGeometry(.06,.18,10),p);Y.position.set(0,.82,.15),Y.rotation.x=Math.PI,b.add(Y);for(let v=0;v<3;v++){const m=v/3*Math.PI*2,x=new t.Mesh(new t.CylinderGeometry(.006,.006,.25,6),p);x.position.set(Math.cos(m)*.12,.75,.08+Math.sin(m)*.12),x.rotation.x=.4,x.rotation.z=m,b.add(x)}n.add(b);const q=new t.Group;q.position.set(-.6,0,1);const re=new t.Mesh(new t.CylinderGeometry(.025,.025,.8,8),p);re.position.y=.4,q.add(re);const se=new t.Mesh(new t.SphereGeometry(.04,8,8),o);se.position.y=.82,q.add(se),n.add(q);const O=new t.Mesh(new t.CylinderGeometry(.32,.42,.48,24),c);O.position.set(0,-.85,.35),O.rotation.x=Math.PI/2,n.add(O);const te=new t.Mesh(new t.TorusGeometry(.34,.04,10,24),o);te.position.set(0,-1.05,.35),te.rotation.x=Math.PI/2,n.add(te);for(let v=0;v<4;v++){const m=v/4*Math.PI*2+Math.PI/4,x=new t.Mesh(new t.CylinderGeometry(.022,.022,.15,6),p);x.position.set(Math.cos(m)*.36,-1.05,.35+Math.sin(m)*.36),x.rotation.z=-Math.PI/2,n.add(x)}[[3.2,0,0],[-3.2,0,0],[0,1,1],[0,-1,1]].forEach(([v,m,x])=>{const j=new t.Group;j.position.set(v,m,x);for(let f=0;f<4;f++){const M=f/4*Math.PI*2,I=new t.Mesh(new t.ConeGeometry(.04,.12,8),p);I.position.set(Math.cos(M)*.08,Math.sin(M)*.08,0),I.rotation.x=Math.PI/2,j.add(I)}n.add(j)});const de=[];[[0,-2.9,.15],[0,-2.9,-.15],[0,-1.1,.35],[0,-1.1,-.05],[-3.2,0,0],[3.2,0,0]].forEach(([v,m,x])=>{const j=new t.Sprite(new t.SpriteMaterial({map:i,color:6336767,transparent:!0,opacity:0,blending:t.AdditiveBlending,depthWrite:!1}));j.scale.set(2.8,2.8,1),j.position.set(v,m,x),n.add(j);const f=new t.Sprite(new t.SpriteMaterial({map:i,color:15267071,transparent:!0,opacity:0,blending:t.AdditiveBlending,depthWrite:!1}));f.scale.set(.7,.7,1),f.position.set(v,m,x),n.add(f),de.push({outer:j,inner:f})});const Z=[];[[3.4,0,0,16724048],[-3.4,0,0,13041468],[0,2.95,1.2,16777215],[0,-2.95,1.2,16777215],[0,0,1.4,16747068],[0,0,-1.4,6741503]].forEach(([v,m,x,j])=>{const f=new t.Mesh(new t.SphereGeometry(.05,10,10),new t.MeshBasicMaterial({color:j,transparent:!0}));f.position.set(v,m,x);const M=new t.Sprite(new t.SpriteMaterial({map:i,color:j,transparent:!0,opacity:.6,blending:t.AdditiveBlending,depthWrite:!1}));M.scale.set(.4,.4,1),f.add(M),n.add(f),Z.push({mesh:f,halo:M})});const K=[new t.Vector3(0,.82,.2),new t.Vector3(-2.4,2.85,0),new t.Vector3(.4,.65,1)],W=K.map((v,m)=>{const x=new t.Sprite(new t.SpriteMaterial({map:i,color:[13041468,3732944,8019199][m],transparent:!0,opacity:0,blending:t.AdditiveBlending,depthWrite:!1}));return x.scale.set(3.5,3.5,1),x.position.copy(v),n.add(x),x});return{thrusterGlows:de,navLights:Z,focusHalos:W,FOCUS_ANCHORS:K,solarWings:z,dishGroup:b}}const lt=d.forwardRef(function({thrusterProxy:t,focusProxy:r,stationProxy:a},i){const s=d.useRef(),l=d.useRef(null);return d.useImperativeHandle(i,()=>s.current,[]),d.useEffect(()=>{if(!s.current)return;const c=ot(s.current);return l.current=c,()=>{l.current=null}},[]),le(({clock:c})=>{if(!l.current)return;const o=c.elapsedTime,p=(t==null?void 0:t.intensity)??0,g=(r==null?void 0:r.value)??-1,{thrusterGlows:N,navLights:k,focusHalos:y,solarWings:T,dishGroup:D}=l.current;T.forEach((S,z)=>{S.rotation.z=Math.sin(o*.06+z*1.4)*.22}),D.rotation.y=Math.sin(o*.05)*.3,D.rotation.x=Math.sin(o*.041+.7)*.08,N.forEach(({outer:S,inner:z},b)=>{const u=Math.sin(o*9+b*.8)*.5+.5;S.material.opacity=p*(.18+u*.07),z.material.opacity=p*(.45+u*.12)}),k.forEach(({mesh:S},z)=>{const b=Math.sin(o*(2.1+z*.43)+z*1.9)>.3;S.material.opacity=b?1:.04}),y.forEach((S,z)=>{const b=z===g?.36+Math.sin(o*1.8)*.07:0;S.material.opacity+=(b-S.material.opacity)*.06})}),e.jsx("group",{ref:s})}),ct=`
...
`;function dt(){const n=d.useRef(),{surfaceMat:t,atmoMat:r}=d.useMemo(()=>{const a=new Se(Math.cos(-53*Math.PI/180)*Math.cos(135*Math.PI/180),Math.sin(-53*Math.PI/180),Math.cos(-53*Math.PI/180)*Math.sin(135*Math.PI/180)).normalize(),i=new xe({uniforms:{uTime:{value:0},uSunDir:{value:a.clone()},uSeaLevel:{value:-.02},uCloudOpacity:{value:.45},uCloudSpeed:{value:.65},uCityLights:{value:1},uAtmoStrength:{value:0}},vertexShader:`
      ...
      `}),s=new xe({side:et,transparent:!0,depthWrite:!1,blending:ue,uniforms:{uSunDir:{value:a.clone()},uAtmoStrength:{value:.55}},vertexShader:`
      ...
      `});return{surfaceMat:i,atmoMat:s}},[]);return le(({clock:a})=>{t.uniforms.uTime.value=a.elapsedTime,n.current&&(n.current.rotation.y=a.elapsedTime*.075)}),e.jsxs("group",{ref:n,position:[-7.4,-7.5,-13.7],scale:1.14,children:[e.jsx("mesh",{material:t,children:e.jsx("sphereGeometry",{args:[2.7,96,64]})}),e.jsx("mesh",{material:r,children:e.jsx("sphereGeometry",{args:[2.92,64,48]})})]})}function pt(){const{geometry:t,material:r}=d.useMemo(()=>{const a=new Float32Array(6600),i=new Float32Array(2200),s=new Float32Array(2200*3);for(let o=0;o<2200;o++){const p=60+Math.random()*70,g=Math.random()*Math.PI*2,N=Math.acos(2*Math.random()-1);a[o*3]=p*Math.sin(N)*Math.cos(g),a[o*3+1]=p*Math.sin(N)*Math.sin(g),a[o*3+2]=p*Math.cos(N),i[o]=.4+Math.random()*1.4;const k=Math.random();s[o*3]=k<.15?1:k>.85?.7:.95,s[o*3+1]=k<.15?.85:k>.85?.8:.95,s[o*3+2]=k<.15?.7:k>.85?1:.95}const l=new $e;l.setAttribute("position",new ne(a,3)),l.setAttribute("starSize",new ne(i,1)),l.setAttribute("color",new ne(s,3));const c=new xe({uniforms:{},vertexShader:`
      ...
      `,transparent:!0,depthWrite:!1,blending:ue});return{geometry:l,material:c}},[]);return e.jsx("points",{geometry:t,material:r})}function mt(){const{geometry:n,material:t}=d.useMemo(()=>{const a=new Float32Array(660),i=new Float32Array(220),s=new Float32Array(220);for(let o=0;o<220;o++)a[o*3]=(Math.random()-.5)*30,a[o*3+1]=(Math.random()-.5)*18,a[o*3+2]=-6+Math.random()*14,i[o]=.25+Math.random()*.9,s[o]=.3+Math.random()*1;const l=new $e;l.setAttribute("position",new ne(a,3)),l.setAttribute("aSpeed",new ne(i,1)),l.setAttribute("starSize",new ne(s,1));const c=new xe({uniforms:{uTime:{value:0}},vertexShader:`
      ...
      `,transparent:!0,depthWrite:!1,blending:ue});return{geometry:l,material:c}},[]);return le(({clock:r})=>{t.uniforms.uTime.value=r.elapsedTime}),e.jsx("points",{geometry:n,material:t})}function ht(){const n=d.useMemo(()=>{const t=document.createElement("canvas");t.width=t.height=256;const r=t.getContext("2d"),a=r.createRadialGradient(128,128,0,128,128,128);return a.addColorStop(0,"rgba(255,244,220,.95)"),a.addColorStop(.18,"rgba(255,210,150,.38)"),a.addColorStop(.5,"rgba(255,170,90,.08)"),a.addColorStop(1,"rgba(0,0,0,0)"),r.fillStyle=a,r.fillRect(0,0,256,256),new tt({map:new ce(t),transparent:!0,opacity:.5,blending:ue,depthWrite:!1,fog:!1})},[]);return le(({clock:t})=>{n.opacity=.46+Math.sin(t.elapsedTime*.8)*.06}),e.jsx("sprite",{material:n,position:[44.7,22.3,31.3],scale:[30,30,1]})}function xt({cameraProxy:n,lookProxy:t,fovProxy:r}){const{camera:a}=at(),i=d.useMemo(()=>new Se,[]),s=d.useMemo(()=>new Se,[]);return d.useEffect(()=>{a.position.set(0,1.6,28),a.fov=36,a.updateProjectionMatrix()},[]),le(({clock:l})=>{const c=l.elapsedTime,o=Math.sin(c*.19)*.06,p=Math.sin(c*.13)*.04,g=Math.sin(c*.07)*.05;s.set(((n==null?void 0:n.x)??0)+o,((n==null?void 0:n.y)??0)+p,((n==null?void 0:n.z)??16)+g),a.position.lerp(s,.18),i.set(((t==null?void 0:t.x)??0)+Math.sin(c*.17)*.025,((t==null?void 0:t.y)??0)+Math.cos(c*.21)*.02,(t==null?void 0:t.z)??0),a.lookAt(i),r&&Math.abs(a.fov-r.value)>.05&&(a.fov+=(r.value-a.fov)*.12,a.updateProjectionMatrix())}),null}function ut({issGroupRef:n,stationProxy:t,cameraProxy:r,lookProxy:a,thrusterProxy:i,fovProxy:s,focusProxy:l,onReady:c}){return d.useEffect(()=>{c==null||c()},[c]),e.jsxs(e.Fragment,{children:[e.jsx("ambientLight",{color:2107456,intensity:.35}),e.jsx("directionalLight",{color:16774364,intensity:2.4,position:[10,5,7]}),e.jsx("directionalLight",{color:4880568,intensity:.95,position:[6,-8,-4]}),e.jsx("directionalLight",{color:8965375,intensity:.45,position:[-7,3,-5]}),e.jsx(pt,{}),e.jsx(dt,{}),e.jsx(mt,{}),e.jsx(ht,{}),e.jsx(d.Suspense,{fallback:null,children:e.jsx(lt,{ref:n,thrusterProxy:i,focusProxy:l})}),e.jsx(xt,{cameraProxy:r,lookProxy:a,fovProxy:s})]})}function vt({issGroupRef:n,stationProxy:t,cameraProxy:r,lookProxy:a,thrusterProxy:i,fovProxy:s,focusProxy:l,onLoaded:c}){return e.jsx(Je,{dpr:[1,1.6],gl:{antialias:!0,alpha:!1,powerPreference:"high-performance"},style:{width:"100%",height:"100%",background:"#02030a"},camera:{fov:36,near:.1,far:300,position:[0,1.6,28]},onCreated:({scene:o})=>{o.fog=new Qe(131850,.025)},children:e.jsx(ut,{issGroupRef:n,stationProxy:t,cameraProxy:r,lookProxy:a,thrusterProxy:i,fovProxy:s,focusProxy:l,onReady:c})})}function ft(n){return n?n.split(/(<em>[^<]*<\/em>|\n)/g).map((t,r)=>{if(t===`
`)return e.jsx("br",{},r);const a=t.match(/^<em>([^<]*)<\/em>$/);return a?e.jsx("em",{children:a[1]},r):t||null}):null}const gt=d.forwardRef(function({index:t=0,total:r=3,tag:a,title:i,description:s,stats:l,position:c="tr",state:o="future"},p){const g=["iss-card",`pos-${c}`,o==="active"?"is-active":"",o==="past"?"is-past":""].filter(Boolean).join(" ");return e.jsxs("article",{ref:p,className:g,"aria-hidden":o!=="active",children:[e.jsxs("div",{className:"iss-card-index",children:[e.jsx("em",{children:String(t+1).padStart(2,"0")}),e.jsx("span",{children:"/"}),e.jsx("span",{children:String(r).padStart(2,"0")})]}),a&&e.jsx("div",{className:"iss-card-tag",children:a}),i&&e.jsx("h3",{children:ft(i)}),s&&e.jsx("p",{children:s}),l&&l.length>0&&e.jsx("div",{className:"iss-card-stats",children:l.map(([N,k],y)=>e.jsxs("div",{className:"iss-card-stat",children:[e.jsx("span",{className:"iss-card-stat-num",children:N}),e.jsx("span",{className:"iss-card-stat-lbl",children:k})]},y))})]})}),G=(n,t,r)=>n+(t-n)*r,He=(n,t,r)=>n<t?t:n>r?r:n,bt=n=>{const t=He(n,0,1);return t*t*t*(t*(t*6-15)+10)},oe=[{p:0,cam:{x:0,y:1.6,z:28},look:{x:0,y:0,z:0},rotX:.05,rotY:.2,rotZ:0,fov:36,thruster:0,focus:-1,card:-1,phase:"approach"},{p:.1,cam:{x:0,y:.7,z:13.5},look:{x:0,y:.1,z:0},rotX:.18,rotY:.85,rotZ:.04,fov:40,thruster:.25,focus:-1,card:-1,phase:"active"},{p:.26,cam:{x:-1.9,y:1.8,z:6.4},look:{x:0,y:.6,z:.2},rotX:-.06,rotY:1.55,rotZ:-.04,fov:38,thruster:0,focus:0,card:0,phase:"reveal"},{p:.46,cam:{x:3.6,y:-.1,z:8},look:{x:-.4,y:1.4,z:0},rotX:.08,rotY:2.55,rotZ:.08,fov:44,thruster:0,focus:1,card:1,phase:"reveal"},{p:.66,cam:{x:-2.3,y:-.6,z:6.6},look:{x:.4,y:-.05,z:.9},rotX:.18,rotY:3.45,rotZ:-.05,fov:36,thruster:0,focus:2,card:2,phase:"reveal"},{p:.86,cam:{x:0,y:2.9,z:19.5},look:{x:0,y:-.8,z:-1.8},rotX:.28,rotY:4.25,rotZ:-.05,fov:46,thruster:.55,focus:-1,card:-1,phase:"outro"},{p:1,cam:{x:0,y:3.4,z:23},look:{x:0,y:-1.1,z:-2.4},rotX:.3,rotY:4.45,rotZ:-.06,fov:48,thruster:.25,focus:-1,card:-1,phase:"outro"}];function yt(n){let t=0;for(;t<oe.length-2&&n>oe[t+1].p;)t++;const r=oe[t],a=oe[Math.min(t+1,oe.length-1)],i=a.p-r.p,s=i>1e-5?bt((n-r.p)/i):0;return{cam:{x:G(r.cam.x,a.cam.x,s),y:G(r.cam.y,a.cam.y,s),z:G(r.cam.z,a.cam.z,s)},look:{x:G(r.look.x,a.look.x,s),y:G(r.look.y,a.look.y,s),z:G(r.look.z,a.look.z,s)},rotX:G(r.rotX,a.rotX,s),rotY:G(r.rotY,a.rotY,s),rotZ:G(r.rotZ,a.rotZ,s),fov:G(r.fov,a.fov,s),thruster:G(r.thruster,a.thruster,s),focus:s>.65?a.focus:r.focus,card:s>.65?a.card:r.card,phase:s>.65?a.phase:r.phase}}function wt({sectionRef:n,issGroupRef:t,stationProxy:r,cameraProxy:a,lookProxy:i,thrusterProxy:s,fovProxy:l,focusProxy:c,onPhaseChange:o,onCardChange:p,damping:g=.07}={}){d.useEffect(()=>{if(!(n!=null&&n.current)){console.warn("[ISS] sectionRef.current ist null – RAF wurde nicht gestartet");return}let N=0,k=0,y=0,T=-2,D="",S=!0;const z=()=>{const u=n.current;if(!u)return;const F=u.getBoundingClientRect(),A=document.documentElement.clientHeight||window.innerHeight,Y=u.offsetHeight-A;if(Y<=0){k=0;return}k=He(-F.top/Y,0,1)},b=()=>{if(!S)return;N=requestAnimationFrame(b),z(),y=G(y,k,g),Math.abs(y-k)<1e-4&&(y=k);const u=yt(y),F=performance.now()/1e3;a&&(a.x=u.cam.x,a.y=u.cam.y,a.z=u.cam.z),i&&(i.x=u.look.x,i.y=u.look.y,i.z=u.look.z),r&&(r.rotX=u.rotX,r.rotY=u.rotY,r.rotZ=u.rotZ),s&&(s.intensity=u.thruster),l&&(l.value=u.fov),c&&(c.value=u.focus);const A=t==null?void 0:t.current;A&&(A.position.x=Math.sin(F*.31)*.04,A.position.y=Math.sin(F*.23)*.055,A.position.z=Math.sin(F*.17)*.03,A.rotation.x=u.rotX+Math.sin(F*.07)*.005,A.rotation.y=u.rotY+Math.sin(F*.09)*.008,A.rotation.z=u.rotZ+Math.sin(F*.11)*.004),u.card!==T&&(T=u.card,p&&p(u.card)),u.phase!==D&&(D=u.phase,o&&o(u.phase))};return N=requestAnimationFrame(b),()=>{S=!1,cancelAnimationFrame(N)}},[n,t,r,a,i,s,l,c,o,p,g])}const Me=[{tag:"Observation Layer",title:`Intelligente
...
<em>Orchestrierung</em>`,description:"Die Schüssel zeigt nach draußen — NILL spricht mit Banken, Behörden, Lieferanten. Workloads finden ihren Weg, ohne dass du ein Ticket öffnest.",stats:[["1.200+","aufgaben/tag"],["−60 %","manuelle arbeit"],["3 s","cold start"]],position:"br"}];function jt(){const n=d.useRef(null),t=d.useRef(null),r=[d.useRef(null),d.useRef(null),d.useRef(null)],[a,i]=d.useState(-1),[s,l]=d.useState("approach"),[c,o]=d.useState(!1),[p,g]=d.useState({x:"0.00",y:"0.00",z:"0.00"}),N=d.useMemo(()=>({rotX:0,rotY:0,rotZ:0}),[]),k=d.useMemo(()=>({x:0,y:1.6,z:28}),[]),y=d.useMemo(()=>({x:0,y:0,z:0}),[]),T=d.useMemo(()=>({intensity:0}),[]),D=d.useMemo(()=>({value:36}),[]),S=d.useMemo(()=>({value:-1}),[]);wt({sectionRef:n,issGroupRef:t,stationProxy:N,cameraProxy:k,lookProxy:y,thrusterProxy:T,fovProxy:D,focusProxy:S,onCardChange:i,onPhaseChange:l,damping:.07}),d.useEffect(()=>{let b=0,u=0;const F=A=>{b=requestAnimationFrame(F),!(A-u<120)&&(u=A,g({x:k.x.toFixed(2),y:k.y.toFixed(2),z:k.z.toFixed(2)}))};return b=requestAnimationFrame(F),()=>cancelAnimationFrame(b)},[k]);const z=b=>b===a?"active":a>b?"past":"future";return e.jsx("section",{ref:n,className:`iss-section ${c?"iss-loaded":""}`,"data-screen-label":"ISS",children:e.jsxs("div",{className:"iss-sticky","data-phase":s,children:[e.jsx("div",{className:"iss-canvas-wrap",children:e.jsx(vt,{issGroupRef:t,stationProxy:N,cameraProxy:k,lookProxy:y,thrusterProxy:T,fovProxy:D,focusProxy:S,onLoaded:()=>o(!0)})}),e.jsx("div",{className:"iss-bar top","aria-hidden":"true"}),e.jsx("div",{className:"iss-bar bot","aria-hidden":"true"}),e.jsx("div",{className:"iss-grain","aria-hidden":"true"}),e.jsxs("div",{className:"iss-hud tl",children:[e.jsxs("div",{children:[e.jsx("span",{className:"dot"}),"NILL · MISSION CONTROL"]}),e.jsx("div",{className:"label",children:"Orbital Layer · v1"})]}),e.jsxs("div",{className:"iss-hud tr",children:[e.jsx("div",{className:"label",children:"REF · NILL-OS / ISS-04"}),e.jsx("div",{className:"value",children:"42° 06′ 18″ N · 5° 23′ 41″ E"})]}),e.jsxs("div",{className:"iss-hud bl",children:[e.jsx("div",{className:"label",children:"CAMERA"}),e.jsxs("div",{className:"value",children:["x ",e.jsx("em",{children:p.x}),"  y ",e.jsx("em",{children:p.y}),"  z ",e.jsx("em",{children:p.z})]})]}),e.jsxs("div",{className:"iss-hud br",children:[e.jsx("div",{className:"label",children:"STATUS"}),e.jsx("div",{className:"value",children:s==="approach"?"APPROACH — STAND-BY":s==="reveal"?"REVEAL — MODULE FOCUS":"NOMINAL — TRACKING"})]}),e.jsx("div",{className:"iss-intro","aria-hidden":s!=="approach",children:e.jsxs("div",{className:"iss-intro-inner",children:[e.jsxs("span",{className:"eyebrow",children:[e.jsx("span",{className:"pip"}),"NILL · MISSION CONTROL"]}),e.jsxs("h2",{children:["Das Betriebssystem, das dein",e.jsx("br",{}),"Unternehmen ",e.jsx("em",{children:"im Orbit"})," hält."]}),e.jsx("p",{children:"Stell dir NILL als Raumstation vor: ein zentrales System, das alle Module deines Betriebs verbindet. Beobachtung, Energie, Kommunikation — orchestriert von einer KI, die nie schläft."})]})}),e.jsx("div",{className:"iss-outro","aria-hidden":s!=="outro",children:e.jsxs("div",{className:"iss-outro-inner",children:[e.jsxs("span",{className:"eyebrow",children:[e.jsx("span",{className:"pip"}),"READY · LAUNCH WINDOW OPEN"]}),e.jsxs("h2",{children:["Eine Plattform.",e.jsx("br",{}),"Ein Login. ",e.jsx("em",{children:"Alle Module."})]}),e.jsx("p",{children:"NILL hält deinen Betrieb in der Umlaufbahn — 24/7, ohne Tickets, ohne Bauchschmerzen. Bereit, die Station zu betreten?"}),e.jsxs("a",{className:"iss-outro-cta",href:"#cta",children:["Demo anfragen ",e.jsx("span",{className:"arrow",children:"→"})]})]})}),e.jsx("div",{className:"iss-card-stage",children:Me.map((b,u)=>e.jsx(gt,{ref:r[u],index:u,total:Me.length,tag:b.tag,title:b.title,description:b.description,stats:b.stats,position:b.position,state:z(u)},u))}),e.jsx("div",{className:"iss-progress","aria-hidden":"true",children:Me.map((b,u)=>e.jsx("div",{className:`iss-progress-dot ${u===a?"active":u<a?"passed":""}`},u))}),e.jsxs("div",{className:`iss-scroll-hint ${s!=="approach"?"hidden":""}`,children:[e.jsx("span",{children:"scroll · mission"}),e.jsx("span",{className:"iss-scroll-hint-line"})]})]})})}const Nt=`
:root{
...
`;let De=!1,Ge=!1;function kt(){if(De)return;De=!0;const n=document.createElement("style");if(n.textContent=Nt,document.head.appendChild(n),document.title="NILL — Intelligenz, die mitarbeitet.",!window.THREE&&!Ge){Ge=!0;const t=document.createElement("script");t.src="https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js",document.head.appendChild(t)}}function U(n=.12){const t=d.useRef(null),[r,a]=d.useState(!1);return d.useEffect(()=>{if(!t.current)return;const i=new IntersectionObserver(([s])=>{s.isIntersecting&&(a(!0),i.disconnect())},{threshold:n});return i.observe(t.current),()=>i.disconnect()},[]),[t,r]}function ee({className:n="",stagger:t=!1,children:r,...a}){const[i,s]=U(.08);return e.jsx("div",{ref:i,className:`${t?"stagger":"reveal"}${s?" in":""} ${n}`,...a,children:r})}function Mt(){const n=d.useRef(null);return d.useEffect(()=>{let t,r=0;const a=()=>{t=requestAnimationFrame(a);const i=document.documentElement.scrollHeight-innerHeight,s=i>0?window.scrollY/i:0;r+=(s-r)*.12,n.current&&(n.current.style.transform=`scaleX(${r})`)};return t=requestAnimationFrame(a),()=>cancelAnimationFrame(t)},[]),e.jsx("div",{className:"scroll-progress","aria-hidden":"true",children:e.jsx("span",{ref:n})})}function Ve(n){d.useEffect(()=>{const t=n.current;if(!t)return;const r=i=>{const s=t.getBoundingClientRect();t.style.setProperty("--mx",(i.clientX-s.left)/s.width*100+"%"),t.style.setProperty("--my",(i.clientY-s.top)/s.height*100+"%");const l=(i.clientY-s.top-s.height/2)/s.height*-4,c=(i.clientX-s.left-s.width/2)/s.width*4;t.style.transform=`translateY(-4px) perspective(900px) rotateX(${l}deg) rotateY(${c}deg)`},a=()=>t.style.transform="";return t.addEventListener("mousemove",r),t.addEventListener("mouseleave",a),()=>{t.removeEventListener("mousemove",r),t.removeEventListener("mouseleave",a)}},[])}function St(n){d.useEffect(()=>{const t=n.current;if(!t)return;const r=i=>{const s=t.getBoundingClientRect();t.style.transform=`translate(${(i.clientX-s.left-s.width/2)/s.width*18}px,${(i.clientY-s.top-s.height/2)/s.height*18}px)`},a=()=>t.style.transform="";return t.addEventListener("mousemove",r),t.addEventListener("mouseleave",a),()=>{t.removeEventListener("mousemove",r),t.removeEventListener("mouseleave",a)}},[])}function _({className:n,children:t,onClick:r,href:a}){const i=d.useRef(null);return St(i),a?e.jsx("a",{ref:i,href:a,className:n,onClick:r,children:t}):e.jsx("button",{ref:i,className:n,onClick:r,children:t})}function ae({className:n,style:t,children:r}){const a=d.useRef(null);return Ve(a),e.jsx("article",{ref:a,className:`card ${n||""}`,style:t,children:r})}const ze=`
  vec3 _m3(vec3 x){return x-floor(x*(1./289.))*289.;}
  vec4 _m4(vec4 x){return x-floor(x*(1./289.))*289.;}
...
`;function Ft(n){const t=THREE,r=new t.WebGLRenderer({canvas:n,antialias:!0,powerPreference:"high-performance"});r.setPixelRatio(Math.min(devicePixelRatio,1.5)),r.setClearColor(131850,1);const a=new t.Scene,i=new t.PerspectiveCamera(42,2,.1,300);i.position.set(0,1.8,11),i.lookAt(0,0,0);const s=2200,l=new Float32Array(s*3),c=new Float32Array(s),o=new Float32Array(s*3),p=new Float32Array(s);for(let h=0;h<s;h++){p[h]=Math.random()*Math.PI*2;const P=60+Math.random()*70,w=Math.random()*Math.PI*2,L=Math.acos(2*Math.random()-1);l[h*3]=P*Math.sin(L)*Math.cos(w),l[h*3+1]=P*Math.sin(L)*Math.sin(w),l[h*3+2]=P*Math.cos(L),c[h]=.4+Math.random()*1.4;const C=Math.random();o[h*3]=C<.15?1:C>.85?.7:.95,o[h*3+1]=C<.15?.85:C>.85?.8:.95,o[h*3+2]=C<.15?.7:C>.85?1:.95}const g=new t.BufferGeometry;g.setAttribute("position",new t.BufferAttribute(l,3)),g.setAttribute("starSize",new t.BufferAttribute(c,1)),g.setAttribute("color",new t.BufferAttribute(o,3)),g.setAttribute("twinkle",new t.BufferAttribute(p,1));const N=new t.ShaderMaterial({uniforms:{uTime:{value:0}},vertexShader:"attribute float starSize;attribute vec3 color;attribute float twinkle;uniform float uTime;varying vec3 vC;varying float vTw;void main(){vC=color;vTw=.72+.28*sin(uTime*1.6+twinkle*7.);vec4 mv=modelViewMatrix*vec4(position,1.);gl_PointSize=starSize*(.85+.3*sin(uTime*1.1+twinkle*5.))*(700./-mv.z);gl_Position=projectionMatrix*mv;}",fragmentShader:"varying vec3 vC;varying float vTw;void main(){vec2 uv=gl_PointCoord-.5;float a=1.-smoothstep(.25,.5,length(uv));if(a<.01)discard;gl_FragColor=vec4(vC,a*.85*vTw);}",transparent:!0,depthWrite:!1,blending:t.AdditiveBlending}),k=new t.Points(g,N);a.add(k);const y=new t.Group;y.rotation.x=-.55,y.rotation.z=.07,a.add(y);const T=new t.Group;y.add(T);const D=new t.ShaderMaterial({uniforms:{uTime:{value:0}},vertexShader:"varying vec3 vP;varying vec3 vN;void main(){vP=position;vN=normal;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}",fragmentShader:ze+`
