import{a as i,j as e}from"./vendor-react--hPKs4bs.js";import{a as v,L as j}from"./vendor-router-B9EJrQcr.js";import{a as y,u as S}from"./index-Cr5-N4ZA.js";import"./vendor-misc-xcvkua7f.js";const N={position:"fixed",inset:0,zIndex:9999,background:"rgba(4,7,15,0.88)",backdropFilter:"blur(8px)",WebkitBackdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",padding:"1rem"},z={background:"var(--nill-elevated,rgba(15,18,28,0.98))",border:"1px solid rgba(var(--ink-tint),0.1)",borderRadius:20,padding:"2rem 2.25rem",width:"100%",maxWidth:400,display:"flex",flexDirection:"column",gap:"1.25rem",fontFamily:"'Inter', system-ui, sans-serif"},C={width:"100%",padding:"0.65rem 0.9rem",background:"rgba(var(--tint),0.04)",border:"1px solid rgba(var(--tint),0.12)",borderRadius:10,color:"var(--nill-text,#efede7)",fontSize:"0.95rem",fontFamily:"'JetBrains Mono', monospace",letterSpacing:"0.1em",outline:"none",boxSizing:"border-box"},M={width:"100%",padding:"0.7rem",background:"#c5a572",border:"none",borderRadius:10,color:"#000",fontWeight:700,fontSize:"0.9rem",cursor:"pointer"},E={background:"none",border:"none",color:"rgba(var(--ink-tint),0.45)",fontSize:"0.8rem",cursor:"pointer",padding:"0.3rem 0",textDecoration:"underline",textUnderlineOffset:3};function A({onClose:t,hasPassword:a}){const s=v(),[r,h]=i.useState(""),[c,g]=i.useState(!1),[u,d]=i.useState(""),l=()=>{localStorage.removeItem("nill_kiosk_device"),s("/dashboard")};i.useEffect(()=>{a||l()},[]);const b=async n=>{var m,p;if(n.preventDefault(),!!r){g(!0),d("");try{await y.post("/auth/station/verify-exit-password",{password:r}),l()}catch(x){d(((p=(m=x==null?void 0:x.response)==null?void 0:m.data)==null?void 0:p.detail)??"Falsches Passwort.")}finally{g(!1)}}};return a?e.jsx("div",{style:N,onClick:n=>{n.target===n.currentTarget&&t()},children:e.jsxs("div",{style:z,children:[e.jsxs("div",{children:[e.jsx("div",{style:{fontFamily:"'JetBrains Mono', monospace",fontSize:"0.62rem",letterSpacing:"0.18em",textTransform:"uppercase",color:"rgba(var(--ink-tint),0.35)",marginBottom:6},children:"ArbeitsStation"}),e.jsx("div",{style:{fontFamily:"'Fraunces', Georgia, serif",fontSize:"1.4rem",fontWeight:400,color:"var(--nill-text,#efede7)",letterSpacing:"-0.02em"},children:"Station verlassen?"})]}),e.jsxs("form",{onSubmit:b,style:{display:"flex",flexDirection:"column",gap:"0.85rem"},children:[e.jsx("p",{style:{margin:0,fontSize:"0.82rem",color:"rgba(var(--ink-tint),0.5)",lineHeight:1.55},children:"Bitte gib das Stations-Passwort ein, um den Kiosk-Modus zu beenden."}),e.jsx("input",{type:"password",placeholder:"Passwort",value:r,onChange:n=>h(n.target.value),style:C,autoFocus:!0,autoComplete:"off",autoCapitalize:"none",autoCorrect:"off",spellCheck:!1,name:"station-exit-password"}),u&&e.jsx("div",{style:{fontSize:"0.78rem",color:"var(--nill-danger,#f87171)"},children:u}),e.jsx("button",{type:"submit",disabled:c||!r,style:{...M,opacity:c||!r?.6:1},children:c?"Prüfen…":"Bestätigen"}),e.jsx("div",{style:{display:"flex",justifyContent:"flex-end",alignItems:"center"},children:e.jsx("button",{type:"button",style:E,onClick:t,children:"Abbrechen"})})]})]})}):null}const F=`
  .as-root {
    --as-bg:        #040817;
