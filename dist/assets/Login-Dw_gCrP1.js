import{a as r,j as e}from"./vendor-react--hPKs4bs.js";import{u as X,c as Y}from"./vendor-router-rhPWNlHF.js";import{u as ee,a as u}from"./index-C52QKycp.js";import"./vendor-misc-1rS7ujT8.js";function le(){const f=X(),{setUser:N,setOrg:w}=ee(),[S,L]=r.useState(""),[j,W]=r.useState(""),[s,d]=r.useState(!1),[o,n]=r.useState(null),[E,v]=r.useState("credentials"),[k,q]=r.useState(""),[b,x]=r.useState(""),[m,M]=r.useState("totp"),[R,C]=r.useState(!1),[F,B]=r.useState(""),[V,A]=r.useState(!1),[_,I]=r.useState(!1),[P,z]=r.useState(null),[O]=Y(),J=O.get("reason")==="inactivity",K=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;async function H(t){var l;if(t.preventDefault(),n(null),!K.test(S)){n("Bitte eine gültige E-Mail-Adresse eingeben.");return}if(!j||j.length<6){n("Passwort muss mindestens 6 Zeichen lang sein.");return}d(!0);try{const a=await u.post("/auth/login",{email:S,password:j});if((l=a.data)!=null&&l["2fa_required"]){q(a.data.temp_token),M(a.data.method||"totp"),v("2fa"),d(!1);return}const i=await u.get("/auth/me",{withCredentials:!0});N({id:i.data.id,email:i.data.email,role:i.data.role,is_admin:i.data.is_admin,org_role:i.data.org_role??null}),w(i.data.org??null),f("/dashboard",{replace:!0})}catch(a){console.error("Login Fehler:",a),n("E-Mail oder Passwort ungültig.")}finally{d(!1)}}async function T(t){var l,a;t.preventDefault(),n(null),d(!0);try{const i=m==="email"?"/auth/2fa/verify-email-otp":"/auth/2fa/verify-login";await u.post(i,{temp_token:k,code:b.trim()});const c=await u.get("/auth/me",{withCredentials:!0});N({id:c.data.id,email:c.data.email,role:c.data.role,is_admin:c.data.is_admin,org_role:c.data.org_role??null}),w(c.data.org??null),f("/dashboard",{replace:!0})}catch(i){console.error("2FA Fehler:",i),n(((a=(l=i==null?void 0:i.response)==null?void 0:l.data)==null?void 0:a.detail)||"Ungültiger Code. Bitte erneut versuchen."),x("")}finally{d(!1)}}async function D(){var t,l;n(null),d(!0);try{await u.post("/auth/2fa/send-email-otp",{temp_token:k}),C(!0)}catch(a){n(((l=(t=a==null?void 0:a.response)==null?void 0:t.data)==null?void 0:l.detail)||"E-Mail konnte nicht gesendet werden.")}finally{d(!1)}}async function U(t){var l,a;t.preventDefault(),z(null),I(!0);try{await u.post("/auth/request-reset",{email:F}),A(!0)}catch(i){z(((a=(l=i==null?void 0:i.response)==null?void 0:l.data)==null?void 0:a.detail)||"Fehler. Bitte versuche es erneut.")}finally{I(!1)}}async function Z(){var t,l;n(null),d(!0);try{const i=(await u.post("/auth/2fa/webauthn/auth-options",{temp_token:k})).data,c=g=>{const $=atob(g.replace(/-/g,"+").replace(/_/g,"/"));return Uint8Array.from($,Q=>Q.charCodeAt(0)).buffer},y=g=>btoa(String.fromCharCode(...new Uint8Array(g))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,""),p=await navigator.credentials.get({publicKey:{challenge:c(i.challenge),rpId:i.rpId,timeout:i.timeout,userVerification:i.userVerification,allowCredentials:(i.allowCredentials||[]).map(g=>({type:g.type,id:c(g.id)}))}}),G={id:p.id,rawId:y(p.rawId),type:p.type,response:{clientDataJSON:y(p.response.clientDataJSON),authenticatorData:y(p.response.authenticatorData),signature:y(p.response.signature),userHandle:p.response.userHandle?y(p.response.userHandle):null}};await u.post("/auth/2fa/webauthn/auth-verify",{temp_token:k,credential:G});const h=await u.get("/auth/me",{withCredentials:!0});N({id:h.data.id,email:h.data.email,role:h.data.role,is_admin:h.data.is_admin,org_role:h.data.org_role??null}),w(h.data.org??null),f("/dashboard",{replace:!0})}catch(a){(a==null?void 0:a.name)==="NotAllowedError"?n("Biometrische Authentifizierung abgebrochen."):n(((l=(t=a==null?void 0:a.response)==null?void 0:t.data)==null?void 0:l.detail)||"Biometrische Authentifizierung fehlgeschlagen.")}finally{d(!1)}}return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
