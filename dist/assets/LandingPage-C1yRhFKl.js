import{a as d,j as e}from"./vendor-react--hPKs4bs.js";import{L as J}from"./vendor-router-DHr2oj4b.js";import{u as de,T as nt,C as pe,R as rt,a as it,F as st,B as qe,b as ne,S as ve,A as fe,V as Ae,c as ot,d as lt,e as ct}from"./vendor-three-BBl3idiH.js";/* empty css                */import"./vendor-misc-DR5OIT6T.js";function dt(){const r=document.createElement("canvas");r.width=1024,r.height=512;const a=r.getContext("2d");a.fillStyle="#d4d6dc",a.fillRect(0,0,1024,512);for(let i=0;i<2400;i++)a.fillStyle=`rgba(${100+(Math.random()*40|0)},${100+(Math.random()*40|0)},${110+(Math.random()*40|0)},${.08+Math.random()*.12})`,a.fillRect(Math.random()*1024,Math.random()*512,1+Math.random()*3,1);a.strokeStyle="rgba(20,22,28,.55)",a.lineWidth=1.2;for(let i=0;i<1024;i+=64)a.beginPath(),a.moveTo(i,0),a.lineTo(i,512),a.stroke();for(let i=0;i<512;i+=64)a.beginPath(),a.moveTo(0,i),a.lineTo(1024,i),a.stroke();a.fillStyle="rgba(40,44,52,.7)";for(let i=8;i<1024;i+=32)for(let l=8;l<512;l+=32)a.fillRect(i,l,1.5,1.5);for(let i=0;i<14;i++){const l=Math.random()*844,c=Math.random()*422,o=80+Math.random()*100,p=40+Math.random()*60;a.strokeStyle="rgba(15,17,22,.7)",a.lineWidth=2,a.strokeRect(l,c,o,p),a.fillStyle="rgba(50,55,65,.18)",a.fillRect(l,c,o,p)}for(let i=0;i<60;i++)a.fillStyle=`rgba(${30+(Math.random()*40|0)},${28+(Math.random()*30|0)},${28+(Math.random()*30|0)},${.15+Math.random()*.25})`,a.fillRect(Math.random()*1024,Math.random()*512,30+Math.random()*120,1+Math.random()*3);a.fillStyle="rgba(220,200,40,.55)",a.font="bold 14px monospace",["CAUTION","HATCH-A4","MOD-7","EXT-VENT","HIGH-V","NILL-OS"].forEach((i,l)=>a.fillText(i,60+l*160,40+l%2*220));const s=new pe(r);return s.wrapS=s.wrapT=rt,s.anisotropy=8,s}function pt(){const r=document.createElement("canvas");r.width=512,r.height=256;const a=r.getContext("2d"),s=a.createLinearGradient(0,0,512,256);s.addColorStop(0,"#0a1840"),s.addColorStop(.5,"#1a3878"),s.addColorStop(1,"#0a1d54"),a.fillStyle=s,a.fillRect(0,0,512,256);const i=32,l=32;for(let o=0;o<512;o+=i)for(let p=0;p<256;p+=l){const b=.8+Math.random()*.3;a.fillStyle=`rgba(${30*b|0},${60*b|0},${140*b|0},.95)`,a.fillRect(o+1,p+1,i-2,l-2);const M=a.createLinearGradient(o,p,o+i,p+l);M.addColorStop(0,"rgba(120,180,255,.18)"),M.addColorStop(.5,"rgba(255,255,255,.05)"),M.addColorStop(1,"rgba(20,40,90,.2)"),a.fillStyle=M,a.fillRect(o+1,p+1,i-2,l-2),a.fillStyle="rgba(180,190,210,.4)",a.fillRect(o+i/2-.5,p+1,1,l-2)}a.strokeStyle="rgba(8,12,28,.85)",a.lineWidth=1;for(let o=0;o<=512;o+=i)a.beginPath(),a.moveTo(o,0),a.lineTo(o,256),a.stroke();for(let o=0;o<=256;o+=l)a.beginPath(),a.moveTo(0,o),a.lineTo(512,o),a.stroke();const c=new pe(r);return c.anisotropy=8,c}function mt(){const n=document.createElement("canvas");n.width=n.height=128;const t=n.getContext("2d"),r=t.createRadialGradient(64,64,0,64,64,64);return r.addColorStop(0,"rgba(255,255,255,1)"),r.addColorStop(.3,"rgba(255,255,255,.5)"),r.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=r,t.fillRect(0,0,128,128),new pe(n)}function ht(){const n=document.createElement("canvas");n.width=512,n.height=64;const t=n.getContext("2d");t.fillStyle="#181a20",t.fillRect(0,0,512,64);for(let r=0;r<24;r++){const a=20+r*20,s=t.createRadialGradient(a+6,32,0,a+6,32,12);s.addColorStop(0,"rgba(255,240,200,1)"),s.addColorStop(.4,"rgba(180,220,255,.85)"),s.addColorStop(1,"rgba(40,80,160,0)"),t.fillStyle=s,t.fillRect(a-6,16,24,32),t.strokeStyle="#2a2d35",t.lineWidth=2,t.strokeRect(a,22,12,20)}return new pe(n)}function xt(n){const t=nt,r=dt(),a=pt(),s=mt(),i=ht(),l=new t.MeshStandardMaterial({map:r,color:16777215,metalness:.65,roughness:.42}),c=new t.MeshStandardMaterial({map:r,color:10133680,metalness:.7,roughness:.5}),o=new t.MeshStandardMaterial({color:13041468,emissive:7178772,emissiveIntensity:.9,metalness:.5,roughness:.35}),p=new t.MeshStandardMaterial({color:1842982,metalness:.75,roughness:.55}),b=new t.MeshStandardMaterial({color:13148234,metalness:.85,roughness:.25,emissive:3811848,emissiveIntensity:.15}),M=new t.MeshStandardMaterial({map:a,metalness:.7,roughness:.35,emissive:661560,emissiveIntensity:.18,side:t.DoubleSide}),k=new t.MeshBasicMaterial({map:i,transparent:!0,opacity:.95}),y=new t.Group;n.add(y),[-1,0,1].forEach((x,h)=>{const u=new t.Mesh(new t.CylinderGeometry(.88,.88,.92,32),l);if(u.rotation.z=Math.PI/2,u.position.x=x*1,y.add(u),h<2){const f=new t.Mesh(new t.CylinderGeometry(.94,.94,.12,32),b);f.rotation.z=Math.PI/2,f.position.x=x*1+.5,y.add(f)}const j=new t.Mesh(new t.CylinderGeometry(.881,.881,.22,32,1,!0),k);j.rotation.z=Math.PI/2,j.position.x=x*1,y.add(j)}),[-1.5,1.5].forEach(x=>{const h=new t.Mesh(new t.SphereGeometry(.88,32,16,0,Math.PI*2,0,Math.PI/2),l);h.rotation.z=x>0?-Math.PI/2:Math.PI/2,h.position.x=x,y.add(h)});const T=new t.Group;T.position.y=.82,T.add(new t.Mesh(new t.CylinderGeometry(.32,.38,.15,24),l));const W=new t.Mesh(new t.SphereGeometry(.3,24,16,0,Math.PI*2,0,Math.PI/2),new t.MeshStandardMaterial({color:4880568,metalness:.9,roughness:.08,emissive:3823736,emissiveIntensity:.45,transparent:!0,opacity:.88}));W.position.y=.075,T.add(W);for(let x=0;x<6;x++){const h=x/6*Math.PI*2,u=new t.Mesh(new t.BoxGeometry(.012,.3,.012),p);u.position.set(Math.cos(h)*.27,.075,Math.sin(h)*.27),u.rotation.y=-h,T.add(u)}y.add(T),[-2.55,2.55].forEach(x=>{const h=new t.Group;h.position.x=x;const u=new t.Mesh(new t.CylinderGeometry(.58,.58,1.5,24),l);u.rotation.z=Math.PI/2,h.add(u);const j=new t.Mesh(new t.SphereGeometry(.58,24,16,0,Math.PI*2,0,Math.PI/2),b);j.rotation.z=x>0?-Math.PI/2:Math.PI/2,j.position.x=x>0?.75:-.75,h.add(j);const f=new t.Mesh(new t.TorusGeometry(.58,.03,8,24),o);f.rotation.y=Math.PI/2,f.position.x=x>0?.75:-.75,h.add(f);const S=new t.Mesh(new t.CylinderGeometry(.581,.581,.18,24,1,!0),k);S.rotation.z=Math.PI/2,h.add(S);for(let D=0;D<8;D++){const Z=D/8*Math.PI*2,te=new t.Mesh(new t.BoxGeometry(.08,.04,.15),p);te.position.set((Math.random()-.5)*1,Math.cos(Z)*.6,Math.sin(Z)*.6),te.lookAt(te.position.x,0,0),h.add(te)}const N=new t.Mesh(new t.BoxGeometry(.4,.15,.12),p);N.position.set(0,-.62,0),h.add(N);const O=new t.Mesh(new t.CylinderGeometry(.04,.04,1.4,8),b);O.rotation.z=Math.PI/2,O.position.set(0,.58,.15),h.add(O),n.add(h)});const P=(x,h)=>{const u=new t.Group;u.position.x=x,[[-.13,-.13],[.13,-.13],[-.13,.13],[.13,.13]].forEach(([j,f])=>{const S=new t.Mesh(new t.CylinderGeometry(.018,.018,h,6),p);S.rotation.z=Math.PI/2,S.position.set(0,j,f),u.add(S)});for(let j=0;j<4;j++){const f=-h/2+(j+.5)*(h/4),S=new t.Mesh(new t.CylinderGeometry(.012,.012,.36,6),p);S.position.set(f,0,0),S.rotation.z=Math.PI/4,u.add(S);const N=new t.Mesh(new t.CylinderGeometry(.012,.012,.36,6),p);N.position.set(f,0,0),N.rotation.x=Math.PI/4,u.add(N)}return[-h/2,h/2].forEach(j=>{const f=new t.Mesh(new t.TorusGeometry(.18,.015,6,12),p);f.rotation.y=Math.PI/2,f.position.x=j,u.add(f)}),u};n.add(P(-1.7,.65)),n.add(P(1.7,.65));const I=[];[-1,1].forEach(x=>{const h=new t.Group,u=new t.Mesh(new t.CylinderGeometry(.13,.13,.35,12),c);u.position.y=x*.9,h.add(u);const j=new t.Mesh(new t.CylinderGeometry(.07,.07,1.7,10),c);j.position.y=x*1.95,h.add(j);const f=new t.Mesh(new t.SphereGeometry(.14,16,12),b);f.position.y=x*2.85,h.add(f),[-1,1].forEach(S=>{const N=new t.Group;N.position.set(S*2.4,x*2.85,0);const O=new t.Mesh(new t.PlaneGeometry(4.6,1.55,16,4),M);O.rotation.y=Math.PI/2*(S>0?1:-1),N.add(O);const D=new t.Mesh(new t.BoxGeometry(.08,1.55,4.6),c);N.add(D);const Z=new t.Mesh(new t.BoxGeometry(.18,.25,.25),p);Z.position.x=S>0?-2.3:2.3,N.add(Z),h.add(N),I.push(N)}),n.add(h)}),[-1,1].forEach(x=>{const h=new t.Mesh(new t.PlaneGeometry(1.2,.9),new t.MeshStandardMaterial({color:15790312,metalness:.1,roughness:.8,side:t.DoubleSide,emissive:2105376,emissiveIntensity:.05}));h.position.set(x*1.7,0,.85),h.rotation.x=Math.PI/2,n.add(h);const u=new t.Mesh(new t.BoxGeometry(1.2,.04,.04),p);u.position.set(x*1.7,0,.85),n.add(u)});const w=new t.Group;w.position.set(.4,0,1);const v=new t.Mesh(new t.CylinderGeometry(.05,.05,.55,10),c);v.position.y=.27,w.add(v);const F=new t.Mesh(new t.SphereGeometry(.08,12,10),b);F.position.y=.55,w.add(F);const C=new t.Mesh(new t.SphereGeometry(.42,24,16,0,Math.PI*2,0,Math.PI/2.5),new t.MeshStandardMaterial({color:15658724,metalness:.4,roughness:.3,side:t.DoubleSide}));C.position.y=.65,C.rotation.x=-.4,w.add(C);const $=new t.Mesh(new t.ConeGeometry(.06,.18,10),p);$.position.set(0,.82,.15),$.rotation.x=Math.PI,w.add($);for(let x=0;x<3;x++){const h=x/3*Math.PI*2,u=new t.Mesh(new t.CylinderGeometry(.006,.006,.25,6),p);u.position.set(Math.cos(h)*.12,.75,.08+Math.sin(h)*.12),u.rotation.x=.4,u.rotation.z=h,w.add(u)}n.add(w);const Y=new t.Group;Y.position.set(-.6,0,1);const re=new t.Mesh(new t.CylinderGeometry(.025,.025,.8,8),p);re.position.y=.4,Y.add(re);const ie=new t.Mesh(new t.SphereGeometry(.04,8,8),o);ie.position.y=.82,Y.add(ie),n.add(Y);const _=new t.Mesh(new t.CylinderGeometry(.32,.42,.48,24),c);_.position.set(0,-.85,.35),_.rotation.x=Math.PI/2,n.add(_);const ee=new t.Mesh(new t.TorusGeometry(.34,.04,10,24),o);ee.position.set(0,-1.05,.35),ee.rotation.x=Math.PI/2,n.add(ee);for(let x=0;x<4;x++){const h=x/4*Math.PI*2+Math.PI/4,u=new t.Mesh(new t.CylinderGeometry(.022,.022,.15,6),p);u.position.set(Math.cos(h)*.36,-1.05,.35+Math.sin(h)*.36),u.rotation.z=-Math.PI/2,n.add(u)}[[3.2,0,0],[-3.2,0,0],[0,1,1],[0,-1,1]].forEach(([x,h,u])=>{const j=new t.Group;j.position.set(x,h,u);for(let f=0;f<4;f++){const S=f/4*Math.PI*2,N=new t.Mesh(new t.ConeGeometry(.04,.12,8),p);N.position.set(Math.cos(S)*.08,Math.sin(S)*.08,0),N.rotation.x=Math.PI/2,j.add(N)}n.add(j)});const U=[];[[0,-2.9,.15],[0,-2.9,-.15],[0,-1.1,.35],[0,-1.1,-.05],[-3.2,0,0],[3.2,0,0]].forEach(([x,h,u])=>{const j=new t.Sprite(new t.SpriteMaterial({map:s,color:6336767,transparent:!0,opacity:0,blending:t.AdditiveBlending,depthWrite:!1}));j.scale.set(2.8,2.8,1),j.position.set(x,h,u),n.add(j);const f=new t.Sprite(new t.SpriteMaterial({map:s,color:15267071,transparent:!0,opacity:0,blending:t.AdditiveBlending,depthWrite:!1}));f.scale.set(.7,.7,1),f.position.set(x,h,u),n.add(f),U.push({outer:j,inner:f})});const q=[];[[3.4,0,0,16724048],[-3.4,0,0,13041468],[0,2.95,1.2,16777215],[0,-2.95,1.2,16777215],[0,0,1.4,16747068],[0,0,-1.4,6741503]].forEach(([x,h,u,j])=>{const f=new t.Mesh(new t.SphereGeometry(.05,10,10),new t.MeshBasicMaterial({color:j,transparent:!0}));f.position.set(x,h,u);const S=new t.Sprite(new t.SpriteMaterial({map:s,color:j,transparent:!0,opacity:.6,blending:t.AdditiveBlending,depthWrite:!1}));S.scale.set(.4,.4,1),f.add(S),n.add(f),q.push({mesh:f,halo:S})});const se=[new t.Vector3(0,.82,.2),new t.Vector3(-2.4,2.85,0),new t.Vector3(.4,.65,1)],me=se.map((x,h)=>{const u=new t.Sprite(new t.SpriteMaterial({map:s,color:[13041468,3732944,8019199][h],transparent:!0,opacity:0,blending:t.AdditiveBlending,depthWrite:!1}));return u.scale.set(3.5,3.5,1),u.position.copy(x),n.add(u),u});return{thrusterGlows:U,navLights:q,focusHalos:me,FOCUS_ANCHORS:se,solarWings:I,dishGroup:w}}const ut=d.forwardRef(function({thrusterProxy:t,focusProxy:r,stationProxy:a},s){const i=d.useRef(),l=d.useRef(null);return d.useImperativeHandle(s,()=>i.current,[]),d.useEffect(()=>{if(!i.current)return;const c=xt(i.current);return l.current=c,()=>{l.current=null}},[]),de(({clock:c})=>{if(!l.current)return;const o=c.elapsedTime,p=(t==null?void 0:t.intensity)??0,b=(r==null?void 0:r.value)??-1,{thrusterGlows:M,navLights:k,focusHalos:y,solarWings:T,dishGroup:W}=l.current;T.forEach((P,I)=>{P.rotation.z=Math.sin(o*.06+I*1.4)*.22}),W.rotation.y=Math.sin(o*.05)*.3,W.rotation.x=Math.sin(o*.041+.7)*.08,M.forEach(({outer:P,inner:I},w)=>{const v=Math.sin(o*9+w*.8)*.5+.5;P.material.opacity=p*(.18+v*.07),I.material.opacity=p*(.45+v*.12)}),k.forEach(({mesh:P},I)=>{const w=Math.sin(o*(2.1+I*.43)+I*1.9)>.3;P.material.opacity=w?1:.04}),y.forEach((P,I)=>{const w=I===b?.36+Math.sin(o*1.8)*.07:0;P.material.opacity+=(w-P.material.opacity)*.06})}),e.jsx("group",{ref:i})}),vt=`
...
`;function ft(){const n=d.useRef(),{surfaceMat:t,atmoMat:r}=d.useMemo(()=>{const a=new Ae(Math.cos(-53*Math.PI/180)*Math.cos(135*Math.PI/180),Math.sin(-53*Math.PI/180),Math.cos(-53*Math.PI/180)*Math.sin(135*Math.PI/180)).normalize(),s=new ve({uniforms:{uTime:{value:0},uSunDir:{value:a.clone()},uSeaLevel:{value:-.02},uCloudOpacity:{value:.45},uCloudSpeed:{value:.65},uCityLights:{value:1},uAtmoStrength:{value:0}},vertexShader:`
      ...
      `}),i=new ve({side:ot,transparent:!0,depthWrite:!1,blending:fe,uniforms:{uSunDir:{value:a.clone()},uAtmoStrength:{value:.55}},vertexShader:`
      ...
      `});return{surfaceMat:s,atmoMat:i}},[]);return de(({clock:a})=>{t.uniforms.uTime.value=a.elapsedTime,n.current&&(n.current.rotation.y=a.elapsedTime*.075)}),e.jsxs("group",{ref:n,position:[-7.4,-7.5,-13.7],scale:1.14,children:[e.jsx("mesh",{material:t,children:e.jsx("sphereGeometry",{args:[2.7,96,64]})}),e.jsx("mesh",{material:r,children:e.jsx("sphereGeometry",{args:[2.92,64,48]})})]})}function gt(){const{geometry:t,material:r}=d.useMemo(()=>{const a=new Float32Array(6600),s=new Float32Array(2200),i=new Float32Array(2200*3);for(let o=0;o<2200;o++){const p=60+Math.random()*70,b=Math.random()*Math.PI*2,M=Math.acos(2*Math.random()-1);a[o*3]=p*Math.sin(M)*Math.cos(b),a[o*3+1]=p*Math.sin(M)*Math.sin(b),a[o*3+2]=p*Math.cos(M),s[o]=.4+Math.random()*1.4;const k=Math.random();i[o*3]=k<.15?1:k>.85?.7:.95,i[o*3+1]=k<.15?.85:k>.85?.8:.95,i[o*3+2]=k<.15?.7:k>.85?1:.95}const l=new qe;l.setAttribute("position",new ne(a,3)),l.setAttribute("starSize",new ne(s,1)),l.setAttribute("color",new ne(i,3));const c=new ve({uniforms:{},vertexShader:`
      ...
      `,transparent:!0,depthWrite:!1,blending:fe});return{geometry:l,material:c}},[]);return e.jsx("points",{geometry:t,material:r})}function bt(){const{geometry:n,material:t}=d.useMemo(()=>{const a=new Float32Array(660),s=new Float32Array(220),i=new Float32Array(220);for(let o=0;o<220;o++)a[o*3]=(Math.random()-.5)*30,a[o*3+1]=(Math.random()-.5)*18,a[o*3+2]=-6+Math.random()*14,s[o]=.25+Math.random()*.9,i[o]=.3+Math.random()*1;const l=new qe;l.setAttribute("position",new ne(a,3)),l.setAttribute("aSpeed",new ne(s,1)),l.setAttribute("starSize",new ne(i,1));const c=new ve({uniforms:{uTime:{value:0}},vertexShader:`
      ...
      `,transparent:!0,depthWrite:!1,blending:fe});return{geometry:l,material:c}},[]);return de(({clock:r})=>{t.uniforms.uTime.value=r.elapsedTime}),e.jsx("points",{geometry:n,material:t})}function yt(){const n=d.useMemo(()=>{const t=document.createElement("canvas");t.width=t.height=256;const r=t.getContext("2d"),a=r.createRadialGradient(128,128,0,128,128,128);return a.addColorStop(0,"rgba(255,244,220,.95)"),a.addColorStop(.18,"rgba(255,210,150,.38)"),a.addColorStop(.5,"rgba(255,170,90,.08)"),a.addColorStop(1,"rgba(0,0,0,0)"),r.fillStyle=a,r.fillRect(0,0,256,256),new lt({map:new pe(t),transparent:!0,opacity:.5,blending:fe,depthWrite:!1,fog:!1})},[]);return de(({clock:t})=>{n.opacity=.46+Math.sin(t.elapsedTime*.8)*.06}),e.jsx("sprite",{material:n,position:[44.7,22.3,31.3],scale:[30,30,1]})}function wt({cameraProxy:n,lookProxy:t,fovProxy:r}){const{camera:a}=ct(),s=d.useMemo(()=>new Ae,[]),i=d.useMemo(()=>new Ae,[]);return d.useEffect(()=>{a.position.set(0,1.6,28),a.fov=36,a.updateProjectionMatrix()},[]),de(({clock:l})=>{const c=l.elapsedTime,o=Math.sin(c*.19)*.06,p=Math.sin(c*.13)*.04,b=Math.sin(c*.07)*.05;i.set(((n==null?void 0:n.x)??0)+o,((n==null?void 0:n.y)??0)+p,((n==null?void 0:n.z)??16)+b),a.position.lerp(i,.18),s.set(((t==null?void 0:t.x)??0)+Math.sin(c*.17)*.025,((t==null?void 0:t.y)??0)+Math.cos(c*.21)*.02,(t==null?void 0:t.z)??0),a.lookAt(s),r&&Math.abs(a.fov-r.value)>.05&&(a.fov+=(r.value-a.fov)*.12,a.updateProjectionMatrix())}),null}function jt({issGroupRef:n,stationProxy:t,cameraProxy:r,lookProxy:a,thrusterProxy:s,fovProxy:i,focusProxy:l,onReady:c}){return d.useEffect(()=>{c==null||c()},[c]),e.jsxs(e.Fragment,{children:[e.jsx("ambientLight",{color:2107456,intensity:.35}),e.jsx("directionalLight",{color:16774364,intensity:2.4,position:[10,5,7]}),e.jsx("directionalLight",{color:4880568,intensity:.95,position:[6,-8,-4]}),e.jsx("directionalLight",{color:8965375,intensity:.45,position:[-7,3,-5]}),e.jsx(gt,{}),e.jsx(ft,{}),e.jsx(bt,{}),e.jsx(yt,{}),e.jsx(d.Suspense,{fallback:null,children:e.jsx(ut,{ref:n,thrusterProxy:s,focusProxy:l})}),e.jsx(wt,{cameraProxy:r,lookProxy:a,fovProxy:i})]})}function Nt({issGroupRef:n,stationProxy:t,cameraProxy:r,lookProxy:a,thrusterProxy:s,fovProxy:i,focusProxy:l,onLoaded:c}){return e.jsx(it,{dpr:[1,1.6],gl:{antialias:!0,alpha:!1,powerPreference:"high-performance"},style:{width:"100%",height:"100%",background:"#02030a"},camera:{fov:36,near:.1,far:300,position:[0,1.6,28]},onCreated:({scene:o})=>{o.fog=new st(131850,.025)},children:e.jsx(jt,{issGroupRef:n,stationProxy:t,cameraProxy:r,lookProxy:a,thrusterProxy:s,fovProxy:i,focusProxy:l,onReady:c})})}function Mt(n){return n?n.split(/(<em>[^<]*<\/em>|\n)/g).map((t,r)=>{if(t===`
`)return e.jsx("br",{},r);const a=t.match(/^<em>([^<]*)<\/em>$/);return a?e.jsx("em",{children:a[1]},r):t||null}):null}const kt=d.forwardRef(function({index:t=0,total:r=3,tag:a,title:s,description:i,stats:l,position:c="tr",state:o="future"},p){const b=["iss-card",`pos-${c}`,o==="active"?"is-active":"",o==="past"?"is-past":""].filter(Boolean).join(" ");return e.jsxs("article",{ref:p,className:b,"aria-hidden":o!=="active",children:[e.jsxs("div",{className:"iss-card-index",children:[e.jsx("em",{children:String(t+1).padStart(2,"0")}),e.jsx("span",{children:"/"}),e.jsx("span",{children:String(r).padStart(2,"0")})]}),a&&e.jsx("div",{className:"iss-card-tag",children:a}),s&&e.jsx("h3",{children:Mt(s)}),i&&e.jsx("p",{children:i}),l&&l.length>0&&e.jsx("div",{className:"iss-card-stats",children:l.map(([M,k],y)=>e.jsxs("div",{className:"iss-card-stat",children:[e.jsx("span",{className:"iss-card-stat-num",children:M}),e.jsx("span",{className:"iss-card-stat-lbl",children:k})]},y))})]})}),R=(n,t,r)=>n+(t-n)*r,Ze=(n,t,r)=>n<t?t:n>r?r:n,St=n=>{const t=Ze(n,0,1);return t*t*t*(t*(t*6-15)+10)},ce=[{p:0,cam:{x:0,y:1.6,z:28},look:{x:0,y:0,z:0},rotX:.05,rotY:.2,rotZ:0,fov:36,thruster:0,focus:-1,card:-1,phase:"approach"},{p:.1,cam:{x:0,y:.7,z:13.5},look:{x:0,y:.1,z:0},rotX:.18,rotY:.85,rotZ:.04,fov:40,thruster:.25,focus:-1,card:-1,phase:"active"},{p:.26,cam:{x:-1.9,y:1.8,z:6.4},look:{x:0,y:.6,z:.2},rotX:-.06,rotY:1.55,rotZ:-.04,fov:38,thruster:0,focus:0,card:0,phase:"reveal"},{p:.46,cam:{x:3.6,y:-.1,z:8},look:{x:-.4,y:1.4,z:0},rotX:.08,rotY:2.55,rotZ:.08,fov:44,thruster:0,focus:1,card:1,phase:"reveal"},{p:.66,cam:{x:-2.3,y:-.6,z:6.6},look:{x:.4,y:-.05,z:.9},rotX:.18,rotY:3.45,rotZ:-.05,fov:36,thruster:0,focus:2,card:2,phase:"reveal"},{p:.86,cam:{x:0,y:2.9,z:19.5},look:{x:0,y:-.8,z:-1.8},rotX:.28,rotY:4.25,rotZ:-.05,fov:46,thruster:.55,focus:-1,card:-1,phase:"outro"},{p:1,cam:{x:0,y:3.4,z:23},look:{x:0,y:-1.1,z:-2.4},rotX:.3,rotY:4.45,rotZ:-.06,fov:48,thruster:.25,focus:-1,card:-1,phase:"outro"}];function zt(n){let t=0;for(;t<ce.length-2&&n>ce[t+1].p;)t++;const r=ce[t],a=ce[Math.min(t+1,ce.length-1)],s=a.p-r.p,i=s>1e-5?St((n-r.p)/s):0;return{cam:{x:R(r.cam.x,a.cam.x,i),y:R(r.cam.y,a.cam.y,i),z:R(r.cam.z,a.cam.z,i)},look:{x:R(r.look.x,a.look.x,i),y:R(r.look.y,a.look.y,i),z:R(r.look.z,a.look.z,i)},rotX:R(r.rotX,a.rotX,i),rotY:R(r.rotY,a.rotY,i),rotZ:R(r.rotZ,a.rotZ,i),fov:R(r.fov,a.fov,i),thruster:R(r.thruster,a.thruster,i),focus:i>.65?a.focus:r.focus,card:i>.65?a.card:r.card,phase:i>.65?a.phase:r.phase}}function Pt({sectionRef:n,issGroupRef:t,stationProxy:r,cameraProxy:a,lookProxy:s,thrusterProxy:i,fovProxy:l,focusProxy:c,onPhaseChange:o,onCardChange:p,damping:b=.07}={}){d.useEffect(()=>{if(!(n!=null&&n.current)){console.warn("[ISS] sectionRef.current ist null – RAF wurde nicht gestartet");return}let M=0,k=0,y=0,T=-2,W="",P=!0;const I=()=>{const v=n.current;if(!v)return;const F=v.getBoundingClientRect(),C=document.documentElement.clientHeight||window.innerHeight,$=v.offsetHeight-C;if($<=0){k=0;return}k=Ze(-F.top/$,0,1)},w=()=>{if(!P)return;M=requestAnimationFrame(w),I(),y=R(y,k,b),Math.abs(y-k)<1e-4&&(y=k);const v=zt(y),F=performance.now()/1e3;a&&(a.x=v.cam.x,a.y=v.cam.y,a.z=v.cam.z),s&&(s.x=v.look.x,s.y=v.look.y,s.z=v.look.z),r&&(r.rotX=v.rotX,r.rotY=v.rotY,r.rotZ=v.rotZ),i&&(i.intensity=v.thruster),l&&(l.value=v.fov),c&&(c.value=v.focus);const C=t==null?void 0:t.current;C&&(C.position.x=Math.sin(F*.31)*.04,C.position.y=Math.sin(F*.23)*.055,C.position.z=Math.sin(F*.17)*.03,C.rotation.x=v.rotX+Math.sin(F*.07)*.005,C.rotation.y=v.rotY+Math.sin(F*.09)*.008,C.rotation.z=v.rotZ+Math.sin(F*.11)*.004),v.card!==T&&(T=v.card,p&&p(v.card)),v.phase!==W&&(W=v.phase,o&&o(v.phase))};return M=requestAnimationFrame(w),()=>{P=!1,cancelAnimationFrame(M)}},[n,t,r,a,s,i,l,c,o,p,b])}const Ie=[{tag:"Observation Layer",title:`Intelligente
...
<em>Orchestrierung</em>`,description:"Die Schüssel zeigt nach draußen — NILL spricht mit Banken, Behörden, Lieferanten. Workloads finden ihren Weg, ohne dass du ein Ticket öffnest.",stats:[["1.200+","aufgaben/tag"],["−60 %","manuelle arbeit"],["3 s","cold start"]],position:"br"}];function It(){const n=d.useRef(null),t=d.useRef(null),r=[d.useRef(null),d.useRef(null),d.useRef(null)],[a,s]=d.useState(-1),[i,l]=d.useState("approach"),[c,o]=d.useState(!1),[p,b]=d.useState({x:"0.00",y:"0.00",z:"0.00"}),M=d.useMemo(()=>({rotX:0,rotY:0,rotZ:0}),[]),k=d.useMemo(()=>({x:0,y:1.6,z:28}),[]),y=d.useMemo(()=>({x:0,y:0,z:0}),[]),T=d.useMemo(()=>({intensity:0}),[]),W=d.useMemo(()=>({value:36}),[]),P=d.useMemo(()=>({value:-1}),[]);Pt({sectionRef:n,issGroupRef:t,stationProxy:M,cameraProxy:k,lookProxy:y,thrusterProxy:T,fovProxy:W,focusProxy:P,onCardChange:s,onPhaseChange:l,damping:.07}),d.useEffect(()=>{let w=0,v=0;const F=C=>{w=requestAnimationFrame(F),!(C-v<120)&&(v=C,b({x:k.x.toFixed(2),y:k.y.toFixed(2),z:k.z.toFixed(2)}))};return w=requestAnimationFrame(F),()=>cancelAnimationFrame(w)},[k]);const I=w=>w===a?"active":a>w?"past":"future";return e.jsx("section",{ref:n,className:`iss-section ${c?"iss-loaded":""}`,"data-screen-label":"ISS",children:e.jsxs("div",{className:"iss-sticky","data-phase":i,children:[e.jsx("div",{className:"iss-canvas-wrap",children:e.jsx(Nt,{issGroupRef:t,stationProxy:M,cameraProxy:k,lookProxy:y,thrusterProxy:T,fovProxy:W,focusProxy:P,onLoaded:()=>o(!0)})}),e.jsx("div",{className:"iss-bar top","aria-hidden":"true"}),e.jsx("div",{className:"iss-bar bot","aria-hidden":"true"}),e.jsx("div",{className:"iss-grain","aria-hidden":"true"}),e.jsxs("div",{className:"iss-hud tl",children:[e.jsxs("div",{children:[e.jsx("span",{className:"dot"}),"NILL · MISSION CONTROL"]}),e.jsx("div",{className:"label",children:"Orbital Layer · v1"})]}),e.jsxs("div",{className:"iss-hud tr",children:[e.jsx("div",{className:"label",children:"REF · NILL-OS / ISS-04"}),e.jsx("div",{className:"value",children:"42° 06′ 18″ N · 5° 23′ 41″ E"})]}),e.jsxs("div",{className:"iss-hud bl",children:[e.jsx("div",{className:"label",children:"CAMERA"}),e.jsxs("div",{className:"value",children:["x ",e.jsx("em",{children:p.x}),"  y ",e.jsx("em",{children:p.y}),"  z ",e.jsx("em",{children:p.z})]})]}),e.jsxs("div",{className:"iss-hud br",children:[e.jsx("div",{className:"label",children:"STATUS"}),e.jsx("div",{className:"value",children:i==="approach"?"APPROACH — STAND-BY":i==="reveal"?"REVEAL — MODULE FOCUS":"NOMINAL — TRACKING"})]}),e.jsx("div",{className:"iss-intro","aria-hidden":i!=="approach",children:e.jsxs("div",{className:"iss-intro-inner",children:[e.jsxs("span",{className:"eyebrow",children:[e.jsx("span",{className:"pip"}),"NILL · MISSION CONTROL"]}),e.jsxs("h2",{children:["Das Betriebssystem, das dein",e.jsx("br",{}),"Unternehmen ",e.jsx("em",{children:"im Orbit"})," hält."]}),e.jsx("p",{children:"Stell dir NILL als Raumstation vor: ein zentrales System, das alle Module deines Betriebs verbindet. Beobachtung, Energie, Kommunikation — orchestriert von einer KI, die nie schläft."})]})}),e.jsx("div",{className:"iss-outro","aria-hidden":i!=="outro",children:e.jsxs("div",{className:"iss-outro-inner",children:[e.jsxs("span",{className:"eyebrow",children:[e.jsx("span",{className:"pip"}),"READY · LAUNCH WINDOW OPEN"]}),e.jsxs("h2",{children:["Eine Plattform.",e.jsx("br",{}),"Ein Login. ",e.jsx("em",{children:"Alle Module."})]}),e.jsx("p",{children:"NILL hält deinen Betrieb in der Umlaufbahn — 24/7, ohne Tickets, ohne Bauchschmerzen. Bereit, die Station zu betreten?"}),e.jsxs("a",{className:"iss-outro-cta",href:"#cta",children:["Demo anfragen ",e.jsx("span",{className:"arrow",children:"→"})]})]})}),e.jsx("div",{className:"iss-card-stage",children:Ie.map((w,v)=>e.jsx(kt,{ref:r[v],index:v,total:Ie.length,tag:w.tag,title:w.title,description:w.description,stats:w.stats,position:w.position,state:I(v)},v))}),e.jsx("div",{className:"iss-progress","aria-hidden":"true",children:Ie.map((w,v)=>e.jsx("div",{className:`iss-progress-dot ${v===a?"active":v<a?"passed":""}`},v))}),e.jsxs("div",{className:`iss-scroll-hint ${i!=="approach"?"hidden":""}`,children:[e.jsx("span",{children:"scroll · mission"}),e.jsx("span",{className:"iss-scroll-hint-line"})]})]})})}const At=`
:root{
...
`;let Ke=!1,$e=!1;function Tt(){if(Ke)return;Ke=!0;const n=document.createElement("style");if(n.textContent=At,document.head.appendChild(n),document.title="NILL — Intelligenz, die mitarbeitet.",!window.THREE&&!$e){$e=!0;const t=document.createElement("script");t.src="https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js",document.head.appendChild(t)}}function V(n=.12){const t=d.useRef(null),[r,a]=d.useState(!1);return d.useEffect(()=>{if(!t.current)return;const s=new IntersectionObserver(([i])=>{i.isIntersecting&&(a(!0),s.disconnect())},{threshold:n});return s.observe(t.current),()=>s.disconnect()},[]),[t,r]}function Q({className:n="",stagger:t=!1,children:r,...a}){const[s,i]=V(.08);return e.jsx("div",{ref:s,className:`${t?"stagger":"reveal"}${i?" in":""} ${n}`,...a,children:r})}function Ct(){const n=d.useRef(null);return d.useEffect(()=>{let t,r=0;const a=()=>{t=requestAnimationFrame(a);const s=document.documentElement.scrollHeight-innerHeight,i=s>0?window.scrollY/s:0;r+=(i-r)*.12,n.current&&(n.current.style.transform=`scaleX(${r})`)};return t=requestAnimationFrame(a),()=>cancelAnimationFrame(t)},[]),e.jsx("div",{className:"scroll-progress","aria-hidden":"true",children:e.jsx("span",{ref:n})})}function Xe(n){d.useEffect(()=>{const t=n.current;if(!t)return;const r=s=>{const i=t.getBoundingClientRect();t.style.setProperty("--mx",(s.clientX-i.left)/i.width*100+"%"),t.style.setProperty("--my",(s.clientY-i.top)/i.height*100+"%");const l=(s.clientY-i.top-i.height/2)/i.height*-4,c=(s.clientX-i.left-i.width/2)/i.width*4;t.style.transform=`translateY(-4px) perspective(900px) rotateX(${l}deg) rotateY(${c}deg)`},a=()=>t.style.transform="";return t.addEventListener("mousemove",r),t.addEventListener("mouseleave",a),()=>{t.removeEventListener("mousemove",r),t.removeEventListener("mouseleave",a)}},[])}function Lt(n){d.useEffect(()=>{const t=n.current;if(!t)return;const r=s=>{const i=t.getBoundingClientRect();t.style.transform=`translate(${(s.clientX-i.left-i.width/2)/i.width*18}px,${(s.clientY-i.top-i.height/2)/i.height*18}px)`},a=()=>t.style.transform="";return t.addEventListener("mousemove",r),t.addEventListener("mouseleave",a),()=>{t.removeEventListener("mousemove",r),t.removeEventListener("mouseleave",a)}},[])}function G({className:n,children:t,onClick:r,href:a}){const s=d.useRef(null);return Lt(s),a?e.jsx("a",{ref:s,href:a,className:n,onClick:r,children:t}):e.jsx("button",{ref:s,className:n,onClick:r,children:t})}function ae({className:n,style:t,children:r}){const a=d.useRef(null);return Xe(a),e.jsx("article",{ref:a,className:`card ${n||""}`,style:t,children:r})}const Te=`
  vec3 _m3(vec3 x){return x-floor(x*(1./289.))*289.;}
  vec4 _m4(vec4 x){return x-floor(x*(1./289.))*289.;}
...
`;function Ot(n){const t=THREE,r=new t.WebGLRenderer({canvas:n,antialias:!0,powerPreference:"high-performance"});r.setPixelRatio(Math.min(devicePixelRatio,1.5)),r.setClearColor(131850,1);const a=new t.Scene,s=new t.PerspectiveCamera(42,2,.1,300);s.position.set(0,1.8,11),s.lookAt(0,0,0);const i=2200,l=new Float32Array(i*3),c=new Float32Array(i),o=new Float32Array(i*3),p=new Float32Array(i);for(let m=0;m<i;m++){p[m]=Math.random()*Math.PI*2;const z=60+Math.random()*70,g=Math.random()*Math.PI*2,L=Math.acos(2*Math.random()-1);l[m*3]=z*Math.sin(L)*Math.cos(g),l[m*3+1]=z*Math.sin(L)*Math.sin(g),l[m*3+2]=z*Math.cos(L),c[m]=.4+Math.random()*1.4;const A=Math.random();o[m*3]=A<.15?1:A>.85?.7:.95,o[m*3+1]=A<.15?.85:A>.85?.8:.95,o[m*3+2]=A<.15?.7:A>.85?1:.95}const b=new t.BufferGeometry;b.setAttribute("position",new t.BufferAttribute(l,3)),b.setAttribute("starSize",new t.BufferAttribute(c,1)),b.setAttribute("color",new t.BufferAttribute(o,3)),b.setAttribute("twinkle",new t.BufferAttribute(p,1));const M=new t.ShaderMaterial({uniforms:{uTime:{value:0}},vertexShader:"attribute float starSize;attribute vec3 color;attribute float twinkle;uniform float uTime;varying vec3 vC;varying float vTw;void main(){vC=color;vTw=.72+.28*sin(uTime*1.6+twinkle*7.);vec4 mv=modelViewMatrix*vec4(position,1.);gl_PointSize=starSize*(.85+.3*sin(uTime*1.1+twinkle*5.))*(700./-mv.z);gl_Position=projectionMatrix*mv;}",fragmentShader:"varying vec3 vC;varying float vTw;void main(){vec2 uv=gl_PointCoord-.5;float a=1.-smoothstep(.25,.5,length(uv));if(a<.01)discard;gl_FragColor=vec4(vC,a*.85*vTw);}",transparent:!0,depthWrite:!1,blending:t.AdditiveBlending}),k=new t.Points(b,M);a.add(k);const y=new t.Group;y.rotation.x=-.55,y.rotation.z=.07,a.add(y);const T=new t.Group;y.add(T);const W=new t.ShaderMaterial({uniforms:{uTime:{value:0}},vertexShader:"varying vec3 vP;varying vec3 vN;void main(){vP=position;vN=normal;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}",fragmentShader:Te+`
    ...
    `}),P=new t.Mesh(new t.SphereGeometry(.92,64,48),W);T.add(P);const I=m=>{const z=document.createElement("canvas");z.width=z.height=256;const g=z.getContext("2d"),L=g.createRadialGradient(128,128,0,128,128,128);m.forEach(([X,B])=>L.addColorStop(X,B)),g.fillStyle=L,g.fillRect(0,0,256,256);const A=new t.CanvasTexture(z);return A.minFilter=t.LinearFilter,A},w=(m,z,g)=>{const L=new t.Sprite(new t.SpriteMaterial({map:z,transparent:!0,opacity:g,blending:t.AdditiveBlending,depthWrite:!1,depthTest:!1}));return L.scale.set(m,m,1),T.add(L),L},v=I([[0,"rgba(255,240,190,1)"],[.2,"rgba(255,150,50,.5)"],[.55,"rgba(198,255,60,.12)"],[1,"rgba(0,0,0,0)"]]),F=I([[0,"rgba(0,0,0,0)"],[.55,"rgba(255,130,40,.08)"],[.75,"rgba(120,80,220,.12)"],[1,"rgba(0,0,0,0)"]]),C=I([[0,"rgba(0,0,0,0)"],[.6,"rgba(80,60,180,.06)"],[.85,"rgba(198,255,60,.05)"],[1,"rgba(0,0,0,0)"]]),$=w(5.5,v,.82),Y=w(10,F,.48),re=w(17,C,.24),ie=[{r:2.2,sz:.3,spd:.26,phase:.3,tilt:.03,surf:Wt,atmo:[.55,.9,.22],atmoI:.55},{r:3.05,sz:.4,spd:.19,phase:1.6,tilt:-.05,surf:Rt,atmo:[.18,.88,.9],atmoI:.48},{r:3.88,sz:.28,spd:.15,phase:3,tilt:.04,surf:Dt,atmo:[.92,.28,.2],atmoI:.38},{r:4.92,sz:.55,spd:.11,phase:4.7,tilt:-.03,surf:Bt,atmo:[.88,.68,.35],atmoI:.42,rings:!0},{r:6.08,sz:.34,spd:.09,phase:5.9,tilt:.05,surf:Ye,atmo:[.72,.7,.66],atmoI:.22},{r:7.12,sz:.22,spd:.07,phase:1.2,tilt:-.04,surf:Gt,atmo:[.78,1,.28],atmoI:.5,future:!0}],_=new t.Vector3,ee=[];ie.forEach(m=>{const z=new t.Mesh(new t.RingGeometry(m.r-.005,m.r+.005,160),new t.MeshBasicMaterial({color:16777215,transparent:!0,opacity:m.future?.04:.07,side:t.DoubleSide,depthWrite:!1}));z.rotation.x=Math.PI/2+m.tilt,y.add(z);const g=m.rings?64:56,L=new t.ShaderMaterial({uniforms:{uTime:{value:0},uSunPos:{value:new t.Vector3},uAtmo:{value:new t.Color(...m.atmo)}},vertexShader:He,fragmentShader:Ve(m.surf)}),A=new t.Mesh(new t.SphereGeometry(m.sz,g,Math.round(g*.65)),L);y.add(A);const X=new t.ShaderMaterial({side:t.FrontSide,transparent:!0,depthWrite:!1,blending:t.AdditiveBlending,uniforms:{uSunPos:{value:new t.Vector3},uColor:{value:new t.Color(...m.atmo)},uIntensity:{value:m.future?.28:m.atmoI}},vertexShader:Et,fragmentShader:Ft}),B=new t.Mesh(new t.SphereGeometry(m.sz*1.12,32,22),X);y.add(B);let K=null;if(m.rings){const xe=m.sz*1.55,ue=m.sz*2.72;K=new t.Mesh(new t.RingGeometry(xe,ue,140,1),new t.ShaderMaterial({side:t.DoubleSide,transparent:!0,depthWrite:!1,uniforms:{uInner:{value:xe},uOuter:{value:ue},uSunPos:{value:new t.Vector3}},vertexShader:"varying vec3 vLP;varying vec3 vWP;void main(){vLP=position;vec4 wp=modelMatrix*vec4(position,1.);vWP=wp.xyz;gl_Position=projectionMatrix*viewMatrix*wp;}",fragmentShader:_t})),K.rotation.x=-Math.PI/2+.2,K.rotation.z=.1,y.add(K)}ee.push({mesh:A,pMat:L,atmo:B,atmoMat:X,ring:K,def:m})});const U=700,q=new Float32Array(U*3),se=new Float32Array(U),me=new Float32Array(U);for(let m=0;m<U;m++){const z=5.42+Math.random()*.42+(Math.random()<.06?Math.random()*.2:0),g=Math.random()*Math.PI*2;q[m*3]=Math.cos(g)*z,q[m*3+1]=(Math.random()-.5)*.14,q[m*3+2]=Math.sin(g)*z,se[m]=.35+Math.random()*1.1,me[m]=Math.random()*Math.PI*2}const x=new t.BufferGeometry;x.setAttribute("position",new t.BufferAttribute(q,3)),x.setAttribute("starSize",new t.BufferAttribute(se,1)),x.setAttribute("twinkle",new t.BufferAttribute(me,1));const h=new t.ShaderMaterial({uniforms:{uTime:{value:0}},vertexShader:"attribute float starSize;attribute float twinkle;uniform float uTime;varying float vA;void main(){vA=.5+.5*sin(uTime*.9+twinkle*9.);vec4 mv=modelViewMatrix*vec4(position,1.);gl_PointSize=starSize*(260./-mv.z);gl_Position=projectionMatrix*mv;}",fragmentShader:"varying float vA;void main(){vec2 uv=gl_PointCoord-.5;float a=1.-smoothstep(.18,.5,length(uv));if(a<.01)discard;gl_FragColor=vec4(vec3(.78,.74,.66),a*(.22+vA*.28));}",transparent:!0,depthWrite:!1,blending:t.AdditiveBlending}),u=new t.Points(x,h);y.add(u);const j=I([[0,"rgba(225,250,255,1)"],[.25,"rgba(150,210,255,.6)"],[.6,"rgba(80,140,255,.12)"],[1,"rgba(0,0,0,0)"]]),f=new t.Sprite(new t.SpriteMaterial({map:j,transparent:!0,opacity:.95,blending:t.AdditiveBlending,depthWrite:!1}));f.scale.set(.55,.55,1),y.add(f);const S=64,N=new Float32Array(S*3),O=new Float32Array(S);for(let m=0;m<S;m++)O[m]=m/S;const D=new t.BufferGeometry;D.setAttribute("position",new t.BufferAttribute(N,3).setUsage(t.DynamicDrawUsage)),D.setAttribute("age",new t.BufferAttribute(O,1));const Z=new t.ShaderMaterial({vertexShader:"attribute float age;varying float vA;void main(){vA=1.-age;vec4 mv=modelViewMatrix*vec4(position,1.);gl_PointSize=(1.-age)*(95./-mv.z)+1.5;gl_Position=projectionMatrix*mv;}",fragmentShader:"varying float vA;void main(){vec2 uv=gl_PointCoord-.5;float a=1.-smoothstep(.1,.5,length(uv));if(a<.01)discard;gl_FragColor=vec4(mix(vec3(.35,.55,1.),vec3(.85,.95,1.),vA),a*vA*.6);}",transparent:!0,depthWrite:!1,blending:t.AdditiveBlending}),te=new t.Points(D,Z);y.add(te);let oe=Math.random()*Math.PI*2;const Je=3.4,Qe=.62,H=new t.Vector3,ge=new t.ShaderMaterial({uniforms:{uTime:{value:0},uSunPos:{value:new t.Vector3},uAtmo:{value:new t.Color(.7,.7,.66)}},vertexShader:He,fragmentShader:Ve(Ye)}),be=new t.Mesh(new t.SphereGeometry(.085,26,18),ge);y.add(be);let Ce=0,Le=0,ye=0,we=0,Ee=0;const Fe=m=>{Ce=m.clientX/innerWidth-.5,Le=m.clientY/innerHeight-.5},We=()=>{Ee=Math.min(window.scrollY/innerHeight,1.2)};addEventListener("pointermove",Fe,{passive:!0}),addEventListener("scroll",We,{passive:!0});const je=()=>{const m=n.parentElement;if(!m)return;const z=m.clientWidth,g=m.clientHeight;r.setSize(z,g,!1),s.aspect=z/g,s.updateProjectionMatrix()};je(),addEventListener("resize",je);const Re=performance.now();let De=Re,Be,he=0,Ge=!1;const _e=()=>{Be=requestAnimationFrame(_e);const m=performance.now(),z=Math.min((m-De)/1e3,1/20);De=m;const g=(m-Re)/1e3;ye+=(Ce-ye)*.05,we+=(Le-we)*.05,he+=(Ee-he)*.06;const L=1-Math.pow(1-Math.min(1,g/2.8),3);s.position.set(0,1.8+(1-L)*1.7,11+(1-L)*4.6),s.lookAt(0,0,0),y.rotation.y=g*.028+ye*.26-(1-L)*.65,y.rotation.x=-.55+we*.09-he*.16,y.position.y=-he*.7,W.uniforms.uTime.value=g,P.rotation.y=g*.07,P.scale.setScalar(1+Math.sin(g*.9)*.018),Y.material.opacity=.46+Math.sin(g*1.1)*.04,re.material.opacity=.22+Math.sin(g*.7+1.2)*.04,Y.material.rotation=g*.02,re.material.rotation=-g*.015,$.material.opacity=.8+Math.sin(g*1.2)*.07,T.getWorldPosition(_),k.rotation.y=g*.003,M.uniforms.uTime.value=g,h.uniforms.uTime.value=g,u.rotation.y=g*.014;const A=Je/(1+Qe*Math.cos(oe));oe+=z*1.35/(A*A),H.set(Math.cos(oe)*A,Math.sin(oe)*A*.16,Math.sin(oe)*A),f.position.copy(H);const X=.3+1.1/A;if(f.scale.set(X,X,1),Ge){for(let E=S-1;E>0;E--)N[E*3]=N[(E-1)*3],N[E*3+1]=N[(E-1)*3+1],N[E*3+2]=N[(E-1)*3+2];N[0]=H.x,N[1]=H.y,N[2]=H.z}else{Ge=!0;for(let E=0;E<S;E++)N[E*3]=H.x,N[E*3+1]=H.y,N[E*3+2]=H.z}D.attributes.position.needsUpdate=!0;const B=ie[3],K=B.phase+g*B.spd,xe=Math.cos(K)*B.r,ue=Math.sin(K*.55+B.tilt*4)*.22,et=Math.sin(K)*B.r,Ne=g*.85;be.position.set(xe+Math.cos(Ne)*1.18,ue+Math.sin(Ne)*.26,et+Math.sin(Ne)*1.18),be.rotation.y=g*.3,ge.uniforms.uTime.value=g,ge.uniforms.uSunPos.value.copy(_);for(const{mesh:E,pMat:Oe,atmo:tt,atmoMat:at,ring:Me,def:le}of ee){const ke=le.phase+g*le.spd,Se=Math.cos(ke)*le.r,ze=Math.sin(ke*.55+le.tilt*4)*.22,Pe=Math.sin(ke)*le.r;E.position.set(Se,ze,Pe),E.rotation.y+=z*.18,Oe.uniforms.uTime.value=g,Oe.uniforms.uSunPos.value.copy(_),tt.position.set(Se,ze,Pe),at.uniforms.uSunPos.value.copy(_),Me&&(Me.position.set(Se,ze,Pe),Me.material.uniforms.uSunPos.value.copy(_))}r.render(a,s)};return _e(),()=>{cancelAnimationFrame(Be),removeEventListener("pointermove",Fe),removeEventListener("scroll",We),removeEventListener("resize",je),r.dispose()}}function Kt(){const n=d.useRef(null),[t,r]=d.useState(!!window.THREE);return d.useEffect(()=>{if(window.THREE){r(!0);return}const a=setInterval(()=>{window.THREE&&(clearInterval(a),r(!0))},50);return()=>clearInterval(a)},[]),d.useEffect(()=>{if(!(!n.current||!window.THREE))return Ot(n.current)},[t]),e.jsx("canvas",{ref:n,style:{position:"absolute",inset:0,zIndex:0,display:"block",width:"100%",height:"100%"}})}function $t({onDemo:n}){const[t,r]=d.useState(!1);return d.useEffect(()=>{const a=()=>r(window.scrollY>40);return a(),addEventListener("scroll",a,{passive:!0}),()=>removeEventListener("scroll",a)},[]),e.jsx("header",{className:`nav${t?" scrolled":""}`,id:"nav",children:e.jsxs("div",{className:"wrap",children:[e.jsxs("a",{className:"brand",href:"#top",children:[e.jsx("span",{className:"brand-mark","aria-hidden":"true"}),e.jsx("span",{children:"NILL"})]}),e.jsx("nav",{"aria-label":"Primary",children:e.jsxs("ul",{children:[e.jsx("li",{children:e.jsx("a",{href:"#produkte",children:"Produkte"})}),e.jsx("li",{children:e.jsx("a",{href:"#wie",children:"Wie es arbeitet"})}),e.jsx("li",{children:e.jsx("a",{href:"#preise",children:"Preise"})}),e.jsx("li",{children:e.jsx("a",{href:"#nachhaltigkeit",children:"Nachhaltigkeit"})}),e.jsx("li",{children:e.jsx("a",{href:"#faq",children:"FAQ"})})]})}),e.jsxs("div",{className:"nav-auth",children:[e.jsx("a",{href:"https://nillai.de/login",className:"btn-auth",children:"Login"}),e.jsx("a",{href:"https://nillai.de/register",className:"btn-auth primary",children:"Registrieren"})]})]})})}function Ht({onCTA:n}){const[t,r]=d.useState(!1);return d.useEffect(()=>{const a=setTimeout(()=>r(!0),80);return()=>clearTimeout(a)},[]),e.jsxs("section",{className:`hero${t?" revealed":""}`,id:"top",children:[e.jsx(Kt,{}),e.jsxs("div",{className:"hero-chips","aria-hidden":"true",children:[e.jsxs("span",{className:"chip c1",children:[e.jsx("span",{className:"chip-dot"}),e.jsx("span",{children:"KI aktiv"})]}),e.jsxs("span",{className:"chip c2",children:[e.jsx("span",{className:"chip-dot",style:{background:"var(--accent-4)"}}),e.jsx("span",{children:"47 Mails sortiert"})]}),e.jsxs("span",{className:"chip c3",children:[e.jsx("span",{className:"chip-dot",style:{background:"var(--accent-2)"}}),e.jsx("span",{children:"Rechnung gebucht"})]}),e.jsxs("span",{className:"chip c4",children:[e.jsx("span",{className:"chip-dot",style:{background:"var(--accent-3)"}}),e.jsx("span",{children:"Dienstplan aktualisiert"})]})]}),e.jsxs("div",{className:"wrap hero-inner",children:[e.jsx("span",{className:"eyebrow hero-eyebrow",children:"KI-Betriebssystem für Unternehmen"}),e.jsxs("h1",{"aria-label":"Intelligenz, die mitarbeitet.",children:[e.jsx("span",{className:"word",children:e.jsx("span",{children:"Intelligenz,"})}),e.jsx("br",{}),e.jsx("span",{className:"word",children:e.jsx("span",{children:"die "})}),e.jsx("span",{className:"word",children:e.jsx("span",{children:e.jsx("em",{children:"mit­arbeitet."})})})]}),e.jsxs("p",{className:"lead",children:["NILL verbindet ",e.jsx("strong",{style:{color:"var(--ink)",fontWeight:500},children:"Postfach, Buchhaltung, Inventur, Zeiterfassung"})," und ",e.jsx("strong",{style:{color:"var(--ink)",fontWeight:500},children:"Teamverwaltung"})," zu einem einzigen System — gesteuert von einer KI, die Arbeit erkennt, entscheidet und erledigt."]}),e.jsxs("div",{className:"hero-cta",children:[e.jsxs(G,{className:"btn btn-primary",href:"https://app.nillai.de/register",children:[e.jsx("span",{children:"Kostenlos registrieren"}),e.jsx("span",{className:"arrow",children:"→"})]}),e.jsxs(G,{className:"btn btn-ghost",href:"https://app.nillai.de/login",children:[e.jsx("span",{children:"Login"}),e.jsx("span",{className:"arrow",children:"→"})]}),e.jsxs(G,{className:"btn btn-ghost",onClick:a=>{a.preventDefault(),n("Demo")},href:"#",children:[e.jsx("span",{children:"Live-Demo"}),e.jsx("span",{className:"arrow",children:"↓"})]})]})]}),e.jsxs("div",{className:"hero-meta",children:[e.jsx("span",{children:"NILL v4 · Stand 2026"}),e.jsxs("div",{className:"scroll-ind",children:[e.jsx("span",{children:"scroll"}),e.jsx("div",{className:"scroll-bar"})]}),e.jsx("span",{children:"DE · Made in Germany"})]})]})}function Vt(){const n=e.jsxs(e.Fragment,{children:["Postfach ",e.jsx("em",{children:"·"})," Buchhaltung ",e.jsx("span",{className:"ticker-sep"})," Inventur ",e.jsx("em",{children:"·"})," Zeiterfassung ",e.jsx("span",{className:"ticker-sep"})," Team­verwaltung ",e.jsx("em",{children:"·"})," Sekretärin ",e.jsx("span",{className:"ticker-sep"})," ",e.jsx("em",{children:"Ein Login."})," ",e.jsx("span",{className:"ticker-sep"}),"Postfach ",e.jsx("em",{children:"·"})," Buchhaltung ",e.jsx("span",{className:"ticker-sep"})," Inventur ",e.jsx("em",{children:"·"})," Zeiterfassung ",e.jsx("span",{className:"ticker-sep"})," Team­verwaltung ",e.jsx("em",{children:"·"})," Sekretärin ",e.jsx("span",{className:"ticker-sep"})," ",e.jsx("em",{children:"Ein Login."})," ",e.jsx("span",{className:"ticker-sep"})]});return e.jsx("div",{className:"ticker",children:e.jsx("div",{className:"ticker-track","aria-hidden":"true",children:e.jsx("span",{children:n})})})}function Yt({onCTA:n}){const[t,r]=V();return e.jsx("section",{id:"produkte",children:e.jsxs("div",{className:"wrap",children:[e.jsxs("div",{className:`section-head reveal${r?" in":""}`,ref:t,children:[e.jsxs("div",{children:[e.jsx("span",{className:"eyebrow",children:"Module — 05 live · 01 in Entwicklung"}),e.jsxs("h2",{children:["Sechs Module. ",e.jsx("br",{}),e.jsx("em",{style:{fontStyle:"italic",color:"var(--accent)",fontFamily:"var(--serif)",fontVariationSettings:'"opsz" 144,"SOFT" 100,"WONK" 1'},children:"Eine"})," Intelligenz."]})]}),e.jsx("p",{className:"lead",children:"Jedes Modul steht für sich — doch gemeinsam werden sie zu einem Gehirn, das dein Unternehmen versteht."})]}),e.jsxs(Q,{stagger:!0,className:"bento",children:[e.jsxs(ae,{className:"k1",children:[e.jsx("div",{className:"viz","aria-hidden":"true",children:e.jsxs("svg",{viewBox:"0 0 600 380",preserveAspectRatio:"none",children:[e.jsx("defs",{children:e.jsxs("linearGradient",{id:"mg",x1:"0",y1:"0",x2:"1",y2:"1",children:[e.jsx("stop",{offset:"0",stopColor:"#c6ff3c",stopOpacity:".25"}),e.jsx("stop",{offset:"1",stopColor:"#c6ff3c",stopOpacity:"0"})]})}),e.jsx("g",{transform:"translate(260,40)",opacity:".8",children:[0,60,120,180].map((a,s)=>e.jsxs("g",{className:"mail-row",transform:`translate(0,${a})`,children:[e.jsx("rect",{width:"300",height:"48",rx:"8",fill:s===0?"url(#mg)":"rgba(255,255,255,.03)",stroke:"rgba(255,255,255,.08)"}),e.jsx("circle",{cx:"22",cy:"24",r:"6",fill:["#c6ff3c","#7a5cff","#38f5d0","#ff4d8d"][s]}),e.jsx("rect",{x:"42",y:"16",width:[120,100,140,80][s],height:"6",rx:"3",fill:"rgba(255,255,255,.6)"}),e.jsx("rect",{x:"42",y:"28",width:[200,180,160,220][s],height:"4",rx:"2",fill:"rgba(255,255,255,.2)"})]},a))})]})}),e.jsxs("div",{children:[e.jsxs("span",{className:"tag",children:[e.jsx("span",{className:"n",children:"01"})," · Postfach"]}),e.jsxs("h3",{children:["E-Mails, die sich ",e.jsx("em",{style:{fontStyle:"italic",color:"var(--accent)"},children:"selbst beantworten."})]}),e.jsx("p",{children:"Kategorisieren, priorisieren, Antworten schreiben — NILL liest mit und arbeitet voraus."})]})]}),e.jsxs(ae,{className:"k2",children:[e.jsxs("div",{children:[e.jsxs("span",{className:"tag",children:[e.jsx("span",{className:"n",children:"02"})," · Buchhaltung"]}),e.jsxs("h3",{children:["Belege buchen. ",e.jsx("em",{style:{fontStyle:"italic",color:"var(--accent)"},children:"Ohne dich."})]}),e.jsx("p",{children:"Rechnungen per Mail, Scan oder Foto — NILL erkennt, kontiert, verbucht und bereitet auf."})]}),e.jsx("div",{style:{display:"flex",gap:8,flexWrap:"wrap",fontFamily:"var(--mono)",fontSize:11,color:"var(--ink-dim)"},children:["DATEV-ready","OCR","GoBD-konform"].map(a=>e.jsx("span",{style:{padding:"6px 10px",border:"1px solid var(--line)",borderRadius:99},children:a},a))})]}),e.jsx(ae,{className:"k3",children:e.jsxs("div",{children:[e.jsxs("span",{className:"tag",children:[e.jsx("span",{className:"n",children:"03"})," · Inventur"]}),e.jsxs("h3",{children:["Bestände, die sich ",e.jsx("em",{style:{fontStyle:"italic",color:"var(--accent)"},children:"selbst zählen."})]}),e.jsx("p",{children:"Automatische Fortschreibung, Meldegrenzen mit Benachrichtigung."})]})}),e.jsxs(ae,{className:"k4",children:[e.jsxs("div",{children:[e.jsxs("span",{className:"tag",children:[e.jsx("span",{className:"n",children:"04"})," · Zeiterfassung"]}),e.jsxs("h3",{children:["Zeit erfasst sich ",e.jsx("em",{style:{fontStyle:"italic",color:"var(--accent)"},children:"per Klick."})]}),e.jsx("p",{children:"Per App oder Browser. NILL weist Projekte zu und berechnet Überstunden."})]}),e.jsxs("div",{style:{fontFamily:"var(--mono)",fontSize:11,color:"var(--ink-dim)",display:"flex",justifyContent:"space-between"},children:[e.jsx("span",{children:"EuGH-konform"}),e.jsx("span",{children:"GPS-optional"})]})]}),e.jsxs(ae,{className:"k5",children:[e.jsxs("div",{children:[e.jsxs("span",{className:"tag",children:[e.jsx("span",{className:"n",children:"05"})," · Team­verwaltung"]}),e.jsxs("h3",{children:["Das Team im ",e.jsx("em",{style:{fontStyle:"italic",color:"var(--accent)"},children:"Autopilot."})]}),e.jsx("p",{children:"Urlaub, Krankmeldungen, Dienstpläne, Onboarding — vorbereitet von der KI."})]}),e.jsx("div",{style:{display:"flex"},children:["MK","LS","JH","+9"].map((a,s)=>e.jsx("span",{className:"avatar",style:{width:28,height:28,fontSize:10,marginLeft:s?-10:0,background:s?["linear-gradient(135deg,var(--accent),var(--accent-4))","linear-gradient(135deg,var(--accent-3),var(--accent-2))","linear-gradient(135deg,var(--accent-4),var(--accent-3))"][s-1]:void 0},children:a},a))})]}),e.jsxs(ae,{className:"k6",style:{background:"linear-gradient(90deg,#0c0c10,#12130c)",borderColor:"rgba(198,255,60,.2)"},children:[e.jsxs("div",{children:[e.jsxs("span",{className:"tag",children:[e.jsx("span",{className:"n",children:"06"})," · KI Sekretärin"]}),e.jsxs("h3",{children:["Nimmt Anrufe entgegen. ",e.jsx("em",{style:{fontStyle:"italic",color:"var(--accent)"},children:"Rund um die Uhr."})]})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:14},children:[e.jsx("span",{className:"badge",children:"In Bearbeitung — Q3 / 2026"}),e.jsxs(G,{className:"btn btn-ghost",style:{padding:"10px 18px"},onClick:a=>{a.preventDefault(),n("Frühzugang")},href:"#",children:[e.jsx("span",{children:"Frühzugang sichern"}),e.jsx("span",{className:"arrow",children:"→"})]})]})]})]})]})})}function Ut(){const[n,t]=d.useState("inbox"),[r,a]=d.useState(314),[s,i]=V();d.useEffect(()=>{const c=document.querySelectorAll(".step-item"),o=new IntersectionObserver(p=>{p.forEach(b=>{if(!b.isIntersecting)return;const M=b.target.dataset.scene;t(M),M==="time"&&a(314*.28)})},{rootMargin:"-45% 0px -45% 0px",threshold:0});return c.forEach(p=>o.observe(p)),()=>o.disconnect()},[]);const l=["X-101","A-22","B-09","T-77","R-3","Q-41","P-18","S-54","D-09","M-66","V-12","N-88","K-2","Z-99","H-14","J-5","L-8","F-31"];return e.jsx("section",{id:"wie",children:e.jsxs("div",{className:"wrap",children:[e.jsxs("div",{className:`section-head reveal${i?" in":""}`,ref:s,children:[e.jsxs("div",{children:[e.jsx("span",{className:"eyebrow",children:"Wie es arbeitet — 05 Schritte"}),e.jsxs("h2",{children:["Ein Tag, ",e.jsx("br",{}),"von der ",e.jsx("em",{style:{fontStyle:"italic",color:"var(--accent)",fontFamily:"var(--serif)",fontVariationSettings:'"opsz" 144,"SOFT" 100,"WONK" 1'},children:"KI"})," geführt."]})]}),e.jsx("p",{className:"lead",children:"Scroll dich durch einen typischen Arbeitstag mit NILL."})]}),e.jsxs("div",{className:"feature-sticky",children:[e.jsx("div",{className:"text-col",children:[{scene:"inbox",idx:"01",title:"07:48 — Die erste Mail liegt schon vorbereitet bereit.",text:"NILL hat die Nacht durchgearbeitet. 47 E-Mails gesichtet, 12 Antworten vorformuliert, 3 zur Freigabe bereit."},{scene:"ledger",idx:"02",title:"09:15 — Der Handwerker schickt die Rechnung per Foto.",text:"OCR, Kontierung, Zuordnung zum richtigen Projekt, Vorbereitung für DATEV — in 4 Sekunden."},{scene:"inventory",idx:"03",title:"11:02 — Zwei Artikel rutschen unter die Meldegrenze.",text:"NILL kennt deinen Lieferanten, deine Rabattstufen, deine historische Liefertreue. Die Nachbestellung liegt auf deinem Schreibtisch."},{scene:"time",idx:"04",title:"13:30 — Mittagspause. Per Klick erfasst.",text:"App oder Browser öffnen, Projekt wählen, starten. NILL berechnet Projekte, Pausen und Überstunden. EuGH-konform."},{scene:"team",idx:"05",title:"16:48 — Zwei Krankmeldungen, ein Dienstplan neu.",text:"NILL zeigt die Lücken, informiert die betroffenen Kunden und schlägt den passenden Springer vor (folgt Q4 2026)."}].map(({scene:c,idx:o,title:p,text:b})=>e.jsxs("div",{className:"step-item","data-scene":c,children:[e.jsxs("div",{className:"step-index",children:[e.jsx("em",{children:o})," / ",["Postfach","Buchhaltung","Inventur","Zeiterfassung","Team­verwaltung"][parseInt(o)-1]]}),e.jsx("h3",{children:p}),e.jsx("p",{children:b})]},c))}),e.jsx("div",{className:"visual-col",children:e.jsx("div",{className:"feature-visual",children:e.jsxs("div",{className:"device",children:[e.jsxs("div",{className:"device-dots",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]}),e.jsxs("div",{className:"device-frame",children:[e.jsxs("div",{className:`scene${n==="inbox"?" active":""}`,children:[e.jsxs("div",{className:"inbox-row hi",children:[e.jsx("span",{className:"inbox-dot",style:{background:"var(--accent)"}}),e.jsx("span",{className:"inbox-name",children:"Kunde Müller GmbH"}),e.jsx("span",{className:"inbox-snippet",children:"Re: Angebot Sanierung — vielen Dank …"}),e.jsx("span",{className:"inbox-time",children:"07:48"})]}),e.jsxs("div",{className:"inbox-row",children:[e.jsx("span",{className:"inbox-dot"}),e.jsx("span",{className:"inbox-name",children:"DATEV"}),e.jsx("span",{className:"inbox-snippet",children:"Monatsreporting bereit"}),e.jsx("span",{className:"inbox-time",children:"06:02"})]}),e.jsxs("div",{className:"inbox-row",children:[e.jsx("span",{className:"inbox-dot",style:{background:"var(--accent-3)"}}),e.jsx("span",{className:"inbox-name",children:"L. Schröder"}),e.jsx("span",{className:"inbox-snippet",children:"Urlaubsantrag 12.—19.08."}),e.jsx("span",{className:"inbox-time",children:"05:55"})]}),e.jsxs("div",{className:"ai-reply",children:["Sehr geehrte Frau Müller, vielen Dank für Ihre Rückmeldung. Wir bestätigen den Termin am ",e.jsx("strong",{children:"23.04. um 09:00 Uhr"})," …",e.jsx("span",{className:"typing"})]})]}),e.jsxs("div",{className:`scene${n==="ledger"?" active":""}`,children:[e.jsxs("div",{className:"ocr-blip",children:[e.jsx("span",{className:"ocr-pulse"}),"OCR läuft"]}),e.jsxs("div",{className:"ledger-head",children:[e.jsx("span",{children:"Datum"}),e.jsx("span",{children:"Beleg"}),e.jsx("span",{children:"Konto"}),e.jsx("span",{children:"Betrag"})]}),e.jsxs("div",{className:"ledger-row",children:[e.jsx("span",{children:"09.15"}),e.jsxs("span",{children:["Rechnung ",e.jsx("span",{className:"cat",children:"Elektro Baum"})]}),e.jsx("span",{children:"3400"}),e.jsx("span",{className:"amount neg",children:"−487,20"})]}),e.jsxs("div",{className:"ledger-row",children:[e.jsx("span",{children:"09.14"}),e.jsxs("span",{children:["Abschlag ",e.jsx("span",{className:"cat",children:"Müller GmbH"})]}),e.jsx("span",{children:"8400"}),e.jsx("span",{className:"amount pos",children:"+3.200,00"})]}),e.jsxs("div",{className:"ledger-row",children:[e.jsx("span",{children:"08.55"}),e.jsxs("span",{children:["Kraftstoff ",e.jsx("span",{className:"cat",children:"Tank AG"})]}),e.jsx("span",{children:"4600"}),e.jsx("span",{className:"amount neg",children:"−128,40"})]})]}),e.jsxs("div",{className:`scene${n==="inventory"?" active":""}`,children:[e.jsx("div",{className:"inv-grid",children:l.map((c,o)=>e.jsx("div",{className:`inv-cell${[2,7,14].includes(o)?" lo":" ok"}`,children:c},c))}),e.jsxs("div",{className:"inv-legend",children:[e.jsx("span",{children:"OK"}),e.jsx("span",{className:"lo",children:"Unterbestand"})]})]}),e.jsx("div",{className:`scene${n==="time"?" active":""}`,children:e.jsx("div",{className:"time-ring",children:e.jsxs("svg",{className:"time-svg",viewBox:"0 0 120 120",children:[e.jsx("circle",{cx:"60",cy:"60",r:"50",fill:"none",stroke:"rgba(255,255,255,.06)",strokeWidth:"8"}),e.jsx("circle",{cx:"60",cy:"60",r:"50",fill:"none",stroke:"var(--accent)",strokeWidth:"8",strokeLinecap:"round",strokeDasharray:"314",strokeDashoffset:r,style:{transform:"rotate(-90deg)",transformOrigin:"60px 60px",transition:"stroke-dashoffset 1.4s cubic-bezier(.16,1,.3,1)"}}),e.jsx("text",{x:"60",y:"56",textAnchor:"middle",fontFamily:"JetBrains Mono,monospace",fontSize:"14",fill:"#efede7",children:"06:22"}),e.jsx("text",{x:"60",y:"72",textAnchor:"middle",fontFamily:"JetBrains Mono,monospace",fontSize:"9",fill:"rgba(239,237,231,.4)",letterSpacing:"2",children:"PROJEKT A"})]})})}),e.jsx("div",{className:`scene${n==="team"?" active":""}`,children:e.jsxs("div",{className:"team-list",children:[e.jsxs("div",{className:"team-tile",children:[e.jsx("span",{className:"avatar",children:"MK"}),e.jsxs("div",{children:[e.jsx("div",{className:"team-name",children:"M. Keller"}),e.jsx("div",{className:"team-role",children:"im Dienst"})]})]}),e.jsxs("div",{className:"team-tile",style:{borderColor:"rgba(255,77,141,.3)",background:"rgba(255,77,141,.04)"},children:[e.jsx("span",{className:"avatar",style:{background:"linear-gradient(135deg,var(--accent-3),var(--accent-2))"},children:"LS"}),e.jsxs("div",{children:[e.jsx("div",{className:"team-name",children:"L. Schröder"}),e.jsx("div",{className:"team-role",style:{color:"var(--accent-3)"},children:"krank"})]})]}),e.jsxs("div",{className:"team-tile",children:[e.jsx("span",{className:"avatar",style:{background:"linear-gradient(135deg,var(--accent),var(--accent-4))"},children:"JH"}),e.jsxs("div",{children:[e.jsx("div",{className:"team-name",children:"J. Hänisch"}),e.jsx("div",{className:"team-role",children:"im Dienst"})]})]}),e.jsxs("div",{className:"team-tile",style:{borderColor:"rgba(255,77,141,.3)",background:"rgba(255,77,141,.04)"},children:[e.jsx("span",{className:"avatar",style:{background:"linear-gradient(135deg,var(--accent-4),var(--accent-3))"},children:"TB"}),e.jsxs("div",{children:[e.jsx("div",{className:"team-name",children:"T. Baumann"}),e.jsx("div",{className:"team-role",style:{color:"var(--accent-3)"},children:"krank"})]})]}),e.jsxs("div",{className:"team-tile",style:{gridColumn:"1/-1",borderColor:"rgba(198,255,60,.4)",background:"rgba(198,255,60,.05)"},children:[e.jsx("span",{className:"avatar",style:{background:"var(--accent)"},children:"KI"}),e.jsxs("div",{children:[e.jsx("div",{className:"team-name",children:"Vorschlag: Springer F. Wolf für Di. 08–14 Uhr"}),e.jsx("div",{className:"team-role",style:{color:"var(--accent)"},children:"warten auf Freigabe"})]})]})]})})]})]})})})]})]})})}function qt(){const[n,t]=V(),r=d.useRef(null),[a,s]=d.useState(0);return d.useEffect(()=>{if(!t||!r.current)return;const i=performance.now(),l=c=>{const o=Math.min(1,(c-i)/1600);s(Math.round((1-Math.pow(1-o,3))*87)),o<1&&requestAnimationFrame(l)};requestAnimationFrame(l)},[t]),e.jsx("section",{style:{padding:"40px 0 120px"},children:e.jsx("div",{className:"wrap",children:e.jsxs("div",{className:`stats stagger${t?" in":""}`,ref:n,children:[e.jsxs("div",{className:"stat",children:[e.jsxs("div",{className:"num",children:[e.jsx("em",{children:"3,5"}),e.jsx("span",{children:"×"})]}),e.jsx("div",{className:"label",children:"Schneller im Alltag"})]}),e.jsxs("div",{className:"stat",children:[e.jsxs("div",{className:"num",children:[e.jsx("span",{ref:r,children:a}),e.jsx("em",{children:"%"})]}),e.jsx("div",{className:"label",children:"Weniger manuelle Arbeit"})]}),e.jsxs("div",{className:"stat",children:[e.jsxs("div",{className:"num",children:[e.jsx("em",{children:"24"}),e.jsx("span",{children:"/"}),e.jsx("em",{children:"7"})]}),e.jsx("div",{className:"label",children:"KI im Einsatz"})]}),e.jsxs("div",{className:"stat",children:[e.jsxs("div",{className:"num",children:[e.jsx("em",{children:"05"}),e.jsx("span",{children:"·"}),e.jsx("em",{children:"01"})]}),e.jsx("div",{className:"label",children:"Module live · Ein Login"})]})]})})})}const Zt=[{tier:"Solo",sub:"Für Einzelunternehmer & kleine Büros",price:"25",per:"€ / Monat · 1–2 Nutzer",items:["E-Mail, Kalender & Buchhaltung","OCR-Belegerfassung & DATEV-ready","Rechnungserstellung & PDF-Export","KI-Kategorisierung & Vorschläge","E-Mail-Support"],pop:!1},{tier:"Team",sub:"Für wachsende Teams & KMUs",price:"50",per:"€ / Monat · bis 10 Nutzer",items:["Alles aus Solo — für bis zu 10 Nutzer","Lohnbuchhaltung & HR-Verwaltung","Arbeitszeiterfassung & Stempeluhr","Urlaubs- & Abwesenheitsverwaltung","Priority-Support"],pop:!0},{tier:"Business",sub:"Für größere Unternehmen",price:"90",per:"€ / Monat · 10+ Nutzer",items:["Alles aus Team — unbegrenzte Nutzer","API-Zugang & Webhooks (folgt Q4 2026)","Erweiterte KI-Automatisierungen","Priorisierter Support mit SLA-Garantie"],pop:!1}];function Xt({tier:n,sub:t,price:r,per:a,items:s,pop:i}){const l=d.useRef(null);return Xe(l),e.jsxs("article",{ref:l,className:`price${i?" pop":""}`,children:[i&&e.jsx("span",{className:"pop-chip",children:"Meistgewählt"}),e.jsxs("div",{children:[e.jsx("span",{className:"eyebrow",style:i?{color:"var(--accent)"}:{},children:n}),e.jsx("h3",{style:{marginTop:12},children:t})]}),e.jsxs("div",{className:"price-tag",children:[e.jsx("span",{className:"num",style:r.length>3?{fontSize:52}:{},children:r}),a&&e.jsx("span",{className:"per",children:a})]}),e.jsx("ul",{children:s.map(c=>e.jsx("li",{children:c},c))}),e.jsxs(G,{className:`btn ${i?"btn-primary":"btn-ghost"}`,href:"/pricing",children:[e.jsx("span",{children:"Mehr Erfahren"}),e.jsx("span",{className:"arrow",children:"→"})]})]})}function Jt({onCTA:n}){const[t,r]=V();return e.jsx("section",{id:"preise",children:e.jsxs("div",{className:"wrap",children:[e.jsxs("div",{className:`section-head reveal${r?" in":""}`,ref:t,children:[e.jsxs("div",{children:[e.jsx("span",{className:"eyebrow",children:"Preise — einfach gehalten"}),e.jsxs("h2",{children:["Eins. Zwei. ",e.jsx("br",{}),e.jsx("em",{style:{fontStyle:"italic",color:"var(--accent)",fontFamily:"var(--serif)",fontVariationSettings:'"opsz" 144,"SOFT" 100,"WONK" 1'},children:"Drei."})]})]}),e.jsx("p",{className:"lead",children:"Transparent. Ohne versteckte Kosten. Monatlich kündbar."})]}),e.jsx(Q,{stagger:!0,className:"pricing-grid",children:Zt.map(a=>e.jsx(Xt,{...a},a.tier))})]})})}function Qt({onCTA:n}){const[t,r]=V();return e.jsx("section",{id:"nachhaltigkeit",children:e.jsxs("div",{className:"wrap",children:[e.jsxs("div",{className:`section-head reveal${r?" in":""}`,ref:t,children:[e.jsxs("div",{children:[e.jsx("span",{className:"eyebrow",children:"Verantwortung statt Fußnote"}),e.jsxs("h2",{children:["Software, die ",e.jsx("em",{children:"nicht heizt."})]})]}),e.jsxs("p",{className:"lead",children:["KI verbraucht Strom. Also nehmen wir es ernst: NILL läuft auf erneuerbaren Energien — und was nicht grün geht, wird ",e.jsx("strong",{style:{color:"var(--ink)",fontWeight:500},children:"transparent kompensiert"}),"."]})]}),e.jsxs(Q,{stagger:!0,className:"nh-hero",children:[e.jsxs("div",{children:[e.jsx("span",{className:"eyebrow",style:{color:"var(--accent)"},children:"Unser Anspruch"}),e.jsxs("h3",{style:{marginTop:20,fontSize:"clamp(34px,4.4vw,64px)",letterSpacing:"-.02em",lineHeight:1.02},children:["100 % ",e.jsx("em",{children:"erneuerbar"})," ·",e.jsx("br",{}),"100 % ",e.jsx("em",{children:"kompensiert."})]}),e.jsxs("p",{children:["Wir betreiben unsere Infrastruktur bei Rechenzentren mit nachweislich erneuerbarer Energie. Jeder Baustein, der sich noch nicht vollständig grün betreiben lässt, wird über ",e.jsx("strong",{style:{color:"var(--ink)",fontWeight:500},children:"zertifizierte Gold-Standard-Projekte"})," ausgeglichen."]})]}),e.jsx("div",{className:"nh-leaf","aria-hidden":"true",children:e.jsxs("svg",{viewBox:"0 0 200 200",fill:"none",children:[e.jsx("defs",{children:e.jsxs("linearGradient",{id:"leafG",x1:"0",y1:"0",x2:"1",y2:"1",children:[e.jsx("stop",{offset:"0",stopColor:"#c6ff3c"}),e.jsx("stop",{offset:"1",stopColor:"#38f5d0"})]})}),e.jsx("path",{d:"M100 20 C 45 55, 25 115, 45 165 C 95 170, 150 140, 170 80 C 155 55, 130 35, 100 20 Z",fill:"url(#leafG)",opacity:".9"}),e.jsx("path",{d:"M100 20 C 95 80, 80 130, 45 165",stroke:"#0a0a10",strokeWidth:"3",strokeLinecap:"round",fill:"none",opacity:".55"})]})})]}),e.jsx(Q,{stagger:!0,className:"nh-stats",children:[["100 %","Rechenzentrum erneuerbar","Frankfurt — Stromversorgung aus erneuerbaren Energien."],["<2 g","CO₂ pro KI-Anfrage","Effiziente Modelle, Caching, Batching — jede Operation wird gemessen."],["105 %","Überkompensation","Wir kompensieren 5 % mehr als unser Fußabdruck."]].map(([a,s,i])=>e.jsxs("div",{className:"nh-stat",children:[e.jsx("div",{className:"val",children:e.jsx("em",{children:a})}),e.jsx("span",{className:"lbl",children:s}),e.jsx("p",{children:i})]},s))}),e.jsx(Q,{stagger:!0,className:"nh-pillars",children:[["01 / Strom","Grünstrom zuerst.","Primärinfrastruktur bei Anbietern mit 100 % Ökostrom."],["02 / Effizienz","Jedes Watt zählt.","Modell-Routing spart Tokens. Idle-Hardware schläft automatisch."],["03 / Kompensation","Gold Standard.","Zertifizierte Waldschutz- & Clean-Cooking-Projekte — mit öffentlicher Seriennummer."]].map(([a,s,i])=>e.jsxs("article",{className:"nh-pillar",children:[e.jsx("span",{className:"num",children:a}),e.jsx("h3",{children:s}),e.jsx("p",{children:i})]},a))}),e.jsxs(Q,{className:"nh-pledge",children:[e.jsxs("div",{className:"big",children:[e.jsx("em",{children:"Transparenter Nachhaltigkeitsbericht"})," — jährlich, als PDF, mit Stromquellen, Emissionen und Kompensations-Zertifikaten."]}),e.jsxs(G,{className:"btn btn-ghost",onClick:a=>{a.preventDefault(),n("Nachhaltigkeitsbericht")},href:"#",children:[e.jsx("span",{children:"Bericht anfordern"}),e.jsx("span",{className:"arrow",children:"→"})]})]})]})})}function ea(){const[n,t]=V(),r=[["Wo werden meine Daten gespeichert?","Alle Daten liegen verschlüsselt auf Servern in Deutschland (Frankfurt). Wir sind nach DSGVO geprüft und bieten auf Wunsch eine Private-Cloud-Instanz."],["Ersetzt NILL meinen Steuerberater?","Nein — NILL bereitet alles so auf, dass dein Steuerberater deutlich weniger Zeit braucht. DATEV-ready Export sorgt für reibungslose Übergabe."],["Wie lange dauert das Onboarding?","Die meisten Teams sind in 48 Stunden produktiv. Wir unterstützen bei der Einrichtung deiner E-Mail-Konten und Module."],["Was passiert, wenn die KI einen Fehler macht?",'Jede automatische Aktion ist standardmäßig im "Vorschlags-Modus". Du entscheidest, was direkt geht, was freigegeben werden muss, und was dokumentiert wird.'],["Wie nachhaltig ist NILL wirklich?","Unsere Kern-Infrastruktur läuft auf 100 % Ökostrom in Frankfurt. Drittanbieter kompensieren wir zu 105 % über Gold-Standard-Projekte. Jährlicher Nachhaltigkeitsbericht auf Anfrage."]];return e.jsx("section",{id:"faq",children:e.jsxs("div",{className:"wrap-tight",children:[e.jsx("div",{className:`section-head reveal${t?" in":""}`,ref:n,style:{marginBottom:40},children:e.jsxs("div",{children:[e.jsx("span",{className:"eyebrow",children:"Antworten auf das Naheliegende"}),e.jsx("h2",{children:"FAQ."})]})}),e.jsx(Q,{stagger:!0,className:"faq",children:r.map(([a,s])=>e.jsxs("details",{children:[e.jsx("summary",{children:a}),e.jsx("p",{className:"a",children:s})]},a))})]})})}function ta({onCTA:n}){const[t,r]=V();return e.jsx("section",{id:"cta",className:"cta-big",children:e.jsxs("div",{className:"wrap",children:[e.jsxs("h2",{className:`reveal${r?" in":""}`,ref:t,children:["Lass deine KI ",e.jsx("br",{}),e.jsx("em",{children:"anfangen"}),e.jsx("br",{}),"zu arbeiten."]}),e.jsxs("div",{className:`cta-sub reveal reveal-delay-1${r?" in":""}`,children:[e.jsx("p",{className:"lead",children:"30 Minuten Live-Demo mit einem unserer Produktspezialisten. Wir zeigen dir direkt an deinem Use-Case, wie NILL arbeitet."}),e.jsxs("div",{style:{display:"flex",gap:12,flexWrap:"wrap"},children:[e.jsxs(G,{className:"btn btn-primary",onClick:a=>{a.preventDefault(),n("Termin")},href:"#",children:[e.jsx("span",{children:"Termin buchen"}),e.jsx("span",{className:"arrow",children:"→"})]}),e.jsxs(G,{className:"btn btn-ghost",href:"#produkte",children:[e.jsx("span",{children:"Module"}),e.jsx("span",{className:"arrow",children:"↑"})]})]})]})]})})}function aa(){return e.jsx("footer",{children:e.jsxs("div",{className:"wrap",children:[e.jsxs("div",{className:"foot-grid",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"brand",style:{marginBottom:18},children:[e.jsx("span",{className:"brand-mark"}),e.jsx("span",{children:"NILL"})]}),e.jsx("p",{style:{maxWidth:"32ch"},children:"Das KI-Betriebssystem für Unternehmen. Gebaut in Deutschland, gehostet in Frankfurt."})]}),e.jsxs("div",{children:[e.jsx("h4",{children:"Produkt"}),e.jsxs("ul",{children:[e.jsx("li",{children:e.jsx("a",{href:"#produkte",children:"Module"})}),e.jsx("li",{children:e.jsx("a",{href:"#preise",children:"Preise"})}),e.jsx("li",{children:e.jsx("a",{href:"#faq",children:"FAQ"})}),e.jsx("li",{children:e.jsx(J,{to:"/changelog",children:"Changelog"})})]})]}),e.jsxs("div",{children:[e.jsx("h4",{children:"Unternehmen"}),e.jsxs("ul",{children:[e.jsx("li",{children:e.jsx(J,{to:"/ueber-uns",children:"Über uns"})}),e.jsx("li",{children:e.jsx(J,{to:"/karriere",children:"Karriere"})})]})]}),e.jsxs("div",{children:[e.jsx("h4",{children:"Rechtliches"}),e.jsxs("ul",{children:[e.jsx("li",{children:e.jsx(J,{to:"/Impressum",children:"Impressum"})}),e.jsx("li",{children:e.jsx(J,{to:"/Datenschutz",children:"Datenschutz"})}),e.jsx("li",{children:e.jsx(J,{to:"/agb",children:"AGB"})}),e.jsx("li",{children:e.jsx(J,{to:"/sicherheit",children:"Sicherheit"})})]})]})]}),e.jsxs("div",{className:"wordmark",children:["NILL",e.jsx("em",{children:"."})]}),e.jsxs("div",{className:"foot-meta",children:[e.jsx("span",{children:"© 2026 NILL AI - Inh. Julian David Nill · nillai.de"}),e.jsx("span",{children:"Made with intelligence · Frankfurt a.M."})]})]})})}const Ue={Demo:{t:"Live-Demo <em>anfragen.</em>",s:"Terminvorschlag per Mail, persönlich via Videocall."},Paket:{t:"Paket <em>wählen.</em>",s:"Wir konfigurieren Module & Preis gemeinsam."},Gespräch:{t:"Kurzes <em>Gespräch.</em>",s:"15 Minuten reichen. Ehrliche Beratung, kein Sales-Druck."},Frühzugang:{t:"Frühzugang <em>sichern.</em>",s:"Erste Plätze gehen an Frühanfragen."},Termin:{t:"Termin <em>buchen.</em>",s:"Sag uns Zeitraum und Kanal — Telefon, Videocall oder vor Ort."},default:{t:"Lass uns <em>reden.</em>",s:"Kurz ein paar Infos — wir melden uns innerhalb von 24 h zurück."}};function na({intent:n,onClose:t}){const[r,a]=d.useState(!1),s=Ue[n]||Ue.default;d.useEffect(()=>{a(!1)},[n]),d.useEffect(()=>{const l=c=>{c.key==="Escape"&&t()};return addEventListener("keydown",l),()=>removeEventListener("keydown",l)},[t]),d.useEffect(()=>(document.body.style.overflow=n?"hidden":"",()=>{document.body.style.overflow=""}),[n]);const i=l=>{l.preventDefault();const c=new FormData(l.target),o=(c.get("name")||"").trim(),p=(c.get("email")||"").trim();if(!o||!p){l.target.reportValidity();return}const b=encodeURIComponent(`NILL · ${n||"Anfrage"} — ${o}`),M=encodeURIComponent(`Anliegen: ${n||"—"}
Name: ${o}
Firma: ${c.get("company")||"—"}
E-Mail: ${p}

${c.get("message")||""}`);window.location.href=`mailto:hallo@nillai.de?subject=${b}&body=${M}`,a(!0)};return e.jsxs("div",{className:`modal-overlay${n?" open":""}`,onClick:l=>{(l.target===l.currentTarget||l.target.classList.contains("modal-bg"))&&t()},children:[e.jsx("div",{className:"modal-bg"}),e.jsxs("div",{className:"modal-panel",children:[e.jsx("button",{className:"modal-close",onClick:t,type:"button","aria-label":"Schließen",children:"×"}),r?e.jsxs("div",{style:{textAlign:"center",padding:"10px 0"},children:[e.jsx("div",{className:"modal-eyebrow",children:"Gesendet · ✓"}),e.jsxs("h3",{children:["Danke, ",e.jsx("em",{children:"wir sind dran."})]}),e.jsx("p",{style:{margin:"0 auto",maxWidth:"40ch"},children:"Deine Anfrage ist im Postfach. Ein Mensch antwortet innerhalb weniger Stunden."}),e.jsx("div",{style:{display:"flex",justifyContent:"center",marginTop:22},children:e.jsx(G,{className:"btn btn-ghost",onClick:t,children:e.jsx("span",{children:"Schließen"})})})]}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"modal-eyebrow",children:["NILL · ",n||"Anfrage"]}),e.jsx("h3",{dangerouslySetInnerHTML:{__html:s.t}}),e.jsx("p",{className:"sub",children:s.s}),e.jsxs("form",{onSubmit:i,autoComplete:"on",noValidate:!0,children:[e.jsxs("div",{className:"form-row",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"mn",children:"Name"}),e.jsx("input",{id:"mn",name:"name",required:!0,placeholder:"Vor- und Nachname"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"mc",children:"Unternehmen"}),e.jsx("input",{id:"mc",name:"company",placeholder:"Firmenname"})]})]}),e.jsxs("div",{className:"form-row",children:[e.jsxs("div",{children:[e.jsx("label",{htmlFor:"me",children:"E-Mail"}),e.jsx("input",{id:"me",name:"email",type:"email",required:!0,placeholder:"du@firma.de"})]}),e.jsxs("div",{children:[e.jsxs("label",{htmlFor:"mp",children:["Telefon ",e.jsx("span",{style:{opacity:.5},children:"· optional"})]}),e.jsx("input",{id:"mp",name:"phone",placeholder:"+49 ..."})]})]}),e.jsxs("div",{className:"form-field",children:[e.jsx("label",{htmlFor:"mm",children:"Nachricht"}),e.jsx("textarea",{id:"mm",name:"message",placeholder:"Welches Modul interessiert dich?"})]}),e.jsxs("div",{className:"modal-actions",children:[e.jsx("small",{children:'Per Klick auf „Senden" wird dein Mailprogramm geöffnet.'}),e.jsxs(G,{className:"btn btn-primary",children:[e.jsx("span",{children:"Senden"}),e.jsx("span",{className:"arrow",children:"→"})]})]})]})]})]})]})}function ca(){Tt();const[n,t]=d.useState(null),r=d.useCallback(s=>t(s||"default"),[]),a=d.useCallback(()=>t(null),[]);return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"vignette","aria-hidden":"true"}),e.jsx(Ct,{}),e.jsx($t,{onDemo:r}),e.jsx(Ht,{onCTA:r}),e.jsx(It,{}),e.jsx(Vt,{}),e.jsx(Yt,{onCTA:r}),e.jsx(Ut,{}),e.jsx(qt,{}),e.jsx(Jt,{onCTA:r}),e.jsx(Qt,{onCTA:r}),e.jsx(ea,{}),e.jsx(ta,{onCTA:r}),e.jsx(aa,{}),e.jsx(na,{intent:n,onClose:a})]})}export{ca as default};
